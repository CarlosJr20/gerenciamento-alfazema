	...
	<table class="nmTable" width="550px"  cellspacing="0">
	   ...
	   <tr id='tr_dados_usu'>
	   		<td colspan="2" id="td_dados_usu" style="display:none">
		   		...
		   		<table width="100%" border="0" >
					...
					<tr style="display:<?php echo $dbms == 'sqlite' ? 'none' : ''; ?>">
				      ...
				      <td class="nmLineV3" width="225px">
				          <input type='text' name='user' id='user' value='<?php echo $user?>' class="nmInput"  onchange="$('#carregar_db').val('S');" >
				      </td>
				   ...
				   <tr style="display:<?php echo $dbms == 'sqlite' ? 'none' : ''; ?>">
				      ...
				      <td class="nmLineV3" width="225px">
				          <input type='password' name='pass' id='pass' value='<?php echo $pass?>' class="nmInput" onchange="$('#carregar_db').val('S');">
				      </td>
				      <td class="nmLineV3" width="50px" align="left" valign="middle">&nbsp;</td>
				   </tr>
	   ...
	   <tr id="tr_more_info" style="display:none">
	   		<td colspan="2">	   				   			   		
				   ...
				   <tr id='tr_use_ssl' style="display:<?php echo $obj_conn->nm_db_sc_type($dbms) != 'mysql' ? 'none' : ''; ?>">
