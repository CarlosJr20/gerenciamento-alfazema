...
{
	if(!isset($_SESSION['nm_session']['cache']['prod_v8'][$ini_file]['PROFILE']) || empty($_SESSION['nm_session']['cache']['prod_v8'][$ini_file]['PROFILE']))
	{
		global $nm_config;
...
function getProdDefault()
{
    ...
    $arr_prod_ini["GLOBAL"]["CACHE_GC_MIN"] = '1440';
    $arr_prod_ini["GLOBAL"]["CACHE_GC_DIR"] = dirname(dirname(dirname(dirname(__FILE__)))) . '/file/cache';
