...
$b_reenviar = false;
    ...
    function gd_auth_api($app_name, $json_oauth, $auth_code = '', $return_token = false){
        global $nm_config;
...
switch ($str_option) {
    case 'gd_auth_api':
                    echo gd_auth_api($_REQUEST['app_name'], $_REQUEST['json_oauth']);
exit;
        break;
    // Altera senha
    case 'change_pass':
    ...
    case 'profile_delete':
        ...
        case 'api_save':
            ...
            if($gw[1] == 'google_drive'){
                        $_SESSION['scriptcase']['nm_path_prod'] =  $nm_config['path_prod'];
                        include_once(__DIR__ . "/nm_api.php");
                        $token_code = gd_auth_api($_REQUEST[ $gw[1] ]['app_name'], $_REQUEST[ $gw[1] ]['json_oauth'], $_REQUEST[ $gw[1] ]['auth_code'], true);
    ...
    <div style="text-align: center">
        <center>
            <table class="nmTable" cellpadding="3px">
                ...
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td class="nmLineV3 pad"><?php echo $nm_lang['form_gc_dir_cache']; ?></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td class="nmLineV3 pad"><input type="text" name="field_cache_gc_dir" size="50"
                                                    value="<?php echo $arr_ini['GLOBAL']['CACHE_GC_DIR']; ?>"
                                                    class="nmInput"/></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                </tr>
                <tr>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td class="nmLineV3 pad"><?php echo $nm_lang['form_gc_min_cache']; ?></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td class="nmLineV3 pad"><input type="text" name="field_cache_gc_min" size="5"
                                                    value="<?php echo $arr_ini['GLOBAL']['CACHE_GC_MIN']; ?>"
                                                    class="nmInput"/></td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                </tr>
                <tr>
...
function openAuthGoogle(){
            var app_name = $('input[name="google_drive[app_name]"]').val();
            var json_oauth = $('textarea[name="google_drive[json_oauth]"]').val();
            $.post('nm_ini_manager2.php?nm_ajax=1&option=gd_auth_api&app_name='+app_name+'&json_oauth='+json_oauth, function(str_return){
                        ...
                        <tr class="row">
                            ...
                            <div class="ui action input">
                                <input type="text"  name="<?php echo $k; ?>[<?php echo $field_name; ?>]" required="required" <?=$on_change?>
                                       placeholder="<?php echo  $nm_lang['api_gw_sett'][$field_name ."_placeholder"]; ?>"
...
/>
                            ...
                            <textarea class="nmInput form-control" name="<?php echo $k; ?>[<?php echo $field_name; ?>]" required="required" <?=$on_change?>
