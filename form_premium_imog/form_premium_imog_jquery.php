...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_premium_imog_id_onchange(this, iSeqRow) });
  $('#id_sc_field_img' + iSeqRow).bind('change', function() { sc_form_premium_imog_img_onchange(this, iSeqRow) });
  $('#id_sc_field_titulo' + iSeqRow).bind('blur', function() { sc_form_premium_imog_titulo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_premium_imog_titulo_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_premium_imog_titulo_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor' + iSeqRow).bind('blur', function() { sc_form_premium_imog_valor_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_premium_imog_valor_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_premium_imog_valor_onfocus(this, iSeqRow) });
  $('#id_sc_field_quartos' + iSeqRow).bind('blur', function() { sc_form_premium_imog_quartos_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_premium_imog_quartos_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_premium_imog_quartos_onfocus(this, iSeqRow) });
  $('#id_sc_field_area' + iSeqRow).bind('blur', function() { sc_form_premium_imog_area_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_premium_imog_area_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_premium_imog_area_onfocus(this, iSeqRow) });
  $('#id_sc_field_lote' + iSeqRow).bind('blur', function() { sc_form_premium_imog_lote_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_premium_imog_lote_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_premium_imog_lote_onfocus(this, iSeqRow) });
  $('#id_sc_field_ano' + iSeqRow).bind('blur', function() { sc_form_premium_imog_ano_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_premium_imog_ano_onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_premium_imog_ano_onfocus(this, iSeqRow) });
  $('#id_sc_field_descricao' + iSeqRow).bind('blur', function() { sc_form_premium_imog_descricao_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_premium_imog_descricao_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_premium_imog_descricao_onfocus(this, iSeqRow) });
  $('#id_sc_field_imagem' + iSeqRow).bind('blur', function() { sc_form_premium_imog_imagem_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_premium_imog_imagem_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_premium_imog_imagem_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_premium_imog_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_img_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_titulo_onblur(oThis, iSeqRow) {
  do_ajax_form_premium_imog_validate_titulo();
  scCssBlur(oThis);
}

function sc_form_premium_imog_titulo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_titulo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_premium_imog_valor_onblur(oThis, iSeqRow) {
  do_ajax_form_premium_imog_validate_valor();
  scCssBlur(oThis);
}

function sc_form_premium_imog_valor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_valor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_premium_imog_quartos_onblur(oThis, iSeqRow) {
  do_ajax_form_premium_imog_validate_quartos();
  scCssBlur(oThis);
}

function sc_form_premium_imog_quartos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_quartos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_premium_imog_area_onblur(oThis, iSeqRow) {
  do_ajax_form_premium_imog_validate_area();
  scCssBlur(oThis);
}

function sc_form_premium_imog_area_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_area_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_premium_imog_lote_onblur(oThis, iSeqRow) {
  do_ajax_form_premium_imog_validate_lote();
  scCssBlur(oThis);
}

function sc_form_premium_imog_lote_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_lote_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_premium_imog_ano_onblur(oThis, iSeqRow) {
  do_ajax_form_premium_imog_validate_ano();
  scCssBlur(oThis);
}

function sc_form_premium_imog_ano_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_ano_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_premium_imog_descricao_onblur(oThis, iSeqRow) {
  do_ajax_form_premium_imog_validate_descricao();
  scCssBlur(oThis);
}

function sc_form_premium_imog_descricao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_descricao_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_premium_imog_imagem_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_premium_imog_imagem_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_premium_imog_imagem_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_premium_imog_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_img" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_premium_imog_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_premium_imog')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
