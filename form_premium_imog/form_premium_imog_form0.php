...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Cadastrar Premium"); } else { echo strip_tags("Cadastrar Premium"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['embutida_pdf']))
 {
 ?>
<?php
    if ((isset($this->nmgp_tipo_pdf) && $this->nmgp_tipo_pdf == "pb") || (isset($this->nmgp_cor_print) && $this->nmgp_cor_print == "PB"))
    {
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['prt_view'] && $this->Ini->Export_img_zip) 
        {
?>
 <style type="text/css">
<?php
...
?>
 <style type="text/css">
<?php
           $NM_css = file($this->Ini->root . $this->Ini->path_link . "form_premium_imog/form_premium_imog_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
           foreach ($NM_css as $cada_css)
           {
               echo $cada_css;
           }
...
<?php
     ...
     {
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_premium_imog/form_premium_imog_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
<?php
     }
?>
...
<?php
include_once("form_premium_imog_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_premium_imog_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['recarga'];
}
...
{
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_premium_imog_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_premium_imog'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_premium_imog'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "Cadastrar Premium"; } else { echo "Cadastrar Premium"; } ?></div>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['titulo'] = (isset($this->nm_new_label['titulo'])) ? $this->nm_new_label['titulo'] : 'Título'; 
          ...
          $SC_Label_atu['area'] = (isset($this->nm_new_label['area'])) ? $this->nm_new_label['area'] : 'Área'; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bpdf", "scBtnFn_sys_format_pdf()", "scBtnFn_sys_format_pdf()", "sc_b_pdf_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-8", "", "group_3");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bprint", "scBtnFn_sys_format_imp()", "scBtnFn_sys_format_imp()", "sc_b_prt_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-9", "", "group_3");?>
  </div>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['titulo'] = "Título";
    }
?>
<?php
...
<span id="id_read_on_titulo" class="sc-ui-readonly-titulo css_titulo_line" style="<?php echo $sStyleReadLab_titulo; ?>"><?php echo $this->form_format_readonly("titulo", $this->form_encode_input($this->titulo)); ?></span><span id="id_read_off_titulo" class="css_read_off_titulo<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_titulo; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=50"; } ?> maxlength=100 alt="{datatype: 'text', maxLength: 100, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_quartos_label" id="hidden_field_label_quartos" style="<?php echo $sStyleHidden_quartos; ?>"><span id="id_label_quartos"><?php echo $this->nm_new_label['quartos']; ?></span></TD>
    <TD class="scFormDataOdd css_quartos_line" id="hidden_field_data_quartos" style="<?php echo $sStyleHidden_quartos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_quartos_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_quartos" class="sc-ui-readonly-quartos css_quartos_line" style="<?php echo $sStyleReadLab_quartos; ?>"><?php echo $this->form_format_readonly("quartos", $this->form_encode_input($this->quartos)); ?></span><span id="id_read_off_quartos" class="css_read_off_quartos<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_quartos; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=4"; } ?> maxlength=4 alt="{datatype: 'text', maxLength: 4, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_area_label" id="hidden_field_label_area" style="<?php echo $sStyleHidden_area; ?>"><span id="id_label_area"><?php echo $this->nm_new_label['area']; ?></span></TD>
    <TD class="scFormDataOdd css_area_line" id="hidden_field_data_area" style="<?php echo $sStyleHidden_area; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_area_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_area" class="sc-ui-readonly-area css_area_line" style="<?php echo $sStyleReadLab_area; ?>"><?php echo $this->form_format_readonly("area", $this->form_encode_input($this->area)); ?></span><span id="id_read_off_area" class="css_read_off_area<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_area; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['area']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['area']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['area']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_lote" class="sc-ui-readonly-lote css_lote_line" style="<?php echo $sStyleReadLab_lote; ?>"><?php echo $this->form_format_readonly("lote", $this->form_encode_input($this->lote)); ?></span><span id="id_read_off_lote" class="css_read_off_lote<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_lote; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['lote']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['lote']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['lote']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_ano_label" id="hidden_field_label_ano" style="<?php echo $sStyleHidden_ano; ?>"><span id="id_label_ano"><?php echo $this->nm_new_label['ano']; ?></span></TD>
    <TD class="scFormDataOdd css_ano_line" id="hidden_field_data_ano" style="<?php echo $sStyleHidden_ano; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ano_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_ano" class="sc-ui-readonly-ano css_ano_line" style="<?php echo $sStyleReadLab_ano; ?>"><?php echo $this->form_format_readonly("ano", $this->form_encode_input($this->ano)); ?></span><span id="id_read_off_ano" class="css_read_off_ano<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ano; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'integer', maxLength: 10, thousandsSep: '', thousandsFormat: <?php echo $this->field_config['ano']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['ano']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_imagem_label" id="hidden_field_label_imagem" style="<?php echo $sStyleHidden_imagem; ?>"><span id="id_label_imagem"><?php echo $this->nm_new_label['imagem']; ?></span></TD>
    <TD class="scFormDataOdd css_imagem_line" id="hidden_field_data_imagem" style="<?php echo $sStyleHidden_imagem; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_imagem_line" style="vertical-align: top;padding: 0px"><span id="id_sc_mucontrol_imagem">
...
<?php 
    ...
    if (isset($this->NMSC_modal) && $this->NMSC_modal == "ok") {
        $sCondStyle = '';
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bsair", "scBtnFn_sys_format_sai_modal()", "scBtnFn_sys_format_sai_modal()", "sc_b_sai_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + Q)", "sc-unique-btn-14", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_premium_imog");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_premium_imog");
 parent.scAjaxDetailHeight("form_premium_imog", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_pdf() {
		if ($("#sc_b_pdf_t.sc-unique-btn-8").length && $("#sc_b_pdf_t.sc-unique-btn-8").is(":visible")) {
			tb_show('', "<?php echo  $this->Ini->path_link . SC_dir_app_name('form_premium_imog')  ?>/form_premium_imog_config_pdf.php?nm_opc=pdf&nm_target=2&nm_cor=cor&papel=8&lpapel=0&apapel=0&orientacao=1&bookmarks=XX&largura=800&conf_larg=10&conf_fonte=N&grafico=XX&language=pt_br&conf_socor=N&password=n&pdf_zip=N&sc_ver_93=s&KeepThis=true&TB_iframe=true&modal=true");
			 return;
		}
	}
	function scBtnFn_sys_format_imp() {
		if ($("#sc_b_prt_t.sc-unique-btn-9").length && $("#sc_b_prt_t.sc-unique-btn-9").is(":visible")) {
			tb_show('', "<?php echo  $this->Ini->path_link . SC_dir_app_name('form_premium_imog')  ?>/form_premium_imog_config_print.php?nm_opc=print&nm_cor=CO&language=pt_br&password=n&origem=form&KeepThis=true&TB_iframe=true&modal=true");
			 return;
		}
	}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_premium_imog']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
