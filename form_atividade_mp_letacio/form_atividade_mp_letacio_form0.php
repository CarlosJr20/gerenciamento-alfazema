...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_atividade_mp_letacio_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_atividade_mp_letacio_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_atividade_mp_letacio_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_atividade_mp_letacio'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_atividade_mp_letacio'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['fast_search'][2] : "";
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hora_inicio_label" id="hidden_field_label_hora_inicio" style="<?php echo $sStyleHidden_hora_inicio; ?>"><span id="id_label_hora_inicio"><?php echo $this->nm_new_label['hora_inicio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['php_cmp_required']['hora_inicio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['php_cmp_required']['hora_inicio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_hora_final_label" id="hidden_field_label_hora_final" style="<?php echo $sStyleHidden_hora_final; ?>"><span id="id_label_hora_final"><?php echo $this->nm_new_label['hora_final']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['php_cmp_required']['hora_final']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['php_cmp_required']['hora_final'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_atividade_mp_letacio");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_atividade_mp_letacio");
 parent.scAjaxDetailHeight("form_atividade_mp_letacio", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
