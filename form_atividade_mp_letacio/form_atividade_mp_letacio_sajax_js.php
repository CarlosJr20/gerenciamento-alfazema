  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_atividade_mp_letacio" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_atividade_mp_letacio_form();
	}
  ...
  function do_ajax_form_atividade_mp_letacio_validate_selecao_projetos()
  {
    ...
    x_ajax_form_atividade_mp_letacio_validate_selecao_projetos(var_selecao_projetos, var_script_case_init, do_ajax_form_atividade_mp_letacio_validate_selecao_projetos_cb);
  } // do_ajax_form_atividade_mp_letacio_validate_selecao_projetos

  function do_ajax_form_atividade_mp_letacio_validate_selecao_projetos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_letacio_validate_selecao_projetos_cb

  // ---------- Validate tag
  function do_ajax_form_atividade_mp_letacio_validate_tag()
  {
    var nomeCampo_tag = "tag";
    var var_tag = scAjaxGetFieldSelect(nomeCampo_tag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_letacio_validate_tag(var_tag, var_script_case_init, do_ajax_form_atividade_mp_letacio_validate_tag_cb);
  } // do_ajax_form_atividade_mp_letacio_validate_tag

  function do_ajax_form_atividade_mp_letacio_validate_tag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tag";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_letacio_validate_tag_cb

  // ---------- Validate selecao_atividade
  function do_ajax_form_atividade_mp_letacio_validate_selecao_atividade()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_letacio_validate_selecao_atividade(var_selecao_atividade, var_script_case_init, do_ajax_form_atividade_mp_letacio_validate_selecao_atividade_cb);
  } // do_ajax_form_atividade_mp_letacio_validate_selecao_atividade

  function do_ajax_form_atividade_mp_letacio_validate_selecao_atividade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_letacio_validate_selecao_atividade_cb

  // ---------- Validate hora_inicio
  function do_ajax_form_atividade_mp_letacio_validate_hora_inicio()
  {
    var nomeCampo_hora_inicio = "hora_inicio";
    var var_hora_inicio = scAjaxGetFieldText(nomeCampo_hora_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_letacio_validate_hora_inicio(var_hora_inicio, var_script_case_init, do_ajax_form_atividade_mp_letacio_validate_hora_inicio_cb);
  } // do_ajax_form_atividade_mp_letacio_validate_hora_inicio

  function do_ajax_form_atividade_mp_letacio_validate_hora_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_letacio_validate_hora_inicio_cb

  // ---------- Validate hora_final
  function do_ajax_form_atividade_mp_letacio_validate_hora_final()
  {
    var nomeCampo_hora_final = "hora_final";
    var var_hora_final = scAjaxGetFieldText(nomeCampo_hora_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_letacio_validate_hora_final(var_hora_final, var_script_case_init, do_ajax_form_atividade_mp_letacio_validate_hora_final_cb);
  } // do_ajax_form_atividade_mp_letacio_validate_hora_final

  function do_ajax_form_atividade_mp_letacio_validate_hora_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_letacio_validate_hora_final_cb

  // ---------- Validate descricao
  function do_ajax_form_atividade_mp_letacio_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_letacio_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_atividade_mp_letacio_validate_descricao_cb);
  } // do_ajax_form_atividade_mp_letacio_validate_descricao

  function do_ajax_form_atividade_mp_letacio_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_letacio_validate_descricao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_atividade_mp_letacio_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_atividade_mp_letacio_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_atividade_mp_letacio_submit_form(var_selecao_projetos, var_tag, var_selecao_atividade, var_hora_inicio, var_hora_final, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_atividade_mp_letacio_submit_form_cb);
  } // do_ajax_form_atividade_mp_letacio_submit_form

  function do_ajax_form_atividade_mp_letacio_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_atividade_mp_letacio_submit_form_cb_after_alert);
  } // do_ajax_form_atividade_mp_letacio_submit_form_cb
  function do_ajax_form_atividade_mp_letacio_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_atividade_mp_letacio_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_atividade_mp_letacio_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_atividade_mp_letacio_navigate_form, function() {});
    } else {
      perform_ajax_form_atividade_mp_letacio_navigate_form();
    }
  }

  function perform_ajax_form_atividade_mp_letacio_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_atividade_mp_letacio_navigate_form(var_id_atividade_mp, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_atividade_mp_letacio_navigate_form_cb);
  } // do_ajax_form_atividade_mp_letacio_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_letacio']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_atividade_mp_letacio_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_atividade_mp_letacio_navigate_form_cb_after_alert);
  } // do_ajax_form_atividade_mp_letacio_navigate_form_cb
  function do_ajax_form_atividade_mp_letacio_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_atividade_mp_letacio_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_atividade_mp_letacio_navigate_form_cb_after_alert
  function sc_hide_form_atividade_mp_letacio_form()
  {
