...
$old_error_handler = set_error_handler("form_atividade_mp_letacio_mob_scriptcase_error_handler");

function form_atividade_mp_letacio_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_atividade_mp_letacio_mob']['contr_erro']) && $_SESSION['scriptcase']['form_atividade_mp_letacio_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_atividade_mp_letacio_mob->contr_form_atividade_mp_letacio_mob->Apl_com_erro = true;
            if ($inicial_form_atividade_mp_letacio_mob->contr_form_atividade_mp_letacio_mob->NM_ajax_flag)
            {
                $inicial_form_atividade_mp_letacio_mob->contr_form_atividade_mp_letacio_mob->NM_ajax_info['errList']['geral_form_atividade_mp_letacio_mob'][] = $msg;
                return;
            }
            form_atividade_mp_letacio_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_atividade_mp_letacio_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_atividade_mp_letacio_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['form_atividade_mp_letacio_mob'])  ? $_SESSION['scriptcase']['error_icon']['form_atividade_mp_letacio_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_atividade_mp_letacio_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['form_atividade_mp_letacio_mob']) ? $_SESSION['scriptcase']['error_span_title']['form_atividade_mp_letacio_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_atividade_mp_letacio_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_atividade_mp_letacio_mob']) ? $_SESSION['scriptcase']['error_icon_title']['form_atividade_mp_letacio_mob'] : '';
?>
