  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_Clientes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_Clientes_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_id(var_id, var_script_case_init, do_ajax_form_Clientes_validate_id_cb);
  } // do_ajax_form_Clientes_validate_id

  function do_ajax_form_Clientes_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_id_cb

  // ---------- Validate nome
  function do_ajax_form_Clientes_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_nome(var_nome, var_script_case_init, do_ajax_form_Clientes_validate_nome_cb);
  } // do_ajax_form_Clientes_validate_nome

  function do_ajax_form_Clientes_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_nome_cb

  // ---------- Validate empresa
  function do_ajax_form_Clientes_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_Clientes_validate_empresa_cb);
  } // do_ajax_form_Clientes_validate_empresa

  function do_ajax_form_Clientes_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_empresa_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_Clientes_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_Clientes_validate_sc_field_0_cb);
  } // do_ajax_form_Clientes_validate_sc_field_0

  function do_ajax_form_Clientes_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_sc_field_0_cb

  // ---------- Validate email
  function do_ajax_form_Clientes_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_email(var_email, var_script_case_init, do_ajax_form_Clientes_validate_email_cb);
  } // do_ajax_form_Clientes_validate_email

  function do_ajax_form_Clientes_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_email_cb

  // ---------- Validate tel
  function do_ajax_form_Clientes_validate_tel()
  {
    var nomeCampo_tel = "tel";
    var var_tel = scAjaxGetFieldText(nomeCampo_tel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_tel(var_tel, var_script_case_init, do_ajax_form_Clientes_validate_tel_cb);
  } // do_ajax_form_Clientes_validate_tel

  function do_ajax_form_Clientes_validate_tel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tel";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_tel_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_Clientes_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_Clientes_validate_sc_field_1_cb);
  } // do_ajax_form_Clientes_validate_sc_field_1

  function do_ajax_form_Clientes_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_sc_field_1_cb

  // ---------- Validate cep
  function do_ajax_form_Clientes_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_cep(var_cep, var_script_case_init, do_ajax_form_Clientes_validate_cep_cb);
  } // do_ajax_form_Clientes_validate_cep

  function do_ajax_form_Clientes_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_cep_cb

  // ---------- Validate plano
  function do_ajax_form_Clientes_validate_plano()
  {
    var nomeCampo_plano = "plano";
    var var_plano = scAjaxGetFieldText(nomeCampo_plano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_plano(var_plano, var_script_case_init, do_ajax_form_Clientes_validate_plano_cb);
  } // do_ajax_form_Clientes_validate_plano

  function do_ajax_form_Clientes_validate_plano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "plano";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_plano_cb

  // ---------- Validate sistema
  function do_ajax_form_Clientes_validate_sistema()
  {
    var nomeCampo_sistema = "sistema";
    var var_sistema = scAjaxGetFieldText(nomeCampo_sistema);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_sistema(var_sistema, var_script_case_init, do_ajax_form_Clientes_validate_sistema_cb);
  } // do_ajax_form_Clientes_validate_sistema

  function do_ajax_form_Clientes_validate_sistema_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sistema";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_sistema_cb

  // ---------- Validate valor
  function do_ajax_form_Clientes_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_valor(var_valor, var_script_case_init, do_ajax_form_Clientes_validate_valor_cb);
  } // do_ajax_form_Clientes_validate_valor

  function do_ajax_form_Clientes_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_valor_cb

  // ---------- Validate tag
  function do_ajax_form_Clientes_validate_tag()
  {
    var nomeCampo_tag = "tag";
    var var_tag = scAjaxGetFieldText(nomeCampo_tag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_tag(var_tag, var_script_case_init, do_ajax_form_Clientes_validate_tag_cb);
  } // do_ajax_form_Clientes_validate_tag

  function do_ajax_form_Clientes_validate_tag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tag";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_tag_cb

  // ---------- Validate ip
  function do_ajax_form_Clientes_validate_ip()
  {
    var nomeCampo_ip = "ip";
    var var_ip = scAjaxGetFieldText(nomeCampo_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_ip(var_ip, var_script_case_init, do_ajax_form_Clientes_validate_ip_cb);
  } // do_ajax_form_Clientes_validate_ip

  function do_ajax_form_Clientes_validate_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_ip_cb

  // ---------- Validate data_time
  function do_ajax_form_Clientes_validate_data_time()
  {
    var nomeCampo_data_time = "data_time";
    var var_data_time = scAjaxGetFieldText(nomeCampo_data_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_validate_data_time(var_data_time, var_script_case_init, do_ajax_form_Clientes_validate_data_time_cb);
  } // do_ajax_form_Clientes_validate_data_time

  function do_ajax_form_Clientes_validate_data_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_validate_data_time_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_Clientes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_Clientes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_Clientes_submit_form(var_id, var_nome, var_empresa, var_sc_field_0, var_email, var_tel, var_sc_field_1, var_cep, var_plano, var_sistema, var_valor, var_tag, var_ip, var_data_time, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_Clientes_submit_form_cb);
  } // do_ajax_form_Clientes_submit_form

  function do_ajax_form_Clientes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_Clientes_submit_form_cb_after_alert);
  } // do_ajax_form_Clientes_submit_form_cb
  function do_ajax_form_Clientes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_Clientes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_Clientes_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_Clientes_navigate_form, function() {});
    } else {
      perform_ajax_form_Clientes_navigate_form();
    }
  }

  function perform_ajax_form_Clientes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_Clientes_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_Clientes_navigate_form_cb);
  } // do_ajax_form_Clientes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_Clientes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_Clientes_navigate_form_cb_after_alert);
  } // do_ajax_form_Clientes_navigate_form_cb
  function do_ajax_form_Clientes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_Clientes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_Clientes_navigate_form_cb_after_alert
  function sc_hide_form_Clientes_form()
  {
