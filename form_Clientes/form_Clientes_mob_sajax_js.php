  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_Clientes_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_Clientes_mob_form();
	}
  ...
  // ---------- Validate id
  function do_ajax_form_Clientes_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_id(var_id, var_script_case_init, do_ajax_form_Clientes_mob_validate_id_cb);
  } // do_ajax_form_Clientes_mob_validate_id

  function do_ajax_form_Clientes_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_id_cb

  // ---------- Validate nome
  function do_ajax_form_Clientes_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_Clientes_mob_validate_nome_cb);
  } // do_ajax_form_Clientes_mob_validate_nome

  function do_ajax_form_Clientes_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_nome_cb

  // ---------- Validate empresa
  function do_ajax_form_Clientes_mob_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_empresa(var_empresa, var_script_case_init, do_ajax_form_Clientes_mob_validate_empresa_cb);
  } // do_ajax_form_Clientes_mob_validate_empresa

  function do_ajax_form_Clientes_mob_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_empresa_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_Clientes_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_Clientes_mob_validate_sc_field_0_cb);
  } // do_ajax_form_Clientes_mob_validate_sc_field_0

  function do_ajax_form_Clientes_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_sc_field_0_cb

  // ---------- Validate email
  function do_ajax_form_Clientes_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_email(var_email, var_script_case_init, do_ajax_form_Clientes_mob_validate_email_cb);
  } // do_ajax_form_Clientes_mob_validate_email

  function do_ajax_form_Clientes_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_email_cb

  // ---------- Validate tel
  function do_ajax_form_Clientes_mob_validate_tel()
  {
    var nomeCampo_tel = "tel";
    var var_tel = scAjaxGetFieldText(nomeCampo_tel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_tel(var_tel, var_script_case_init, do_ajax_form_Clientes_mob_validate_tel_cb);
  } // do_ajax_form_Clientes_mob_validate_tel

  function do_ajax_form_Clientes_mob_validate_tel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tel";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_tel_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_Clientes_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_Clientes_mob_validate_sc_field_1_cb);
  } // do_ajax_form_Clientes_mob_validate_sc_field_1

  function do_ajax_form_Clientes_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sc_field_1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_sc_field_1_cb

  // ---------- Validate cep
  function do_ajax_form_Clientes_mob_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_cep(var_cep, var_script_case_init, do_ajax_form_Clientes_mob_validate_cep_cb);
  } // do_ajax_form_Clientes_mob_validate_cep

  function do_ajax_form_Clientes_mob_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_cep_cb

  // ---------- Validate plano
  function do_ajax_form_Clientes_mob_validate_plano()
  {
    var nomeCampo_plano = "plano";
    var var_plano = scAjaxGetFieldText(nomeCampo_plano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_plano(var_plano, var_script_case_init, do_ajax_form_Clientes_mob_validate_plano_cb);
  } // do_ajax_form_Clientes_mob_validate_plano

  function do_ajax_form_Clientes_mob_validate_plano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "plano";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_plano_cb

  // ---------- Validate sistema
  function do_ajax_form_Clientes_mob_validate_sistema()
  {
    var nomeCampo_sistema = "sistema";
    var var_sistema = scAjaxGetFieldText(nomeCampo_sistema);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_sistema(var_sistema, var_script_case_init, do_ajax_form_Clientes_mob_validate_sistema_cb);
  } // do_ajax_form_Clientes_mob_validate_sistema

  function do_ajax_form_Clientes_mob_validate_sistema_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sistema";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_sistema_cb

  // ---------- Validate valor
  function do_ajax_form_Clientes_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_Clientes_mob_validate_valor_cb);
  } // do_ajax_form_Clientes_mob_validate_valor

  function do_ajax_form_Clientes_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_valor_cb

  // ---------- Validate tag
  function do_ajax_form_Clientes_mob_validate_tag()
  {
    var nomeCampo_tag = "tag";
    var var_tag = scAjaxGetFieldText(nomeCampo_tag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_tag(var_tag, var_script_case_init, do_ajax_form_Clientes_mob_validate_tag_cb);
  } // do_ajax_form_Clientes_mob_validate_tag

  function do_ajax_form_Clientes_mob_validate_tag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tag";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_tag_cb

  // ---------- Validate ip
  function do_ajax_form_Clientes_mob_validate_ip()
  {
    var nomeCampo_ip = "ip";
    var var_ip = scAjaxGetFieldText(nomeCampo_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_ip(var_ip, var_script_case_init, do_ajax_form_Clientes_mob_validate_ip_cb);
  } // do_ajax_form_Clientes_mob_validate_ip

  function do_ajax_form_Clientes_mob_validate_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_ip_cb

  // ---------- Validate data_time
  function do_ajax_form_Clientes_mob_validate_data_time()
  {
    var nomeCampo_data_time = "data_time";
    var var_data_time = scAjaxGetFieldText(nomeCampo_data_time);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Clientes_mob_validate_data_time(var_data_time, var_script_case_init, do_ajax_form_Clientes_mob_validate_data_time_cb);
  } // do_ajax_form_Clientes_mob_validate_data_time

  function do_ajax_form_Clientes_mob_validate_data_time_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_time";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Clientes_mob_validate_data_time_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_Clientes_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_Clientes_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_sc_field_1 = scAjaxGetFieldText("sc_field_1");
    var var_cep = scAjaxGetFieldText("cep");
    var var_plano = scAjaxGetFieldText("plano");
    var var_sistema = scAjaxGetFieldText("sistema");
    var var_valor = scAjaxGetFieldText("valor");
    var var_tag = scAjaxGetFieldText("tag");
    var var_ip = scAjaxGetFieldText("ip");
    var var_data_time = scAjaxGetFieldText("data_time");
    ...
    scAjaxProcOn();
    x_ajax_form_Clientes_mob_submit_form(var_id, var_nome, var_empresa, var_sc_field_0, var_email, var_tel, var_sc_field_1, var_cep, var_plano, var_sistema, var_valor, var_tag, var_ip, var_data_time, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_Clientes_mob_submit_form_cb);
  } // do_ajax_form_Clientes_mob_submit_form

  function do_ajax_form_Clientes_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("sc_field_1");
      scAjaxHideErrorDisplay("cep");
      scAjaxHideErrorDisplay("plano");
      scAjaxHideErrorDisplay("sistema");
      scAjaxHideErrorDisplay("valor");
      scAjaxHideErrorDisplay("tag");
      scAjaxHideErrorDisplay("ip");
      scAjaxHideErrorDisplay("data_time");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_Clientes_mob_submit_form_cb_after_alert);
  } // do_ajax_form_Clientes_mob_submit_form_cb
  function do_ajax_form_Clientes_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_Clientes_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_Clientes_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_Clientes_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_Clientes_mob_navigate_form();
    }
  }

  function perform_ajax_form_Clientes_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_Clientes_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_Clientes_mob_navigate_form_cb);
  } // do_ajax_form_Clientes_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_Clientes_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_Clientes_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_Clientes_mob_navigate_form_cb
  function do_ajax_form_Clientes_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_Clientes_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_Clientes_mob_navigate_form_cb_after_alert
  function sc_hide_form_Clientes_mob_form()
  {
  ...
  ajax_field_list[2] = "empresa";
  ajax_field_list[3] = "sc_field_0";
  ajax_field_list[4] = "email";
  ajax_field_list[5] = "tel";
  ajax_field_list[6] = "sc_field_1";
  ajax_field_list[7] = "cep";
  ajax_field_list[8] = "plano";
  ajax_field_list[9] = "sistema";
  ajax_field_list[10] = "valor";
  ajax_field_list[11] = "tag";
  ajax_field_list[12] = "ip";
  ajax_field_list[13] = "data_time";
  ...
  var ajax_error_list = {
    ...
    "sc_field_0": {"label": "CNPJ/CPF", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tel": {"label": "Tel", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_1": {"label": "Endereço", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cep": {"label": "CEP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "plano": {"label": "Plano", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sistema": {"label": "Sistema", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valor": {"label": "Valor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tag": {"label": "TAG", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ip": {"label": "IP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_time": {"label": "DATA TIME", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["sc_field_1"][1] = "sc_field_1";
  ajax_field_mult["cep"][1] = "cep";
  ajax_field_mult["plano"][1] = "plano";
  ajax_field_mult["sistema"][1] = "sistema";
  ajax_field_mult["valor"][1] = "valor";
  ajax_field_mult["tag"][1] = "tag";
  ajax_field_mult["ip"][1] = "ip";
  ajax_field_mult["data_time"][1] = "data_time";
  ...
  var ajax_field_id = {
    ...
    "sc_field_0": new Array("hidden_field_label_sc_field_0", "hidden_field_data_sc_field_0"),
    ...
    "sc_field_1": new Array("hidden_field_label_sc_field_1", "hidden_field_data_sc_field_1"),
    "cep": new Array("hidden_field_label_cep", "hidden_field_data_cep"),
    "plano": new Array("hidden_field_label_plano", "hidden_field_data_plano"),
    "sistema": new Array("hidden_field_label_sistema", "hidden_field_data_sistema"),
    "valor": new Array("hidden_field_label_valor", "hidden_field_data_valor"),
    "tag": new Array("hidden_field_label_tag", "hidden_field_data_tag"),
    "ip": new Array("hidden_field_label_ip", "hidden_field_data_ip"),
    "data_time": new Array("hidden_field_label_data_time", "hidden_field_data_data_time")
  };
