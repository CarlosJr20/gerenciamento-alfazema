...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " Clientes"); } else { echo strip_tags("" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " Clientes"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_Clientes_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_Clientes_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body . $vertical_center; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_Clientes']['error_buffer']) && '' != $_SESSION['scriptcase']['form_Clientes']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_Clientes']['error_buffer'];
}
...
<?php
 include_once("form_Clientes_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_Clientes_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_Clientes_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_Clientes_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "" . $this->Ini->Nm_lang['lang_othr_frmi_title'] . " Clientes"; } else { echo "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " Clientes"; } ?></div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['fast_search'][2] : "";
...
<?php 
          ...
          $SC_Label_atu['id'] = (isset($this->nm_new_label['id'])) ? $this->nm_new_label['id'] : 'Id'; 
          ...
          $SC_Label_atu['sc_field_0'] = (isset($this->nm_new_label['sc_field_0'])) ? $this->nm_new_label['sc_field_0'] : 'CNPJ/CPF'; 
          $SC_Label_atu['email'] = (isset($this->nm_new_label['email'])) ? $this->nm_new_label['email'] : 'Email'; 
          $SC_Label_atu['tel'] = (isset($this->nm_new_label['tel'])) ? $this->nm_new_label['tel'] : 'Tel'; 
          $SC_Label_atu['sc_field_1'] = (isset($this->nm_new_label['sc_field_1'])) ? $this->nm_new_label['sc_field_1'] : 'Endereço'; 
          $SC_Label_atu['cep'] = (isset($this->nm_new_label['cep'])) ? $this->nm_new_label['cep'] : 'CEP'; 
          $SC_Label_atu['plano'] = (isset($this->nm_new_label['plano'])) ? $this->nm_new_label['plano'] : 'Plano'; 
          $SC_Label_atu['sistema'] = (isset($this->nm_new_label['sistema'])) ? $this->nm_new_label['sistema'] : 'Sistema'; 
          $SC_Label_atu['valor'] = (isset($this->nm_new_label['valor'])) ? $this->nm_new_label['valor'] : 'Valor'; 
          $SC_Label_atu['tag'] = (isset($this->nm_new_label['tag'])) ? $this->nm_new_label['tag'] : 'TAG'; 
          $SC_Label_atu['ip'] = (isset($this->nm_new_label['ip'])) ? $this->nm_new_label['ip'] : 'IP'; 
          $SC_Label_atu['data_time'] = (isset($this->nm_new_label['data_time'])) ? $this->nm_new_label['data_time'] : 'DATA TIME'; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bnovo", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-16", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bincluir", "scBtnFn_sys_format_inc()", "scBtnFn_sys_format_inc()", "sc_b_ins_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-17", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcancelar", "scBtnFn_sys_format_cnl()", "scBtnFn_sys_format_cnl()", "sc_b_sai_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-18", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "balterar", "scBtnFn_sys_format_alt()", "scBtnFn_sys_format_alt()", "sc_b_upd_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-19", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-20", "", "group_2");?>
  </div>
...
<?php echo nmButtonOutput($this->arr_buttons, "bcopy", "scBtnFn_sys_format_copy()", "scBtnFn_sys_format_copy()", "sc_b_clone_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-22", "", "group_2");?>
  </div>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "breload", "scBtnFn_sys_format_reload()", "scBtnFn_sys_format_reload()", "sc_b_reload_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-23", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['sc_field_0'] = "CNPJ/CPF";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php
   ...
   $sStyleReadInp_tel = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['tel']) && $this->nmgp_cmp_readonly['tel'] == 'on')
   {
       $bTestReadOnly = false;
...
<input type="hidden" name="tel" value="<?php echo $this->form_encode_input($tel) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_tel_line" id="hidden_field_data_tel" style="<?php echo $sStyleHidden_tel; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tel_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tel_label" style=""><span id="id_label_tel"><?php echo $this->nm_new_label['tel']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["tel"]) &&  $this->nmgp_cmp_readonly["tel"] == "on") { 

 ?>
<input type="hidden" name="tel" value="<?php echo $this->form_encode_input($tel) . "\">" . $tel . ""; ?>
<?php } else { ?>
<span id="id_read_on_tel" class="sc-ui-readonly-tel css_tel_line" style="<?php echo $sStyleReadLab_tel; ?>"><?php echo $this->form_format_readonly("tel", $this->form_encode_input($this->tel)); ?></span><span id="id_read_off_tel" class="css_read_off_tel<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_tel; ?>">
 <input class="sc-js-input scFormObjectOdd css_tel_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_tel" type=text name="tel" value="<?php echo $this->form_encode_input($tel) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=35"; } ?> maxlength=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_tel_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_tel_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['sc_field_1'] = "Endereço";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<span id="id_read_on_sc_field_1" class="sc-ui-readonly-sc_field_1 css_sc_field_1_line" style="<?php echo $sStyleReadLab_sc_field_1; ?>"><?php echo $this->form_format_readonly("sc_field_1", $this->form_encode_input($this->sc_field_1)); ?></span><span id="id_read_off_sc_field_1" class="css_read_off_sc_field_1<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sc_field_1; ?>">
 <input class="sc-js-input scFormObjectOdd css_sc_field_1_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_sc_field_1" type=text name="sc_field_1" value="<?php echo $this->form_encode_input($sc_field_1) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=35"; } ?> maxlength=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_cep" class="sc-ui-readonly-cep css_cep_line" style="<?php echo $sStyleReadLab_cep; ?>"><?php echo $this->form_format_readonly("cep", $this->form_encode_input($this->cep)); ?></span><span id="id_read_off_cep" class="css_read_off_cep<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_cep; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=29"; } ?> maxlength=29 alt="{datatype: 'text', maxLength: 29, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['plano']))
    {
        $this->nm_new_label['plano'] = "Plano";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $plano = $this->plano;
   $sStyleHidden_plano = '';
   if (isset($this->nmgp_cmp_hidden['plano']) && $this->nmgp_cmp_hidden['plano'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['plano']);
       $sStyleHidden_plano = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_plano = 'display: none;';
   $sStyleReadInp_plano = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['plano']) && $this->nmgp_cmp_readonly['plano'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['plano']);
       $sStyleReadLab_plano = '';
       $sStyleReadInp_plano = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['plano']) && $this->nmgp_cmp_hidden['plano'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="plano" value="<?php echo $this->form_encode_input($plano) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_plano_line" id="hidden_field_data_plano" style="<?php echo $sStyleHidden_plano; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_plano_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_plano_label" style=""><span id="id_label_plano"><?php echo $this->nm_new_label['plano']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["plano"]) &&  $this->nmgp_cmp_readonly["plano"] == "on") { 

 ?>
<input type="hidden" name="plano" value="<?php echo $this->form_encode_input($plano) . "\">" . $plano . ""; ?>
<?php } else { ?>
<span id="id_read_on_plano" class="sc-ui-readonly-plano css_plano_line" style="<?php echo $sStyleReadLab_plano; ?>"><?php echo $this->form_format_readonly("plano", $this->form_encode_input($this->plano)); ?></span><span id="id_read_off_plano" class="css_read_off_plano<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_plano; ?>">
 <input class="sc-js-input scFormObjectOdd css_plano_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_plano" type=text name="plano" value="<?php echo $this->form_encode_input($plano) ?>"
...
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_plano_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_plano_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['sistema']))
    {
        $this->nm_new_label['sistema'] = "Sistema";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   ...
   $sStyleHidden_sistema = '';
   if (isset($this->nmgp_cmp_hidden['sistema']) && $this->nmgp_cmp_hidden['sistema'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['sistema']);
       $sStyleHidden_sistema = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_sistema = 'display: none;';
   $sStyleReadInp_sistema = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['sistema']) && $this->nmgp_cmp_readonly['sistema'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['sistema']);
       $sStyleReadLab_sistema = '';
       $sStyleReadInp_sistema = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['sistema']) && $this->nmgp_cmp_hidden['sistema'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="sistema" value="<?php echo $this->form_encode_input($sistema) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_sistema_line" id="hidden_field_data_sistema" style="<?php echo $sStyleHidden_sistema; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sistema_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_sistema_label" style=""><span id="id_label_sistema"><?php echo $this->nm_new_label['sistema']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sistema"]) &&  $this->nmgp_cmp_readonly["sistema"] == "on") { 

 ?>
<input type="hidden" name="sistema" value="<?php echo $this->form_encode_input($sistema) . "\">" . $sistema . ""; ?>
<?php } else { ?>
<span id="id_read_on_sistema" class="sc-ui-readonly-sistema css_sistema_line" style="<?php echo $sStyleReadLab_sistema; ?>"><?php echo $this->form_format_readonly("sistema", $this->form_encode_input($this->sistema)); ?></span><span id="id_read_off_sistema" class="css_read_off_sistema<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sistema; ?>">
 <input class="sc-js-input scFormObjectOdd css_sistema_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_sistema" type=text name="sistema" value="<?php echo $this->form_encode_input($sistema) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=35"; } ?> maxlength=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_sistema_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_sistema_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<input type="hidden" name="tag" value="<?php echo $this->form_encode_input($tag) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_tag_line" id="hidden_field_data_tag" style="<?php echo $sStyleHidden_tag; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tag_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tag_label" style=""><span id="id_label_tag"><?php echo $this->nm_new_label['tag']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["tag"]) &&  $this->nmgp_cmp_readonly["tag"] == "on") { 

 ?>
<input type="hidden" name="tag" value="<?php echo $this->form_encode_input($tag) . "\">" . $tag . ""; ?>
<?php } else { ?>
<span id="id_read_on_tag" class="sc-ui-readonly-tag css_tag_line" style="<?php echo $sStyleReadLab_tag; ?>"><?php echo $this->form_format_readonly("tag", $this->form_encode_input($this->tag)); ?></span><span id="id_read_off_tag" class="css_read_off_tag<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_tag; ?>">
 <input class="sc-js-input scFormObjectOdd css_tag_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_tag" type=text name="tag" value="<?php echo $this->form_encode_input($tag) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=11"; } ?> alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['tag']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['tag']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['tag']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ip_line" id="hidden_field_data_ip" style="<?php echo $sStyleHidden_ip; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ip_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ip_label" style=""><span id="id_label_ip"><?php echo $this->nm_new_label['ip']; ?></span></span><br>
...
<?php } else { ?>
<span id="id_read_on_ip" class="sc-ui-readonly-ip css_ip_line" style="<?php echo $sStyleReadLab_ip; ?>"><?php echo $this->form_format_readonly("ip", $this->form_encode_input($this->ip)); ?></span><span id="id_read_off_ip" class="css_read_off_ip<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_ip; ?>">
 <input class="sc-js-input scFormObjectOdd css_ip_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_ip" type=text name="ip" value="<?php echo $this->form_encode_input($ip) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=35"; } ?> maxlength=35 alt="{datatype: 'text', maxLength: 35, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    if (!isset($this->nm_new_label['data_time']))
    {
        $this->nm_new_label['data_time'] = "DATA TIME";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
   $nm_img_fun_cel  = ($nm_img_fun_cel  == $this->Ini->img_fun_imp    ? $this->Ini->img_fun_par  : $this->Ini->img_fun_imp);
   $old_dt_data_time = $this->data_time;
   if (strlen($this->data_time_hora) > 8 ) {$this->data_time_hora = substr($this->data_time_hora, 0, 8);}
   $this->data_time .= ' ' . $this->data_time_hora;
   $this->data_time  = trim($this->data_time);
   $data_time = $this->data_time;
   $sStyleHidden_data_time = '';
   if (isset($this->nmgp_cmp_hidden['data_time']) && $this->nmgp_cmp_hidden['data_time'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['data_time']);
       $sStyleHidden_data_time = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_data_time = 'display: none;';
   $sStyleReadInp_data_time = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['data_time']) && $this->nmgp_cmp_readonly['data_time'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['data_time']);
       $sStyleReadLab_data_time = '';
       $sStyleReadInp_data_time = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['data_time']) && $this->nmgp_cmp_hidden['data_time'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="data_time" value="<?php echo $this->form_encode_input($data_time) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_data_time_line" id="hidden_field_data_data_time" style="<?php echo $sStyleHidden_data_time; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_time_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_time_label" style=""><span id="id_label_data_time"><?php echo $this->nm_new_label['data_time']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['php_cmp_required']['data_time']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['php_cmp_required']['data_time'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["data_time"]) &&  $this->nmgp_cmp_readonly["data_time"] == "on") { 

 ?>
<input type="hidden" name="data_time" value="<?php echo $this->form_encode_input($data_time) . "\">" . $data_time . ""; ?>
<?php } else { ?>
<span id="id_read_on_data_time" class="sc-ui-readonly-data_time css_data_time_line" style="<?php echo $sStyleReadLab_data_time; ?>"><?php echo $this->form_format_readonly("data_time", $this->form_encode_input($data_time)); ?></span><span id="id_read_off_data_time" class="css_read_off_data_time<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_data_time; ?>"><?php
$tmp_form_data = $this->field_config['data_time']['date_format'];
...
<span class='trigger-picker-<?php echo $miniCalendarButton[1]; ?>' style='display: inherit; width: 100%'>
 ...
 <input class="sc-js-input scFormObjectOdd css_data_time_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_data_time" type=text name="data_time" value="<?php echo $this->form_encode_input($data_time) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=18"; } ?> alt="{datatype: 'datetime', dateSep: '<?php echo $this->field_config['data_time']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['data_time']['date_format']; ?>', timeSep: '<?php echo $this->field_config['data_time']['time_sep']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span>
&nbsp;<span class="scFormDataHelpOdd"><?php echo $tmp_form_data; ?></span></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_data_time_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_data_time_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
<?php
   $this->data_time = $old_dt_data_time;
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_Clientes_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_Clientes_mob");
 parent.scAjaxDetailHeight("form_Clientes_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_copy() {
		if ($("#sc_b_clone_t.sc-unique-btn-22").length && $("#sc_b_clone_t.sc-unique-btn-22").is(":visible")) {
			nm_move ('clone');
			 return;
		}
	}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
