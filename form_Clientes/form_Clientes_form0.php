...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_empresa_label" id="hidden_field_label_empresa" style="<?php echo $sStyleHidden_empresa; ?>"><span id="id_label_empresa"><?php echo $this->nm_new_label['empresa']; ?></span></TD>
    <TD class="scFormDataOdd css_empresa_line" id="hidden_field_data_empresa" style="<?php echo $sStyleHidden_empresa; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_empresa_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_plano_label" id="hidden_field_label_plano" style="<?php echo $sStyleHidden_plano; ?>"><span id="id_label_plano"><?php echo $this->nm_new_label['plano']; ?></span></TD>
    <TD class="scFormDataOdd css_plano_line" id="hidden_field_data_plano" style="<?php echo $sStyleHidden_plano; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_plano_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_sistema_label" id="hidden_field_label_sistema" style="<?php echo $sStyleHidden_sistema; ?>"><span id="id_label_sistema"><?php echo $this->nm_new_label['sistema']; ?></span></TD>
    <TD class="scFormDataOdd css_sistema_line" id="hidden_field_data_sistema" style="<?php echo $sStyleHidden_sistema; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_sistema_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_time_label" id="hidden_field_label_data_time" style="<?php echo $sStyleHidden_data_time; ?>"><span id="id_label_data_time"><?php echo $this->nm_new_label['data_time']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes']['php_cmp_required']['data_time']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Clientes']['php_cmp_required']['data_time'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_data_time_line" id="hidden_field_data_data_time" style="<?php echo $sStyleHidden_data_time; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_time_line" style="vertical-align: top;padding: 0px">
