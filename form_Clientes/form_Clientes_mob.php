...
//
   ...
   $_SESSION['scriptcase']['form_Clientes_mob']['glo_nm_perfil']          = "conn_banco_de_dados";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['form_Clientes_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'gestao_focus_pronto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['form_Clientes_mob']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['form_Clientes_mob']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['form_Clientes_mob']['glo_nm_conexao'], $this->root . $this->path_prod, 'gestao_focus_pronto', 1, $this->force_db_utf8);
    }
    else {
...
//
    ...
    {
        if ('ajax_form_Clientes_mob_validate_id' == $_POST['rs'])
        {
            $id = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_nome' == $_POST['rs'])
        {
            $nome = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_empresa' == $_POST['rs'])
        {
            $empresa = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_sc_field_0' == $_POST['rs'])
        {
            $sc_field_0 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_email' == $_POST['rs'])
        {
            $email = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_tel' == $_POST['rs'])
        {
            $tel = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_sc_field_1' == $_POST['rs'])
        {
            $sc_field_1 = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_cep' == $_POST['rs'])
        {
            $cep = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_plano' == $_POST['rs'])
        {
            $plano = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_sistema' == $_POST['rs'])
        {
            $sistema = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_valor' == $_POST['rs'])
        {
            $valor = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_tag' == $_POST['rs'])
        {
            $tag = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_ip' == $_POST['rs'])
        {
            $ip = NM_utf8_urldecode($_POST['rsargs'][0]);
            $script_case_init = NM_utf8_urldecode($_POST['rsargs'][1]);
        }
        if ('ajax_form_Clientes_mob_validate_data_time' == $_POST['rs'])
        {
    ...
    if (isset($_SESSION['scriptcase']['form_Clientes_mob']['session_timeout']['lang'])) {
        $STR_lang = $_SESSION['scriptcase']['form_Clientes_mob']['session_timeout']['lang'];
    }
    ...
    if (!isset($_SESSION['scriptcase']['form_Clientes_mob']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_Clientes']) || $_SESSION['scriptcase']['sc_apl_seg']['form_Clientes'] != "on"))
    { 
        $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
        $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['form_Clientes_mob']['iframe_menu']) ? false : true;
...
<?php
    ...
    sajax_init();
    //$sajax_debug_mode = 1;
    sajax_export("ajax_form_Clientes_mob_validate_id");
    sajax_export("ajax_form_Clientes_mob_validate_nome");
    sajax_export("ajax_form_Clientes_mob_validate_empresa");
    sajax_export("ajax_form_Clientes_mob_validate_sc_field_0");
    sajax_export("ajax_form_Clientes_mob_validate_email");
    sajax_export("ajax_form_Clientes_mob_validate_tel");
    sajax_export("ajax_form_Clientes_mob_validate_sc_field_1");
    sajax_export("ajax_form_Clientes_mob_validate_cep");
    sajax_export("ajax_form_Clientes_mob_validate_plano");
    sajax_export("ajax_form_Clientes_mob_validate_sistema");
    sajax_export("ajax_form_Clientes_mob_validate_valor");
    sajax_export("ajax_form_Clientes_mob_validate_tag");
    sajax_export("ajax_form_Clientes_mob_validate_ip");
    sajax_export("ajax_form_Clientes_mob_validate_data_time");
...
//
    ...
    function ajax_form_Clientes_mob_validate_id($id, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        ...
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_id';
    ...
    function ajax_form_Clientes_mob_validate_nome($nome, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_nome';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_empresa($empresa, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_empresa';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_sc_field_0($sc_field_0, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_sc_field_0';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_email($email, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_email';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_tel($tel, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_tel';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_sc_field_1($sc_field_1, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_sc_field_1';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_cep($cep, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_cep';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_plano($plano, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_plano';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_sistema($sistema, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_sistema';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_valor($valor, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_valor';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_tag($tag, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_tag';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_ip($ip, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_ip';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_validate_data_time($data_time, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_opcao         = 'validate_data_time';
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_info['param'] = array(
    ...
    function ajax_form_Clientes_mob_submit_form($id, $nome, $empresa, $sc_field_0, $email, $tel, $sc_field_1, $cep, $plano, $sistema, $valor, $tag, $ip, $data_time, $nm_form_submit, $nmgp_url_saida, $nmgp_opcao, $nmgp_ancora, $nmgp_num_form, $nmgp_parms, $script_case_init, $csrf_token)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
    ...
    function ajax_form_Clientes_mob_navigate_form($id, $nm_form_submit, $nmgp_opcao, $nmgp_ordem, $nmgp_fast_search, $nmgp_cond_fast_search, $nmgp_arg_fast_search, $nmgp_arg_dyn_search, $script_case_init)
    {
        global $inicial_form_Clientes_mob;
        //register_shutdown_function("form_Clientes_mob_pack_ajax_response");
        $inicial_form_Clientes_mob->contr_form_Clientes_mob->NM_ajax_flag          = true;
