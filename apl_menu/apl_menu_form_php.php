...
class apl_menu_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['apl_menu']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['apl_menu']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['apl_menu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['apl_menu']['sc_apl_link'];
...
<?php
    exit;
      ...
      $_SESSION['scriptcase']['apl_menu']['contr_erro'] = 'on';
 if($this->sc_script_name == 'apl_Login'){
...
$_SESSION['scriptcase']['apl_menu']['contr_erro'] = 'off';
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['apl_menu'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("apl_grid_sec_users") . "/?nm_run_menu=1&nm_apl_menu=apl_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_3")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("apl_grid_sec_apps") . "/?nm_run_menu=1&nm_apl_menu=apl_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_4")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("apl_grid_sec_groups") . "/?nm_run_menu=1&nm_apl_menu=apl_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_11")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("apl_grid_sec_users_groups") . "/?nm_run_menu=1&nm_apl_menu=apl_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_5")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("apl_search_sec_groups") . "/?nm_run_menu=1&nm_apl_menu=apl_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_6")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("apl_sync_apps") . "/?nm_run_menu=1&nm_apl_menu=apl_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_7")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("apl_change_pswd") . "/?nm_run_menu=1&nm_apl_menu=apl_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_8")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("apl_Login") . "/?script_case_init=" . $_SESSION['sc_session'][1]['apl_menu']['init'] . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="apl_menu"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "apl_menu")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'apl_menu', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new apl_menu_form_php();
$controle->init();
?>
