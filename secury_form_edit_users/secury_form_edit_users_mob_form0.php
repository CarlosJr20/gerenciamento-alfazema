...
<style type="text/css">
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>secury_form_edit_users/secury_form_edit_users_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("secury_form_edit_users_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('secury_form_edit_users_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body . $vertical_center; ?>">
<?php

if (isset($_SESSION['scriptcase']['secury_form_edit_users']['error_buffer']) && '' != $_SESSION['scriptcase']['secury_form_edit_users']['error_buffer'])
{
    echo $_SESSION['scriptcase']['secury_form_edit_users']['error_buffer'];
}
...
<?php
 include_once("secury_form_edit_users_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="secury_form_edit_users_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['secury_form_edit_users_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['secury_form_edit_users_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<span id="id_read_on_login" class="sc-ui-readonly-login css_login_line" style="<?php echo $sStyleReadLab_login; ?>"><?php echo $this->form_format_readonly("login", $this->form_encode_input($this->login)); ?></span><span id="id_read_off_login" class="css_read_off_login<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_login; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=32"; } ?> maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php 
  ...
  {
      $this->active_1 = explode(";", trim($this->active));
  } 
  else
  {
...
$active_look = "";
 ...
 if (empty($active_look)) { $active_look = $this->active; }
?>
<span id="id_read_on_active" class="css_active_line" style="<?php echo $sStyleReadLab_active; ?>"><?php echo $this->form_format_readonly("active", $this->form_encode_input($active_look)); ?></span><span id="id_read_off_active" class="css_read_off_active css_active_line" style="<?php echo $sStyleReadInp_active; ?>"><?php echo "<div id=\"idAjaxCheckbox_active\" style=\"display: inline-block\" class=\"css_active_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_active_line"><?php $tempOptionId = "id-opt-active" . $sc_seq_vert . "-1"; ?>
 <div class="sc switch">
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-active sc-ui-checkbox-active" name="active[]" value="Y"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['Lookup_active'][] = 'Y'; ?>
<?php  if (in_array("Y", $this->active_1))  { echo " checked" ;} ?><?php  if (empty($this->active)) { echo " checked" ;} ?> onClick="" ><span></span>
...
<input type=hidden name="groups" value="<?php echo $this->form_encode_input($this->groups_hidden) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php 
  $this->groups_1 = array(); 
...
?> 
    ...
    <TD class="scFormDataOdd css_groups_line" id="hidden_field_data_groups" style="<?php echo $sStyleHidden_groups; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_groups_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_groups_label" style=""><span id="id_label_groups"><?php echo $this->nm_new_label['groups']; ?></span></span><br> 
<?php  
$nmgp_def_dados = "" ; 
...
else
{
   ...
   echo "<div id=\"idAjaxCheckbox_groups\" class=\"css_groups_line\" style=\"display: inline-block\">\r\n";
   $y = 0 ; 
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bexcluir", "scBtnFn_sys_format_exc()", "scBtnFn_sys_format_exc()", "sc_b_del_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "sc-unique-btn-14", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("secury_form_edit_users_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("secury_form_edit_users_mob");
 parent.scAjaxDetailHeight("secury_form_edit_users_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_edit_users_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
