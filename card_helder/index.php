<?php
   include_once('card_helder_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['card_helder']['glo_nm_perfil']          = "conn_banco_de_dados";
   $_SESSION['scriptcase']['card_helder']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['card_helder']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['card_helder']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['card_helder']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['card_helder']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['card_helder']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['card_helder']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['card_helder']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['card_helder']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['card_helder']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['card_helder']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['card_helder']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['card_helder']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['card_helder']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['card_helder']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['card_helder']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class card_helder_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['card_helder']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "card_helder"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_hr_criacao   = "194135"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20220429"; 
      $this->nm_hr_ult_alt   = "231606"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['card_helder']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['card_helder']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['card_helder']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['card_helder']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['card_helder']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['card_helder']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['card_helder']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['card_helder']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['card_helder']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/card_helder';
      ...
      $_SESSION['sc_session'][$this->sc_page]['card_helder']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['card_helder']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['card_helder']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['card_helder']['actual_lang']) || $_SESSION['scriptcase']['card_helder']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['card_helder']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("card_helder_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['card_helder']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['card_helder']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['card_helder']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['card_helder']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["card_helder"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["card_helder"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['card_helder']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['card_helder']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['card_helder']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['card_helder']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['card_helder']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['card_helder']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "card_helder_erro.class.php"); 
      $this->Erro = new card_helder_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('card_helder'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['card_helder']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['card_helder']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['card_helder']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['card_helder']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['card_helder']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['card_helder']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['card_helder']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['card_helder']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['card_helder']['glo_nm_conexao']) && $_SESSION['scriptcase']['card_helder']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['card_helder']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['card_helder']['glo_nm_perfil']) && $_SESSION['scriptcase']['card_helder']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['card_helder']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['card_helder']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['card_helder']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['card_helder']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['card_helder']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['card_helder']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['card_helder']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['card_helder']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['card_helder']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['card_helder']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['card_helder']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['card_helder']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['card_helder']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['card_helder']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['card_helder']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['card_helder']['glo_nm_conexao'], $this->root . $this->path_prod, 'gestao_focus_pronto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['card_helder']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new card_helder_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['card_helder']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['card_helder']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['card_helder']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['card_helder'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['card_helder']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['card_helder']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('card_helder') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['card_helder']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['card_helder']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['card_helder']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['card_helder']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "card_helder_erro.class.php"); 
      $this->Erro      = new card_helder_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['card_helder']['contr_erro'] = 'on';
 ?>
								...
								<!--	   <script src="<php echo sc_url_library("sys", "nav_bar_vertical", "js/static/ultimo_projeto.js"); ?>"></script> -->
									       <script>							
											$( document ).ready(function() {
											 $.ajax({
												url: "<?php echo sc_url_library("sys", "nav_bar_vertical","js/static/nome_atual.php"); ?>",
												 success: function (n) {
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                               Último Atendimento</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><div id="bloco_atualphp"></div>
 										  <script>							
											$( document ).ready(function() {
											 $.ajax({
												url: "<?php echo sc_url_library("sys", "nav_bar_vertical","js/static/atendimento_atual.php"); ?>",
												 success: function (n) {
                                        ...
                                        <div class="col-auto">
                                            <img src= '<?php echo sc_url_library("sys", "nav_bar_vertical","img/atendimento.png"); ?>' class style="width: 32px;height: 32px;"  class = 'icon' >
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Último registro
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
...
<!-- 														<div id="numero_atual"></div> -->
											...
											$( document ).ready(function() {
											 $.ajax({
												url: "<?php echo sc_url_library("sys", "nav_bar_vertical","js/static/registro_atual.php"); ?>",
												 success: function (n) {
            									  $("#numero_atual").text(n);
         												 }
                                        ...
                                        <div class="col-auto">
                                           <img src= '<?php echo sc_url_library("sys", "nav_bar_vertical","img/registro.png"); ?>' class style="width: 32px;height: 32px;"  class = 'icon' >
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
											...
											$( document ).ready(function() {
											 $.ajax({
												url: "<?php echo sc_url_library("sys", "nav_bar_vertical","js/static/leito_atual.php"); ?>",
												 success: function (n) {
            									  $("#pessoa_atual").text(n);
         												 }
                                        ...
                                        <div class="col-auto">
                                         <img src= '<?php echo sc_url_library("sys", "nav_bar_vertical","img/cama_med.png"); ?>' class style="width: 32px;height: 32px;"  class = 'icon' >
                                        </div>
                                    </div>
                                </div>
                            </div>
...
$_SESSION['scriptcase']['card_helder']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_card_helder($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['card_helder']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['card_helder']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "card_helder") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['card_helder']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['card_helder']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['card_helder']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_gestao_focus_pronto'])) {
               $_SESSION['scriptcase']['card_helder']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_gestao_focus_pronto'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['card_helder']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['card_helder']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['card_helder']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "card_helder";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'card_helder' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['card_helder']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['card_helder']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['card_helder']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['card_helder']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['card_helder']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('card_helder' == $sReferer || 'card_helder_' == substr($sReferer, 0, 12))
       {
           $_SESSION['sc_session'][$script_case_init]['card_helder']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'card_helder')
   {
       $_SESSION['sc_session'][$script_case_init]['card_helder']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['card_helder']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/card_helder_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_card_helder($cadapar[1]);
   ...
   $contr_card_helder = new card_helder_apl();
   $contr_card_helder->controle();
//
   function nm_limpa_str_card_helder(&$str)
   {
