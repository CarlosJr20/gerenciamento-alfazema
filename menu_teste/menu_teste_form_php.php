<?php
include_once('menu_teste_session.php');
session_start();
   $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']      = "";
   $_SESSION['scriptcase']['menu_teste']['glo_nm_path_imag_temp'] = "";
   ...
   //check prod
   if(empty($_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']))
   {
           /*check prod*/$_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
   }
   //check tmp
   if(empty($_SESSION['scriptcase']['menu_teste']['glo_nm_path_imag_temp']))
   {
           /*check tmp*/$_SESSION['scriptcase']['menu_teste']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   //end check publication with the prod
class menu_teste_form_php
{
      var $sc_script_name;
      var $nm_location;
   ...
   {
      $Campos_Mens_erro = "";
      $_SESSION['scriptcase']['menu_teste']['contr_erro'] = 'off';
      ...
      if(!isset($_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
      ...
      $path_libs     = $str_root . $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'] . "/lib/php";
      $path_third    = $str_root . $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'] . "/third";
      $path_adodb    = $str_root . $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'] . "/third/adodb";
      $_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_teste']['glo_nm_path_imag_temp'];
      ...
      if (isset($_SESSION['scriptcase']['menu_teste']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['menu_teste']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['menu_teste']['actual_lang']) || $_SESSION['scriptcase']['menu_teste']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['menu_teste']['actual_lang'] = $this->str_lang;
...
<?php
      ...
      if (!defined("SC_ERROR_HANDLER"))
      {
          ...
          include_once(dirname(__FILE__) . "/menu_teste_erro.php");
      }
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['menu_teste']['sc_apl_link'];
      ...
      if (isset($_SESSION['scriptcase']['menu_teste']['session_timeout']['redir'])) {
...
';
          ...
          if ($_SESSION['scriptcase']['menu_teste']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_teste']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['menu_teste']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_teste']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['menu_teste']['session_timeout']);
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['menu_teste'] = "on";
} 
if (!isset($_SESSION['scriptcase']['menu_teste']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['menu_teste']) || $_SESSION['scriptcase']['sc_apl_seg']['menu_teste'] != "on"))
{ 
...
<?php
    exit;
      ...
      if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_teste']))
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_teste'] as $id_item => $arr_item)
         {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_teste"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_teste")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_teste', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   {
        $_SESSION['scriptcase']['menu_teste']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_teste']['sc_init'][$apl_menu]] = array();
        $this->menu_sc_init = $_SESSION['scriptcase']['menu_teste']['sc_init'][$apl_menu];
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['menu_teste']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu_teste']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_teste") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_teste']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_teste']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['menu_teste']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_gestao_focus_pronto'])) {
            $_SESSION['scriptcase']['menu_teste']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_gestao_focus_pronto'];
        }
    }
}
$controle = new menu_teste_form_php();
$controle->init();
?>
