...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_teste']['glo_nm_perfil']         = "conn_nerd";
    $_SESSION['scriptcase']['menu_teste']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_teste']['glo_nm_usa_grupo']      = "";
...
class menu_teste_class
{
 ...
 function menu_teste_menu()
 {
    global $menu_teste_menuData, $nm_data_fixa;
...
$path_img_old   = $str_root . $path_link . "menu_teste/img";
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_teste');
...
include_once(dirname(__FILE__) . "/menu_teste_erro.class.php"); 
$this->Erro = new menu_teste_erro();
$str_path = substr($_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_teste']['glo_nm_conexao']);
}

/* Definição dos Caminhos */
$menu_teste_menuData         = array();
$menu_teste_menuData['path'] = array();
$menu_teste_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_teste_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_teste_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_teste_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_teste_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_teste_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_teste_menuData['url']['web']   = str_replace("\\", '/', $menu_teste_menuData['url']['web']);
$menu_teste_menuData['path']['root'] = substr($menu_teste_menuData['path']['sys'],  0, -1 * strlen($menu_teste_menuData['url']['web']));
$menu_teste_menuData['path']['app']  = substr($menu_teste_menuData['path']['sys'],  0, strrpos($menu_teste_menuData['path']['sys'],  '/'));
$menu_teste_menuData['path']['link'] = substr($menu_teste_menuData['path']['app'],  0, strrpos($menu_teste_menuData['path']['app'],  '/'));
$menu_teste_menuData['path']['link'] = substr($menu_teste_menuData['path']['link'], 0, strrpos($menu_teste_menuData['path']['link'], '/')) . '/';
$menu_teste_menuData['path']['app'] .= '/';
$menu_teste_menuData['url']['app']   = substr($menu_teste_menuData['url']['web'],  0, strrpos($menu_teste_menuData['url']['web'],  '/'));
$menu_teste_menuData['url']['link']  = substr($menu_teste_menuData['url']['app'],  0, strrpos($menu_teste_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_teste']['glo_nm_usa_grupo'] == "S")
{
    $menu_teste_menuData['url']['link']  = substr($menu_teste_menuData['url']['link'], 0, strrpos($menu_teste_menuData['url']['link'], '/'));
}
$menu_teste_menuData['url']['link']  .= '/';
$menu_teste_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_teste']['sc_apl_link'] = $menu_teste_menuData['url']['link'];
...
include_once("menu_teste_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_teste']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_teste";
     $_SESSION['scriptcase']['menu_apls']['menu_teste'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_teste']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_teste']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_teste']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_teste']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_teste']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_teste']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_teste']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_teste']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['menu_teste']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_teste']['init']))
{
    $_SESSION['sc_session'][1]['menu_teste']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_teste']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_teste']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_teste'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_teste'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_teste'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_teste'))
{
    $_SESSION['sc_session'][1]['menu_teste']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_teste'] = "javascript:window.close()";
}
/* Variáveis de Configuração do Menu */
$menu_teste_menuData['iframe'] = TRUE;
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_teste'];

$menu_teste_menuData['data'] = array();

if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_teste']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_teste']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_teste');
    $menu_teste_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_teste_help.txt"))
{
    $Arq_WebHelp = file("menu_teste_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_teste_menuData['data'][] = array(
                    ...
                    'target'   => "" . $this->menu_teste_target('_blank') . "",
                    'sc_id'    => "item_Help",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_teste']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_teste']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_teste_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_teste']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_teste_menuData['data'][$i_menu]);
       }
    ...
    $menu_teste_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_teste']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_teste']))
{
    $disable_menu = false;
    foreach ($menu_teste_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_teste']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_teste_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabeçalho HTML */
if ($menu_teste_menuData['iframe'])
{
    $menu_teste_menuData['height'] = '100%';
...
{
    $menu_teste_menuData['height'] = '30px';
}

/* Arquivos JS */
?>
<script type="text/javascript" src="../_lib/lib/js/jquery-3.6.0.min.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="menu_teste_message.js"></script>
...
Iframe_atual = "menu_teste_iframe";
...
<?php
 $seq = 0;
 if(isset($menu_teste_menuData['data']) && !empty($menu_teste_menuData['data']))
 {
   foreach ($menu_teste_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_teste_menuData['data_vertical']) && !empty($menu_teste_menuData['data_vertical']))
 {
   foreach ($menu_teste_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_teste_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_teste'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_teste').hide();
    if (str_id == "")
    {
        $('#iframe_menu_teste').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_teste_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            Iframe_atual = "menu_teste_" + Tab_iframes[i] + '_iframe';
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_teste")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_teste_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    if (str_target == "menu_teste_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_teste")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "menu_teste" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_menu_teste').length)
        $('#iframe_menu_teste')[0].contentWindow.focus();
  }
}
</script>
<?php
...
echo $this->menu_teste_escreveMenu($menu_teste_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Controle de Iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_teste_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
    ...
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_menu_teste" name="menu_teste_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_teste_pag_ini.php"); ?>"></iframe>
<?php
}
?></div></td>
  </tr>
...
/* Controle de Target */
function menu_teste_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
function menu_teste_target($str_target)
{
    global $menu_teste_menuData;
    ...
    elseif ($menu_teste_menuData['iframe'])
    {
        return 'menu_teste_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_teste_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_teste_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_teste_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_teste']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_teste_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_teste_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_teste']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_teste_target( $arr_item['target']) : "_self"; 
           }
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        return  $_SESSION['scriptcase']['menu_teste']['sc_init'][$apl_menu];
   }
...
$contr_menu_teste = new menu_teste_class;
$contr_menu_teste->menu_teste_menu();
