...
<html>
    <head>
        ...
        <title>menu_teste</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_teste"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>nerd_imog/nerd_imog_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>nerd_imog/nerd_imog_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_teste']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
        <script src="<?php echo $_SESSION["scriptcase"]["menu_teste"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_teste"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_teste_menuData["data"]) && is_array($menu_teste_menuData["data"]) && !empty($menu_teste_menuData["data"]))
    {
        foreach($menu_teste_menuData["data"] as $arr_item)
        {
    ...
    <body>
    <?php
        escreveMenuMobile($menu_teste_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
