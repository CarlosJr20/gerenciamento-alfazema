<?php
@session_start() ;
$_SESSION['scriptcase']['secury_grid_sec_apps']['sc_process_barr'] = true;
require_once('../secury_grid_sec_apps/index.php');
unset($_SESSION['scriptcase']['secury_grid_sec_apps']['sc_process_barr']);
$ExportCtrl = new secury_grid_sec_apps_export_control;
$ExportCtrl->Export_barr();

class secury_grid_sec_apps_export_control
{
