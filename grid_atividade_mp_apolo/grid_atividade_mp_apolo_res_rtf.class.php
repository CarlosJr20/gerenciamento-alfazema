...
class grid_atividade_mp_apolo_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atividade_mp_apolo']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_atividade_mp_apolo']['arr_export']['data'];
