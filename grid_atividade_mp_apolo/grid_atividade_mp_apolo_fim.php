...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_atividade_mp_apolo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_atividade_mp_apolo"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_atividade_mp_apolo'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_apolo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_apolo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_apolo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_apolo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_apolo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_atividade_mp_apolo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_apolo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_apolo']['embutida_filho'] as $ind => $sc_init)
          {
