<?php
@session_start() ;
$_SESSION['scriptcase']['grid_atividade_mp_apolo']['sc_process_barr'] = true;
require_once('../grid_atividade_mp_apolo/index.php');
unset($_SESSION['scriptcase']['grid_atividade_mp_apolo']['sc_process_barr']);
$ExportCtrl = new grid_atividade_mp_apolo_export_control;
$ExportCtrl->Export_barr();

class grid_atividade_mp_apolo_export_control
{
