<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['menu']['glo_nm_perfil']          = "conn_banco_de_dados";
   $_SESSION['scriptcase']['menu']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['menu']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['menu']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['menu']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['menu']['glo_nm_path_doc']        = "";
    ...
    //check img
    if(empty($_SESSION['scriptcase']['menu']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['menu']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['menu']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['menu']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['menu']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['menu']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "menu"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20210518"; 
      $this->nm_hr_criacao   = "191502"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20220418"; 
      $this->nm_hr_ult_alt   = "121005"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['menu']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['menu']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['menu']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['menu']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['menu']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['menu']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['menu']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['menu']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/menu';
      ...
      $_SESSION['sc_session'][$this->sc_page]['menu']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      {
          include_once("menu_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['menu']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['menu']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['menu']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['menu']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['menu']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['menu']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["menu"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["menu"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      $_SESSION['sc_session'][$this->sc_page]['menu']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['menu']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['menu']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['menu']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "menu_erro.class.php"); 
...
/*NM*/            $_SESSION['scriptcase']['menu']['glo_nm_perfil'] = $NM_con_dest;
      ...
      $con_devel             = (isset($_SESSION['scriptcase']['menu']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['menu']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      ...
      {
          $perfil_trab = $_SESSION['scriptcase']['menu']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['menu']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['menu']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['menu']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['menu']['glo_nm_conexao'], $this->root . $this->path_prod, 'gestao_focus_pronto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['menu']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['menu']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['menu']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['menu']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['menu']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new menu_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['menu']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['menu']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['menu']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['menu']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('menu') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['menu']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['menu']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "menu_erro.class.php"); 
      $this->Erro      = new menu_erro();
...
echo $this->sc_temp_usr_name; echo $this->sc_temp_logged_user; ?>  
               ...
               <li class="special_link" >
                  <a href="../cards/cards.php" style="padding-left: 15px;" target='CMIframe' id="carrega">Menu</a> 
<!-- 				  <span href="https://suporte.voicetec.com.br/" style="padding-left: 15px;" target='CMIframe' id="carrega">Menu</a>  -->
               ...
               <li>
                  ...
                  <ul class='nav nav-second-level collapse' style=''>
                     <li>
                        <a id='cad' href='../form_atividade_mp_carlos/form_atividade_mp_carlos.php' target='CMIframe' >
                           <img src= '<?php echo sc_url_library("sys", "nerd_imog","img/cadastro.png"); ?>' class = 'icon' > Cadastrar<a href = '../grid_atividade_mp_carlos/grid_atividade_mp_carlos.php' target='CMIframe'>
...
echo $this->sc_temp_usr_name; ?> 
			 <a href="../secury_Login/secury_Login.php"  > <img src= '<?php echo sc_url_library("sys", "nav_bar_vertical","img/logout.png"); ?>' class = 'icon' > Sair</a> 
     </span>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "menu") {
           ...
           if (isset($_COOKIE['sc_actual_lang_gestao_focus_pronto'])) {
               $_SESSION['scriptcase']['menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_gestao_focus_pronto'];
           }
       }
   }
   ...
   if (isset($_POST["usr_name"])) 
   {
       ...
       nm_limpa_str_menu($_SESSION["usr_name"]);
   }
   ...
   if (isset($_POST["logged_user"])) 
   {
       ...
       nm_limpa_str_menu($_SESSION["logged_user"]);
   }
   ...
   if (isset($_SESSION['scriptcase']['menu']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['menu']['session_timeout']['lang'];
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['menu']['menu_desenv'] = false;   
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['menu']['opc_psq'] && !isset($_SESSION['scriptcase']['menu']['session_timeout']['redir'])) 
       { 
          ...
          { 
              ...
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['menu']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("menu", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
...
<?php
   ...
   $contr_menu = new menu_apl();
   $contr_menu->controle();
//
   function nm_limpa_str_menu(&$str)
   {
