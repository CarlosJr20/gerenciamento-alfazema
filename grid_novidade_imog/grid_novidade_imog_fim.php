...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_novidade_imog"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_novidade_imog"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_novidade_imog']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_novidade_imog']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_novidade_imog']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_novidade_imog']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_novidade_imog']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_novidade_imog</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_novidade_imog']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_novidade_imog']['embutida_filho'] as $ind => $sc_init)
          {
