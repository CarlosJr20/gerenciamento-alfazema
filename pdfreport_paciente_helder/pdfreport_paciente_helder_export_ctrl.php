<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_paciente_helder']['sc_process_barr'] = true;
require_once('../pdfreport_paciente_helder/index.php');
unset($_SESSION['scriptcase']['pdfreport_paciente_helder']['sc_process_barr']);
$ExportCtrl = new pdfreport_paciente_helder_export_control;
$ExportCtrl->Export_barr();

class pdfreport_paciente_helder_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_title'] ?> paciente_helder</TITLE>
