  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_novidade_imog_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_novidade_imog_mob_form();
	}
  ...
  // ---------- Validate titulo
  function do_ajax_form_novidade_imog_mob_validate_titulo()
  {
    var nomeCampo_titulo = "titulo";
    var var_titulo = scAjaxGetFieldText(nomeCampo_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novidade_imog_mob_validate_titulo(var_titulo, var_script_case_init, do_ajax_form_novidade_imog_mob_validate_titulo_cb);
  } // do_ajax_form_novidade_imog_mob_validate_titulo

  function do_ajax_form_novidade_imog_mob_validate_titulo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novidade_imog_mob_validate_titulo_cb

  // ---------- Validate valor
  function do_ajax_form_novidade_imog_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novidade_imog_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_novidade_imog_mob_validate_valor_cb);
  } // do_ajax_form_novidade_imog_mob_validate_valor

  function do_ajax_form_novidade_imog_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novidade_imog_mob_validate_valor_cb

  // ---------- Validate quartos
  function do_ajax_form_novidade_imog_mob_validate_quartos()
  {
    var nomeCampo_quartos = "quartos";
    var var_quartos = scAjaxGetFieldText(nomeCampo_quartos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novidade_imog_mob_validate_quartos(var_quartos, var_script_case_init, do_ajax_form_novidade_imog_mob_validate_quartos_cb);
  } // do_ajax_form_novidade_imog_mob_validate_quartos

  function do_ajax_form_novidade_imog_mob_validate_quartos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "quartos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novidade_imog_mob_validate_quartos_cb

  // ---------- Validate area
  function do_ajax_form_novidade_imog_mob_validate_area()
  {
    var nomeCampo_area = "area";
    var var_area = scAjaxGetFieldText(nomeCampo_area);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novidade_imog_mob_validate_area(var_area, var_script_case_init, do_ajax_form_novidade_imog_mob_validate_area_cb);
  } // do_ajax_form_novidade_imog_mob_validate_area

  function do_ajax_form_novidade_imog_mob_validate_area_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "area";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novidade_imog_mob_validate_area_cb

  // ---------- Validate lote
  function do_ajax_form_novidade_imog_mob_validate_lote()
  {
    var nomeCampo_lote = "lote";
    var var_lote = scAjaxGetFieldText(nomeCampo_lote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novidade_imog_mob_validate_lote(var_lote, var_script_case_init, do_ajax_form_novidade_imog_mob_validate_lote_cb);
  } // do_ajax_form_novidade_imog_mob_validate_lote

  function do_ajax_form_novidade_imog_mob_validate_lote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lote";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novidade_imog_mob_validate_lote_cb

  // ---------- Validate ano
  function do_ajax_form_novidade_imog_mob_validate_ano()
  {
    var nomeCampo_ano = "ano";
    var var_ano = scAjaxGetFieldText(nomeCampo_ano);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novidade_imog_mob_validate_ano(var_ano, var_script_case_init, do_ajax_form_novidade_imog_mob_validate_ano_cb);
  } // do_ajax_form_novidade_imog_mob_validate_ano

  function do_ajax_form_novidade_imog_mob_validate_ano_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ano";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novidade_imog_mob_validate_ano_cb

  // ---------- Validate descricao
  function do_ajax_form_novidade_imog_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novidade_imog_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_novidade_imog_mob_validate_descricao_cb);
  } // do_ajax_form_novidade_imog_mob_validate_descricao

  function do_ajax_form_novidade_imog_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novidade_imog_mob_validate_descricao_cb

  // ---------- Validate imagem
  function do_ajax_form_novidade_imog_mob_validate_imagem()
  {
    var nomeCampo_imagem = "imagem";
    var var_imagem = scAjaxGetFieldText(nomeCampo_imagem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_novidade_imog_mob_validate_imagem(var_imagem, var_script_case_init, do_ajax_form_novidade_imog_mob_validate_imagem_cb);
  } // do_ajax_form_novidade_imog_mob_validate_imagem

  function do_ajax_form_novidade_imog_mob_validate_imagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagem";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_novidade_imog_mob_validate_imagem_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_novidade_imog_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_novidade_imog_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_novidade_imog_mob_submit_form(var_titulo, var_valor, var_quartos, var_area, var_lote, var_ano, var_descricao, var_imagem, var_id, var_ul_info_imagem, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_novidade_imog_mob_submit_form_cb);
  } // do_ajax_form_novidade_imog_mob_submit_form

  function do_ajax_form_novidade_imog_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_novidade_imog_mob_submit_form_cb_after_alert);
  } // do_ajax_form_novidade_imog_mob_submit_form_cb
  function do_ajax_form_novidade_imog_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_novidade_imog_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_novidade_imog_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_novidade_imog_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_novidade_imog_mob_navigate_form();
    }
  }

  function perform_ajax_form_novidade_imog_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_novidade_imog_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_novidade_imog_mob_navigate_form_cb);
  } // do_ajax_form_novidade_imog_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_novidade_imog_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_novidade_imog_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_novidade_imog_mob_navigate_form_cb
  function do_ajax_form_novidade_imog_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_novidade_imog_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_novidade_imog_mob_navigate_form_cb_after_alert
  function sc_hide_form_novidade_imog_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "area": {"label": "Area", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
