...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['embutida_pdf']))
 {
 ?>
<?php
    if ((isset($this->nmgp_tipo_pdf) && $this->nmgp_tipo_pdf == "pb") || (isset($this->nmgp_cor_print) && $this->nmgp_cor_print == "PB"))
    {
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['prt_view'] && $this->Ini->Export_img_zip) 
        {
?>
 <style type="text/css">
<?php
...
<?php
include_once("form_novidade_imog_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_novidade_imog_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['recarga'];
}
...
{
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_novidade_imog_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_novidade_imog'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_novidade_imog'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
?>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['fast_search'][2] : "";
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_novidade_imog");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_novidade_imog");
 parent.scAjaxDetailHeight("form_novidade_imog", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_novidade_imog']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
