...
function scHidePage(pageNo) {
	$("#id_form_novidade_imog_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data_hora" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_novidade_imog_mob_validate_data_hora(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_img" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_novidade_imog_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_novidade_imog_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
