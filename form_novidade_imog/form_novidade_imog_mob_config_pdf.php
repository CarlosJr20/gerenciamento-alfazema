...
*/
    ...
    $SC_cod_proj = "gestao_focus_pronto";
    $SC_apl_proc = "form_novidade_imog_mob";
    $SC_ver_93   = true;
    $SC_conf_opt = explode(",","cor_imp,papel,orientacao,password,pdf_compacted");
/* sc_apl_default */
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['__!SC_APPLICATION_NAME!__']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['__!SC_APPLICATION_NAME!__']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['__!SC_APPLICATION_NAME!__']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['__!SC_APPLICATION_NAME!__']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['__!SC_APPLICATION_NAME!__']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['__!SC_APPLICATION_NAME!__']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['__!SC_APPLICATION_NAME!__']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['__!SC_APPLICATION_NAME!__']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['__!SC_APPLICATION_NAME!__']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['__!SC_APPLICATION_NAME!__']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
...
?>
     ...
     parent.nm_gp_export('<?php echo NM_encode_input($opc); ?>', '<?php echo NM_encode_input($target); ?>', cor, parms_pdf, grafico, create, '<?php echo NM_encode_input($export_ajax); ?>', chart_level, page_break, res_cons, use_pass, s_all_cab, s_all_label, s_label_group, s_pdf_zip);return false;
