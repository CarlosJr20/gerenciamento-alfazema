...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_despesas_mp"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_despesas_mp"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_despesas_mp'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_despesas_mp']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_despesas_mp']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_despesas_mp']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_despesas_mp']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_despesas_mp']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_despesas_mp']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_despesas_mp']['embutida_filho'] as $ind => $sc_init)
          {
