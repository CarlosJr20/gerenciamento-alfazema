...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "data";$Nm_datas[] = "data";$Nm_datas[] = "hora";$Nm_datas[] = "hora";$Nm_numeric[] = "id_despesas";$Nm_numeric[] = "transporte";$Nm_numeric[] = "alimentacao";$Nm_numeric[] = "outros";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_hora_cond" name="hora_cond" onChange="nm_campos_between(document.getElementById('id_vis_hora'), this, 'hora')">
      ...
      <br><span id="id_hide_hora"  <?php echo $str_hide_hora?>>
<?php
  $Form_base = "hhiiss";
  $date_format_show = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_despesas_cond" name="id_despesas_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_despesas'), this, 'id_despesas')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_selecao_projeto_cond" name="selecao_projeto_cond" onChange="nm_campos_between(document.getElementById('id_vis_selecao_projeto'), this, 'selecao_projeto')">
      ...
      <br><span id="id_hide_selecao_projeto"  <?php echo $str_hide_selecao_projeto?>><?php
      if ($selecao_projeto != "")
      {
      $selecao_projeto_look = substr($this->Db->qstr($selecao_projeto), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_transporte_cond" name="transporte_cond" onChange="nm_campos_between(document.getElementById('id_vis_transporte'), this, 'transporte')">
      ...
      <br><span id="id_hide_transporte"  <?php echo $str_hide_transporte?>><INPUT  type="text" id="SC_transporte" name="transporte" value="<?php echo NM_encode_input($transporte) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
