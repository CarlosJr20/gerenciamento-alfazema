<?php
   include_once('apl_search_sec_groups_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_perfil']          = "conn_banco_de_dados";
   $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class apl_search_sec_groups_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "apl_search_sec_groups"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['apl_search_sec_groups']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['apl_search_sec_groups']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['apl_search_sec_groups']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/apl_search_sec_groups';
      ...
      $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['apl_search_sec_groups']['actual_lang']) || $_SESSION['scriptcase']['apl_search_sec_groups']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['apl_search_sec_groups']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("apl_search_sec_groups_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "apl_form_sec_groups_apps";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/apl_form_sec_groups_apps_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/apl_form_sec_groups_apps_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/apl_form_sec_groups_apps_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/apl_form_sec_groups_apps_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["apl_form_sec_groups_apps"] = 'S';
          }
      }
      $this->sc_lig_target["A_@scinf_"] = '_self';
      $this->sc_lig_target["A_@scinf__@scinf_apl_form_sec_groups_apps"] = '_self';
      if ($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["apl_search_sec_groups"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["apl_search_sec_groups"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "apl_search_sec_groups_erro.class.php"); 
      $this->Erro = new apl_search_sec_groups_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('apl_search_sec_groups'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao']) && $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_perfil']) && $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['apl_search_sec_groups']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao'], $this->root . $this->path_prod, 'gestao_focus_pronto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['apl_search_sec_groups']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class apl_search_sec_groups_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new apl_search_sec_groups_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_search_sec_groups']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['apl_search_sec_groups']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['apl_search_sec_groups']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['apl_search_sec_groups'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['apl_search_sec_groups']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['apl_search_sec_groups']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('apl_search_sec_groups') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['apl_search_sec_groups']['label'] = "" . $this->Ini->Nm_lang['lang_othr_srch_titl'] . " - sec_groups";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['apl_search_sec_groups']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['apl_search_sec_groups']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page] = $_SESSION['scriptcase']['sc_apl_conf']['apl_search_sec_groups']['exit'];
      }
      $glo_senha_protect = (isset($_SESSION['scriptcase']['glo_senha_protect'])) ? $_SESSION['scriptcase']['glo_senha_protect'] : "S";
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_conexao'], $this->Ini->root . $this->Ini->path_prod, 'gestao_focus_pronto', 1, $this->Ini->force_db_utf8); 
      } 
      else 
      { 
      ...
      include_once($this->Ini->path_aplicacao . "apl_search_sec_groups_erro.class.php"); 
      $this->Erro      = new apl_search_sec_groups_erro();
      $this->Erro->Ini = $this->Ini;
//
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "apl_search_sec_groups_pesq.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "apl_search_sec_groups_mobile_pesq.class.php"); 
      } 
      $this->pesq  = new apl_search_sec_groups_pesq();
...
//======= =========================
   ...
   $_SESSION['scriptcase']['apl_search_sec_groups']['contr_erro'] = 'off';
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_apl_search_sec_groups($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_apl_search_sec_groups($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['apl_search_sec_groups']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "apl_search_sec_groups") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_gestao_focus_pronto'])) {
               $_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_gestao_focus_pronto'];
           }
       }
   }
   if (isset($group)) 
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "apl_search_sec_groups";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'apl_search_sec_groups' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('apl_search_sec_groups' == $sReferer || 'apl_search_sec_groups_' == substr($sReferer, 0, 22))
       {
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['lang'];
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'apl_search_sec_groups')
   {
       $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/apl_search_sec_groups_erro.php");
   }
   ...
   { 
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['opcao'] = $nmgp_opcao ;  
       }   
       if (!empty($nmgp_parms)) 
       { 
           ...
           while (!empty($todo[$ix]))
           {
                ...
                if (1 < sizeof($cadapar))
                {
                    ...
                    nm_limpa_str_apl_search_sec_groups($cadapar[1]);
                    nm_protect_num_apl_search_sec_groups($cadapar[0], $cadapar[1]);
           ...
           if (isset($group)) 
           {
               nm_limpa_str_apl_search_sec_groups($group);
               $_SESSION['group'] = $group;
           }
       } 
       if (isset($_POST["group"])) 
       {
           ...
           nm_limpa_str_apl_search_sec_groups($_SESSION["group"]);
       }
       if (isset($_GET["group"])) 
       {
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['num_css'] = rand(0, 1000);
       } 
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['volta_redirect_tp'] = "";
           $nm_url_saida = "apl_search_sec_groups_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['sc_outra_jan'] == 'true')
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['sc_modal'] = true;
               }
               $nm_url_saida = "apl_search_sec_groups_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['opcao'] != "pdf" ) 
       { 
            $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           $todo = explode(",", $nmgp_parms_ret);
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['dado_psq_ret']  = $todo[2];
           $_SESSION['scriptcase']['sc_tp_saida']  = $salva_tp_saida;
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $salva_url_saida;
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['opc_psq'] = true ;   
           $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['opc_psq'] && !isset($_SESSION['scriptcase']['apl_search_sec_groups']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['apl_search_sec_groups']) || $_SESSION['scriptcase']['sc_apl_seg']['apl_search_sec_groups'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("apl_search_sec_groups", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
...
<?php
       ...
       if (isset($_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['sc_outra_jan'])
       {
           $nm_apl_dependente = 0;
       }
       $contr_apl_search_sec_groups = new apl_search_sec_groups_apl();
      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['apl_search_sec_groups']['opcao'] = "busca";
          $contr_apl_search_sec_groups->NM_ajax_flag = true;
          $contr_apl_search_sec_groups->NM_ajax_opcao = $NM_ajax_opcao;
      }
       $contr_apl_search_sec_groups->controle();
   } 
   if ($nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_apl_search_sec_groups(&$str)
   {
   ...
   function nm_protect_num_apl_search_sec_groups($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function apl_search_sec_groups_pack_protect_string($sString)
   {
