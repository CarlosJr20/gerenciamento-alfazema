...
$old_error_handler = set_error_handler("apl_change_pswd_scriptcase_error_handler");

function apl_change_pswd_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['apl_change_pswd']['contr_erro']) && $_SESSION['scriptcase']['apl_change_pswd']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_apl_change_pswd->contr_apl_change_pswd->Apl_com_erro = true;
            if ($inicial_apl_change_pswd->contr_apl_change_pswd->NM_ajax_flag)
            {
                $inicial_apl_change_pswd->contr_apl_change_pswd->NM_ajax_info['errList']['geral_apl_change_pswd'][] = $msg;
                return;
            }
            apl_change_pswd_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function apl_change_pswd_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['apl_change_pswd'])  && '' != $_SESSION['scriptcase']['error_icon']['apl_change_pswd'])  ? $_SESSION['scriptcase']['error_icon']['apl_change_pswd']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['apl_change_pswd']) && '' != $_SESSION['scriptcase']['error_span_title']['apl_change_pswd']) ? $_SESSION['scriptcase']['error_span_title']['apl_change_pswd'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['apl_change_pswd']) && '' != $_SESSION['scriptcase']['error_icon_title']['apl_change_pswd']) ? $_SESSION['scriptcase']['error_icon_title']['apl_change_pswd'] : '';
?>
