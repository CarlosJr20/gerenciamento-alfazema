...
class grid_comprar_imog_det
{
 ...
 function monta_det()
 {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['seq_dir'] = 0; 
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['sub_dir'] = array(); 
   ...
   $parms_det = explode("*PDet*", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['chave_det']) ; 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['cmp_acum']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['cmp_acum']))
   {
       $parms_acum = explode(";", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['cmp_acum']);
...
$nm_saida->saida("</script>\r\n");
   ...
   if (($this->Ini->sc_export_ajax || $this->Ini->Export_det_zip) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['det_print'] == "print")
   {
       ...
       $NM_css_cmp  = $this->Ini->path_link . "grid_comprar_imog/grid_comprar_imog_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css";
   ...
   elseif (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['det_print'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
   {
       ...
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_comprar_imog/grid_comprar_imog_det_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
   }
   else
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['pdf_det'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['det_print'] != "print")
   {
   ...
   $nm_saida->saida("</HEAD>\r\n");
   if (!$this->Ini->Export_html_zip && !$this->Ini->Export_det_zip && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['det_print'] == "print")
   {
       $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
   ...
   $conteudo_original = ''; 
          ...
          { 
              ...
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['opcao'] != "pdf") 
              { 
...
//--- 
   ...
   $nm_saida->saida("                  action=\"grid_comprar_imog_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   {\r\n");
   $nm_saida->saida("       NovaJanela = window.open (\"grid_comprar_imog_doc.php?nmgp_parms=\" + campo1, \"ScriptCase\", \"resizable\");\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   $nm_saida->saida("           window.location = \"" . $this->Ini->path_link . "grid_comprar_imog/index.php?nmgp_opcao=pdf_det&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p +  \"&nmgp_graf_pdf=\" + g + \"&Det_use_pass_pdf=\" + use_pass_pdf + \"&Det_pdf_zip=\" + pdf_zip + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "\";\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("   }\r\n");
   ...
   {
      global $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['det_print'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprar_imog']['pdf_det']) 
   { 
       $nm_saida->saida("   <tr><td class=\"scGridTabelaTd\">\r\n");
       ...
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Dpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_comprar_imog/grid_comprar_imog_config_pdf.php?nm_opc=pdf_det&nm_target=0&nm_cor=cor&papel=1&orientacao=1&largura=1200&conf_larg=S&conf_fonte=10&language=pt_br&conf_socor=N&sc_ver_93=" . s . "&password=n&pdf_zip=N&KeepThis=false&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
       if ($this->nmgp_botoes['det_print'] == "on")
       {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Dprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_comprar_imog/grid_comprar_imog_config_print.php?nm_opc=detalhe&nm_cor=CO&password=n&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
       }
