<?php
@session_start() ;
$_SESSION['scriptcase']['grid_comprar_imog']['sc_process_barr'] = true;
require_once('../grid_comprar_imog/index.php');
unset($_SESSION['scriptcase']['grid_comprar_imog']['sc_process_barr']);
$ExportCtrl = new grid_comprar_imog_export_control;
$ExportCtrl->Export_barr();

class grid_comprar_imog_export_control
{
