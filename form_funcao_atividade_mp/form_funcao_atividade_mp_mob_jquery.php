...
function scHidePage(pageNo) {
	$("#id_form_funcao_atividade_mp_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_sc_field_1" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_funcao_atividade_mp_mob_validate_sc_field_1(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_funcao_atividade_mp_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
