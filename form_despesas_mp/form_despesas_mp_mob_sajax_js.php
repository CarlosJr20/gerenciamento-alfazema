  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_despesas_mp_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_despesas_mp_mob_form();
	}
  ...
  // ---------- Validate selecao_projeto
  function do_ajax_form_despesas_mp_mob_validate_selecao_projeto()
  {
    var nomeCampo_selecao_projeto = "selecao_projeto";
    var var_selecao_projeto = scAjaxGetFieldSelect(nomeCampo_selecao_projeto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_despesas_mp_mob_validate_selecao_projeto(var_selecao_projeto, var_script_case_init, do_ajax_form_despesas_mp_mob_validate_selecao_projeto_cb);
  } // do_ajax_form_despesas_mp_mob_validate_selecao_projeto

  function do_ajax_form_despesas_mp_mob_validate_selecao_projeto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selecao_projeto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_despesas_mp_mob_validate_selecao_projeto_cb

  // ---------- Validate transporte
  function do_ajax_form_despesas_mp_mob_validate_transporte()
  {
    var nomeCampo_transporte = "transporte";
    var var_transporte = scAjaxGetFieldText(nomeCampo_transporte);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_despesas_mp_mob_validate_transporte(var_transporte, var_script_case_init, do_ajax_form_despesas_mp_mob_validate_transporte_cb);
  } // do_ajax_form_despesas_mp_mob_validate_transporte

  function do_ajax_form_despesas_mp_mob_validate_transporte_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "transporte";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_despesas_mp_mob_validate_transporte_cb

  // ---------- Validate alimentacao
  function do_ajax_form_despesas_mp_mob_validate_alimentacao()
  {
    var nomeCampo_alimentacao = "alimentacao";
    var var_alimentacao = scAjaxGetFieldText(nomeCampo_alimentacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_despesas_mp_mob_validate_alimentacao(var_alimentacao, var_script_case_init, do_ajax_form_despesas_mp_mob_validate_alimentacao_cb);
  } // do_ajax_form_despesas_mp_mob_validate_alimentacao

  function do_ajax_form_despesas_mp_mob_validate_alimentacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "alimentacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_despesas_mp_mob_validate_alimentacao_cb

  // ---------- Validate outros
  function do_ajax_form_despesas_mp_mob_validate_outros()
  {
    var nomeCampo_outros = "outros";
    var var_outros = scAjaxGetFieldText(nomeCampo_outros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_despesas_mp_mob_validate_outros(var_outros, var_script_case_init, do_ajax_form_despesas_mp_mob_validate_outros_cb);
  } // do_ajax_form_despesas_mp_mob_validate_outros

  function do_ajax_form_despesas_mp_mob_validate_outros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "outros";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_despesas_mp_mob_validate_outros_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_despesas_mp_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_despesas_mp_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_selecao_projeto = scAjaxGetFieldSelect("selecao_projeto");
    var var_transporte = scAjaxGetFieldText("transporte");
    var var_alimentacao = scAjaxGetFieldText("alimentacao");
    var var_outros = scAjaxGetFieldText("outros");
    var var_id_despesas = scAjaxGetFieldText("id_despesas");
    ...
    scAjaxProcOn();
    x_ajax_form_despesas_mp_mob_submit_form(var_selecao_projeto, var_transporte, var_alimentacao, var_outros, var_id_despesas, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_despesas_mp_mob_submit_form_cb);
  } // do_ajax_form_despesas_mp_mob_submit_form

  function do_ajax_form_despesas_mp_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("selecao_projeto");
      scAjaxHideErrorDisplay("transporte");
      scAjaxHideErrorDisplay("alimentacao");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_despesas_mp_mob_submit_form_cb_after_alert);
  } // do_ajax_form_despesas_mp_mob_submit_form_cb
  function do_ajax_form_despesas_mp_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_despesas_mp_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_despesas_mp_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_despesas_mp_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_despesas_mp_mob_navigate_form();
    }
  }

  function perform_ajax_form_despesas_mp_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("alimentacao");
    scAjaxHideErrorDisplay("outros");
    var var_id_despesas = document.F2.id_despesas.value;
    ...
    scAjaxProcOn();
    x_ajax_form_despesas_mp_mob_navigate_form(var_id_despesas, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_despesas_mp_mob_navigate_form_cb);
  } // do_ajax_form_despesas_mp_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_despesas_mp_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_despesas_mp_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_despesas.value = scAjaxGetKeyValue("id_despesas");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_despesas_mp_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_despesas_mp_mob_navigate_form_cb
  function do_ajax_form_despesas_mp_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_despesas_mp_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_despesas_mp_mob_navigate_form_cb_after_alert
  function sc_hide_form_despesas_mp_mob_form()
  {
  ...
  ajax_field_list[0] = "selecao_projeto";
  ajax_field_list[1] = "transporte";
  ajax_field_list[2] = "alimentacao";
  ajax_field_list[3] = "outros";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "selecao_projeto": {"label": "Projeto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "transporte": {"label": "Transporte", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "alimentacao": {"label": "Alimentação", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "selecao_projeto": new Array(),
    "transporte": new Array(),
    "alimentacao": new Array(),
    "outros": new Array()
  };
  ajax_field_mult["selecao_projeto"][1] = "selecao_projeto";
  ajax_field_mult["transporte"][1] = "transporte";
  ajax_field_mult["alimentacao"][1] = "alimentacao";
  ajax_field_mult["outros"][1] = "outros";

  var ajax_field_id = {
    "selecao_projeto": new Array("hidden_field_label_selecao_projeto", "hidden_field_data_selecao_projeto"),
    "transporte": new Array("hidden_field_label_transporte", "hidden_field_data_transporte"),
    "alimentacao": new Array("hidden_field_label_alimentacao", "hidden_field_data_alimentacao"),
