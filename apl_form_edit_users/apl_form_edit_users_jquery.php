...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_login' + iSeqRow).bind('blur', function() { sc_apl_form_edit_users_login_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_apl_form_edit_users_login_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_apl_form_edit_users_login_onfocus(this, iSeqRow) });
  $('#id_sc_field_pswd' + iSeqRow).bind('blur', function() { sc_apl_form_edit_users_pswd_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_apl_form_edit_users_pswd_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_apl_form_edit_users_pswd_onfocus(this, iSeqRow) });
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_apl_form_edit_users_name_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_apl_form_edit_users_name_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_apl_form_edit_users_name_onfocus(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_apl_form_edit_users_email_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_apl_form_edit_users_email_onchange(this, iSeqRow) })
...
function sc_apl_form_edit_users_login_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_apl_form_edit_users_login_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_apl_form_edit_users_pswd_onblur(oThis, iSeqRow) {
  do_ajax_apl_form_edit_users_validate_pswd();
  scCssBlur(oThis);
}

function sc_apl_form_edit_users_pswd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_apl_form_edit_users_pswd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_apl_form_edit_users_name_onblur(oThis, iSeqRow) {
  do_ajax_apl_form_edit_users_validate_name();
  scCssBlur(oThis);
}

function sc_apl_form_edit_users_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_apl_form_edit_users_name_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_apl_form_edit_users_email_onblur(oThis, iSeqRow) {
  do_ajax_apl_form_edit_users_validate_email();
  scCssBlur(oThis);
}

function sc_apl_form_edit_users_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_apl_form_edit_users_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_apl_form_edit_users_active_onblur(oThis, iSeqRow) {
  do_ajax_apl_form_edit_users_validate_active();
  scCssBlur(oThis);
}

function sc_apl_form_edit_users_active_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_apl_form_edit_users_active_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_apl_form_edit_users_activation_code_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_apl_form_edit_users_groups_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_apl_form_edit_users_groups_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_apl_form_edit_users_confirm_pswd_onblur(oThis, iSeqRow) {
  do_ajax_apl_form_edit_users_validate_confirm_pswd();
  scCssBlur(oThis);
}

function sc_apl_form_edit_users_confirm_pswd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_apl_form_edit_users_confirm_pswd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_apl_form_edit_users_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'apl_form_edit_users')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
