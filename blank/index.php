<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['blank']['glo_nm_perfil']          = "conn_nerd";
   ...
   $_SESSION['scriptcase']['blank']['glo_nm_path_cache']      = "";
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_dt_criacao   = "20210818"; 
      $this->nm_hr_criacao   = "153805"; 
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank']['glo_nm_conexao'], $this->root . $this->path_prod, 'gestao_focus_pronto', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
foreach($this->dataset  as $aCategory){
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank") {
           ...
           if (isset($_COOKIE['sc_actual_lang_gestao_focus_pronto'])) {
               $_SESSION['scriptcase']['blank']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_gestao_focus_pronto'];
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['blank']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['blank']['session_timeout']['lang'];
   }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['blank']['opc_psq'] && !isset($_SESSION['scriptcase']['blank']['session_timeout']['redir'])) 
       { 
          ...
          { 
              ...
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['blank']['iframe_menu']) ? false : true;
              if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
              {
                  foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
                  {
                      if (in_array("blank", $apls_aba))
                      {
                          $nm_botao_ok = false;
                           break;
                      }
