...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_secury_grid_sec_users').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_secury_grid_sec_users').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_secury_grid_sec_users').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_secury_grid_sec_users').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_secury_grid_sec_users').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_secury_grid_sec_users').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_secury_grid_sec_users').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_secury_grid_sec_users').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_secury_grid_sec_users').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_secury_grid_sec_users').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_secury_grid_sec_users').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_secury_grid_sec_users').style.width  = '0px';
        if (oResp["setValue"]) {
