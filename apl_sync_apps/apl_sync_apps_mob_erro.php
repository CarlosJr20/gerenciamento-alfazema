...
$old_error_handler = set_error_handler("apl_sync_apps_mob_scriptcase_error_handler");

function apl_sync_apps_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['apl_sync_apps_mob']['contr_erro']) && $_SESSION['scriptcase']['apl_sync_apps_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_apl_sync_apps_mob->contr_apl_sync_apps_mob->Apl_com_erro = true;
            if ($inicial_apl_sync_apps_mob->contr_apl_sync_apps_mob->NM_ajax_flag)
            {
                $inicial_apl_sync_apps_mob->contr_apl_sync_apps_mob->NM_ajax_info['errList']['geral_apl_sync_apps_mob'][] = $msg;
                return;
            }
            apl_sync_apps_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function apl_sync_apps_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['apl_sync_apps_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['apl_sync_apps_mob'])  ? $_SESSION['scriptcase']['error_icon']['apl_sync_apps_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['apl_sync_apps_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['apl_sync_apps_mob']) ? $_SESSION['scriptcase']['error_span_title']['apl_sync_apps_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['apl_sync_apps_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['apl_sync_apps_mob']) ? $_SESSION['scriptcase']['error_icon_title']['apl_sync_apps_mob'] : '';
?>
