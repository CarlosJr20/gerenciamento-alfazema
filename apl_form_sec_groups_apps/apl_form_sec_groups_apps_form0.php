<?php
class apl_form_sec_groups_apps_form extends apl_form_sec_groups_apps_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['sc_redir_atualiz'] == 'ok')
{
?>
...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>apl_form_sec_groups_apps/apl_form_sec_groups_apps_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("apl_form_sec_groups_apps_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('apl_form_sec_groups_apps_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("apl_form_sec_groups_apps_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['apl_form_sec_groups_apps'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['apl_form_sec_groups_apps'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "R")
{
?>
...
<?php 
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['fast_search'][2] : "";
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['ordem_cmp'] == "app_name")
      {
          $orderColName = "app_name";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['ordem_ord'] == " desc")
          {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['ordem_cmp'] == "priv_access")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['ordem_cmp'] == "priv_insert")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['ordem_cmp'] == "priv_delete")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['ordem_cmp'] == "priv_update")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['ordem_cmp'] == "priv_export")
      {
...
<?php
      ...
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['ordem_cmp'] == "priv_print")
      {
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_apl_form_sec_groups_apps);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_apl_form_sec_groups_apps = $this->form_vert_apl_form_sec_groups_apps;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_apl_form_sec_groups_apps))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_apl_form_sec_groups_apps as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->group_id_ = $this->form_vert_apl_form_sec_groups_apps[$sc_seq_vert]['group_id_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->app_name_ = $this->form_vert_apl_form_sec_groups_apps[$sc_seq_vert]['app_name_']; 
       ...
       $this->priv_access_ = $this->form_vert_apl_form_sec_groups_apps[$sc_seq_vert]['priv_access_']; 
       ...
       $this->priv_insert_ = $this->form_vert_apl_form_sec_groups_apps[$sc_seq_vert]['priv_insert_']; 
       ...
       $this->priv_delete_ = $this->form_vert_apl_form_sec_groups_apps[$sc_seq_vert]['priv_delete_']; 
       ...
       $this->priv_update_ = $this->form_vert_apl_form_sec_groups_apps[$sc_seq_vert]['priv_update_']; 
       ...
       $this->priv_export_ = $this->form_vert_apl_form_sec_groups_apps[$sc_seq_vert]['priv_export_']; 
       ...
       $this->priv_print_ = $this->form_vert_apl_form_sec_groups_apps[$sc_seq_vert]['priv_print_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_apl_form_sec_groups_apps_add_new_line(" . $sc_seq_vert . ")", "do_ajax_apl_form_sec_groups_apps_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_apl_form_sec_groups_apps_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_apl_form_sec_groups_apps_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_apl_form_sec_groups_apps_cancel_update(" . $sc_seq_vert . ")", "do_ajax_apl_form_sec_groups_apps_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['Lookup_priv_access_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['Lookup_priv_insert_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['Lookup_priv_delete_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['Lookup_priv_update_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['Lookup_priv_export_'][] = 'Y'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['Lookup_priv_print_'][] = 'Y'; ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_apl_form_sec_groups_apps = $guarda_form_vert_apl_form_sec_groups_apps;
   } 
   if ($Table_refresh) 
   { 
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['maximized']))
  {
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("apl_form_sec_groups_apps");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("apl_form_sec_groups_apps");
 parent.scAjaxDetailHeight("apl_form_sec_groups_apps", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['apl_form_sec_groups_apps']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
