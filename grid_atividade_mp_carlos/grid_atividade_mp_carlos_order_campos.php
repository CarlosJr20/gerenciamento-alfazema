...
<?php
   ...
   $Ord_Cmp = new grid_atividade_mp_carlos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_atividade_mp_carlos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["selecao_projetos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["selecao_projetos"])) ? $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["selecao_projetos"] : "Projeto";
   $tab_ger_campos['tag'] = "on";
   $tab_def_campos['tag'] = "tag";
   $tab_labels["tag"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["tag"])) ? $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["tag"] : "Função";
   $tab_ger_campos['selecao_atividade'] = "on";
   $tab_def_campos['selecao_atividade'] = "selecao_atividade";
   $tab_labels["selecao_atividade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["selecao_atividade"])) ? $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["selecao_atividade"] : "Atividade";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "data";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["data"] : "Data";
   $tab_ger_campos['hora_inicio'] = "on";
   $tab_def_campos['hora_inicio'] = "hora_inicio";
   $tab_labels["hora_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["hora_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["hora_inicio"] : "Hora Início";
   $tab_ger_campos['hora_final'] = "on";
   $tab_def_campos['hora_final'] = "hora_final";
   $tab_labels["hora_final"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["hora_final"])) ? $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["hora_final"] : "Hora Final";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['labels']["descricao"] : "Descrição";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_atividade_mp_carlos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_atividade_mp_carlos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
