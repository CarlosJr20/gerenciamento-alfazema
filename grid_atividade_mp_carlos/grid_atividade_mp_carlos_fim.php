...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_atividade_mp_carlos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_atividade_mp_carlos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_atividade_mp_carlos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_carlos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_carlos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_carlos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_carlos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_carlos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_atividade_mp_carlos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_carlos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_carlos']['embutida_filho'] as $ind => $sc_init)
          {
