<?php
@session_start() ;
$_SESSION['scriptcase']['grid_atividade_mp_carlos']['sc_process_barr'] = true;
require_once('../grid_atividade_mp_carlos/index.php');
unset($_SESSION['scriptcase']['grid_atividade_mp_carlos']['sc_process_barr']);
$ExportCtrl = new grid_atividade_mp_carlos_export_control;
$ExportCtrl->Export_barr();

class grid_atividade_mp_carlos_export_control
{
