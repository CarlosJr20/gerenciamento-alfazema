  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_blocos_Alfazema" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_blocos_Alfazema_form();
	}
  ...
  // ---------- Validate id_blocos
  function do_ajax_form_blocos_Alfazema_validate_id_blocos()
  {
    var nomeCampo_id_blocos = "id_blocos";
    var var_id_blocos = scAjaxGetFieldHidden(nomeCampo_id_blocos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_blocos_Alfazema_validate_id_blocos(var_id_blocos, var_script_case_init, do_ajax_form_blocos_Alfazema_validate_id_blocos_cb);
  } // do_ajax_form_blocos_Alfazema_validate_id_blocos

  function do_ajax_form_blocos_Alfazema_validate_id_blocos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_blocos_Alfazema_validate_id_blocos_cb

  // ---------- Validate bloco
  function do_ajax_form_blocos_Alfazema_validate_bloco()
  {
    var nomeCampo_bloco = "bloco";
    var var_bloco = scAjaxGetFieldText(nomeCampo_bloco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_blocos_Alfazema_validate_bloco(var_bloco, var_script_case_init, do_ajax_form_blocos_Alfazema_validate_bloco_cb);
  } // do_ajax_form_blocos_Alfazema_validate_bloco

  function do_ajax_form_blocos_Alfazema_validate_bloco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bloco";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_blocos_Alfazema_validate_bloco_cb

  // ---------- Validate numero
  function do_ajax_form_blocos_Alfazema_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_blocos_Alfazema_validate_numero(var_numero, var_script_case_init, do_ajax_form_blocos_Alfazema_validate_numero_cb);
  } // do_ajax_form_blocos_Alfazema_validate_numero

  function do_ajax_form_blocos_Alfazema_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_blocos_Alfazema_validate_numero_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_blocos_Alfazema_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_blocos_Alfazema_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_blocos_Alfazema_submit_form(var_id_blocos, var_bloco, var_numero, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_blocos_Alfazema_submit_form_cb);
  } // do_ajax_form_blocos_Alfazema_submit_form

  function do_ajax_form_blocos_Alfazema_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_blocos_Alfazema_submit_form_cb_after_alert);
  } // do_ajax_form_blocos_Alfazema_submit_form_cb
  function do_ajax_form_blocos_Alfazema_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_blocos_Alfazema_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_blocos_Alfazema_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_blocos_Alfazema_navigate_form, function() {});
    } else {
      perform_ajax_form_blocos_Alfazema_navigate_form();
    }
  }

  function perform_ajax_form_blocos_Alfazema_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_blocos_Alfazema_navigate_form(var_id_blocos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_blocos_Alfazema_navigate_form_cb);
  } // do_ajax_form_blocos_Alfazema_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_blocos_Alfazema']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_blocos_Alfazema_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_blocos_Alfazema_navigate_form_cb_after_alert);
  } // do_ajax_form_blocos_Alfazema_navigate_form_cb
  function do_ajax_form_blocos_Alfazema_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_blocos_Alfazema_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_blocos_Alfazema_navigate_form_cb_after_alert
  function sc_hide_form_blocos_Alfazema_form()
  {
