<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_blocos" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_blocos']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_blocos_Alfazema']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_blocos_Alfazema"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_blocos_Alfazema']['where_detal']))
  {
?>  
