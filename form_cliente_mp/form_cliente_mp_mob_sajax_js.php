  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cliente_mp_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cliente_mp_mob_form();
	}
  ...
  // ---------- Validate nome_da_empresa
  function do_ajax_form_cliente_mp_mob_validate_nome_da_empresa()
  {
    var nomeCampo_nome_da_empresa = "nome_da_empresa";
    var var_nome_da_empresa = scAjaxGetFieldText(nomeCampo_nome_da_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mp_mob_validate_nome_da_empresa(var_nome_da_empresa, var_script_case_init, do_ajax_form_cliente_mp_mob_validate_nome_da_empresa_cb);
  } // do_ajax_form_cliente_mp_mob_validate_nome_da_empresa

  function do_ajax_form_cliente_mp_mob_validate_nome_da_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_da_empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mp_mob_validate_nome_da_empresa_cb

  // ---------- Validate cnpj
  function do_ajax_form_cliente_mp_mob_validate_cnpj()
  {
    var nomeCampo_cnpj = "cnpj";
    var var_cnpj = scAjaxGetFieldText(nomeCampo_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mp_mob_validate_cnpj(var_cnpj, var_script_case_init, do_ajax_form_cliente_mp_mob_validate_cnpj_cb);
  } // do_ajax_form_cliente_mp_mob_validate_cnpj

  function do_ajax_form_cliente_mp_mob_validate_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cnpj";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mp_mob_validate_cnpj_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_cliente_mp_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mp_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_cliente_mp_mob_validate_sc_field_0_cb);
  } // do_ajax_form_cliente_mp_mob_validate_sc_field_0

  function do_ajax_form_cliente_mp_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mp_mob_validate_sc_field_0_cb

  // ---------- Validate email
  function do_ajax_form_cliente_mp_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mp_mob_validate_email(var_email, var_script_case_init, do_ajax_form_cliente_mp_mob_validate_email_cb);
  } // do_ajax_form_cliente_mp_mob_validate_email

  function do_ajax_form_cliente_mp_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mp_mob_validate_email_cb

  // ---------- Validate setor
  function do_ajax_form_cliente_mp_mob_validate_setor()
  {
    var nomeCampo_setor = "setor";
    var var_setor = scAjaxGetFieldText(nomeCampo_setor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mp_mob_validate_setor(var_setor, var_script_case_init, do_ajax_form_cliente_mp_mob_validate_setor_cb);
  } // do_ajax_form_cliente_mp_mob_validate_setor

  function do_ajax_form_cliente_mp_mob_validate_setor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "setor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mp_mob_validate_setor_cb

  // ---------- Validate tel
  function do_ajax_form_cliente_mp_mob_validate_tel()
  {
    var nomeCampo_tel = "tel";
    var var_tel = scAjaxGetFieldText(nomeCampo_tel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mp_mob_validate_tel(var_tel, var_script_case_init, do_ajax_form_cliente_mp_mob_validate_tel_cb);
  } // do_ajax_form_cliente_mp_mob_validate_tel

  function do_ajax_form_cliente_mp_mob_validate_tel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tel";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mp_mob_validate_tel_cb

  // ---------- Validate outros
  function do_ajax_form_cliente_mp_mob_validate_outros()
  {
    var nomeCampo_outros = "outros";
    var var_outros = scAjaxGetFieldText(nomeCampo_outros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mp_mob_validate_outros(var_outros, var_script_case_init, do_ajax_form_cliente_mp_mob_validate_outros_cb);
  } // do_ajax_form_cliente_mp_mob_validate_outros

  function do_ajax_form_cliente_mp_mob_validate_outros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "outros";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mp_mob_validate_outros_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cliente_mp_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_mp_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome_da_empresa = scAjaxGetFieldText("nome_da_empresa");
    var var_cnpj = scAjaxGetFieldText("cnpj");
    var var_sc_field_0 = scAjaxGetFieldText("sc_field_0");
    var var_email = scAjaxGetFieldText("email");
    var var_setor = scAjaxGetFieldText("setor");
    var var_tel = scAjaxGetFieldText("tel");
    var var_outros = scAjaxGetFieldText("outros");
    var var_id_client = scAjaxGetFieldText("id_client");
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_mp_mob_submit_form(var_nome_da_empresa, var_cnpj, var_sc_field_0, var_email, var_setor, var_tel, var_outros, var_id_client, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_mp_mob_submit_form_cb);
  } // do_ajax_form_cliente_mp_mob_submit_form

  function do_ajax_form_cliente_mp_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("nome_da_empresa");
      scAjaxHideErrorDisplay("cnpj");
      scAjaxHideErrorDisplay("sc_field_0");
      scAjaxHideErrorDisplay("email");
      scAjaxHideErrorDisplay("setor");
      scAjaxHideErrorDisplay("tel");
      scAjaxHideErrorDisplay("outros");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cliente_mp_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cliente_mp_mob_submit_form_cb
  function do_ajax_form_cliente_mp_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cliente_mp_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cliente_mp_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cliente_mp_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_cliente_mp_mob_navigate_form();
    }
  }

  function perform_ajax_form_cliente_mp_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tel");
    scAjaxHideErrorDisplay("outros");
    var var_id_client = document.F2.id_client.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_mp_mob_navigate_form(var_id_client, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_mp_mob_navigate_form_cb);
  } // do_ajax_form_cliente_mp_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mp_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cliente_mp_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_client.value = scAjaxGetKeyValue("id_client");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cliente_mp_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cliente_mp_mob_navigate_form_cb
  function do_ajax_form_cliente_mp_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_cliente_mp_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cliente_mp_mob_navigate_form_cb_after_alert
  function sc_hide_form_cliente_mp_mob_form()
  {
  ...
  ajax_field_list[0] = "nome_da_empresa";
  ajax_field_list[1] = "cnpj";
  ajax_field_list[2] = "sc_field_0";
  ajax_field_list[3] = "email";
  ajax_field_list[4] = "setor";
  ajax_field_list[5] = "tel";
  ajax_field_list[6] = "outros";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "nome_da_empresa": {"label": "Nome Da Empresa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cnpj": {"label": "CNPJ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_0": {"label": "Endereço", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "Email", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "setor": {"label": "Setor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tel": {"label": "Tel", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "outros": {"label": "Outros", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["nome_da_empresa"][1] = "nome_da_empresa";
  ajax_field_mult["cnpj"][1] = "cnpj";
  ajax_field_mult["sc_field_0"][1] = "sc_field_0";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["setor"][1] = "setor";
  ajax_field_mult["tel"][1] = "tel";
  ajax_field_mult["outros"][1] = "outros";

  var ajax_field_id = {
    "nome_da_empresa": new Array("hidden_field_label_nome_da_empresa", "hidden_field_data_nome_da_empresa"),
    "cnpj": new Array("hidden_field_label_cnpj", "hidden_field_data_cnpj"),
    ...
    "setor": new Array("hidden_field_label_setor", "hidden_field_data_setor"),
    "tel": new Array("hidden_field_label_tel", "hidden_field_data_tel"),
    "outros": new Array("hidden_field_label_outros", "hidden_field_data_outros")
  };
