...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_atividade_mp_savio"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_atividade_mp_savio"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_atividade_mp_savio'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_savio']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_savio']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_savio']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_savio']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_savio']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_atividade_mp_savio</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_savio']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_atividade_mp_savio']['embutida_filho'] as $ind => $sc_init)
          {
