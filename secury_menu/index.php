<?php
include_once('secury_menu_session.php');
...
$_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod']      = "";
$_SESSION['scriptcase']['secury_menu']['glo_nm_perfil']         = "conn_nerd";
$_SESSION['scriptcase']['secury_menu']['glo_nm_path_imag_temp'] = "";
$_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo']      = "";
...
//check prod
if(empty($_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod']))
{
   /*check prod*/$_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
}
//check tmp
if(empty($_SESSION['scriptcase']['secury_menu']['glo_nm_path_imag_temp']))
{
   /*check tmp*/$_SESSION['scriptcase']['secury_menu']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
}
...
class secury_menu_class
{
 ...
 function secury_menu_menu()
 {
    global $secury_menu_menuData;
...
$nm_versao_sc  = "" ; 
$_SESSION['scriptcase']['secury_menu']['contr_erro'] = 'off';
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_secury_menu'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_secury_menu'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_secury_menu'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$Campos_Mens_erro = "";
...
$path_libs      = $str_root . $_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod'] . "/third";
$url_third      = $_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "secury_menu/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$path_lib_php   = $str_root . $path_link . "_lib/lib/php";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['secury_menu']['glo_nm_path_imag_temp'];
$menu_largura   = '200';
$menu_mobile_hide          = 'N';
...
if(function_exists('set_php_timezone')) set_php_timezone('secury_menu');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/secury_menu_erro.php");
}
include_once(dirname(__FILE__) . "/secury_menu_erro.class.php"); 
$this->Erro = new secury_menu_erro();
$str_path = substr($_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['secury_menu']['glo_nm_conexao']);
}
/* Definição dos Caminhos */
$secury_menu_menuData          = array();
$secury_menu_menuData['path']  = array();
$secury_menu_menuData['url']   = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $secury_menu_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $secury_menu_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $secury_menu_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $secury_menu_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$secury_menu_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$secury_menu_menuData['url']['web']   = str_replace("\\", '/', $secury_menu_menuData['url']['web']);
$secury_menu_menuData['path']['root'] = substr($secury_menu_menuData['path']['sys'],  0, -1 * strlen($secury_menu_menuData['url']['web']));
$secury_menu_menuData['path']['app']  = substr($secury_menu_menuData['path']['sys'],  0, strrpos($secury_menu_menuData['path']['sys'],  '/'));
$secury_menu_menuData['path']['link'] = substr($secury_menu_menuData['path']['app'],  0, strrpos($secury_menu_menuData['path']['app'],  '/'));
$secury_menu_menuData['path']['link'] = substr($secury_menu_menuData['path']['link'], 0, strrpos($secury_menu_menuData['path']['link'], '/')) . '/';
$secury_menu_menuData['path']['app'] .= '/';
$secury_menu_menuData['url']['app']   = substr($secury_menu_menuData['url']['web'],  0, strrpos($secury_menu_menuData['url']['web'],  '/'));
$secury_menu_menuData['url']['link']  = substr($secury_menu_menuData['url']['app'],  0, strrpos($secury_menu_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] == "S")
{
    $secury_menu_menuData['url']['link']  = substr($secury_menu_menuData['url']['link'], 0, strrpos($secury_menu_menuData['url']['link'], '/'));
}
$secury_menu_menuData['url']['link']  .= '/';
$secury_menu_menuData['url']['app']   .= '/';

$_SESSION['scriptcase']['secury_menu']['sc_apl_link'] = $secury_menu_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['secury_menu']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['secury_menu']['session_timeout']['lang'];
}
elseif (!isset($_SESSION['scriptcase']['secury_menu']['actual_lang']) || $_SESSION['scriptcase']['secury_menu']['actual_lang'] != $this->str_lang) {
    $_SESSION['scriptcase']['secury_menu']['actual_lang'] = $this->str_lang;
...
if ($_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] != "S")
{
    ...
    $_SESSION['scriptcase']['menu_atual'] = "secury_menu";
    $_SESSION['scriptcase']['menu_apls']['secury_menu'] = array();
    if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
    {
        foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
        {
            if (isset($_SESSION['scriptcase']['secury_menu']['glo_nm_conexao']) && $_SESSION['scriptcase']['secury_menu']['glo_nm_conexao'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['secury_menu']['glo_nm_conexao'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['secury_menu']['glo_nm_perfil']) && $_SESSION['scriptcase']['secury_menu']['glo_nm_perfil'] == $NM_con_orig)
            {
/*NM*/          $_SESSION['scriptcase']['secury_menu']['glo_nm_perfil'] = $NM_con_dest;
            }
            if (isset($_SESSION['scriptcase']['secury_menu']['glo_con_' . $NM_con_orig]))
            {
                $_SESSION['scriptcase']['secury_menu']['glo_con_' . $NM_con_orig] = $NM_con_dest;
            }
        }
    }
...
if (isset($_SESSION['scriptcase']['secury_menu']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['secury_menu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['secury_menu']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['secury_menu']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['secury_menu']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['secury_menu']['session_timeout']);
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['secury_menu']['session_timeout']['redir']))
{
...
if (isset($script_case_init))
{
    $_SESSION['sc_session'][1]['secury_menu']['init'] = $script_case_init;
}
elseif (!isset($_SESSION['sc_session'][1]['secury_menu']['init']))
{
    $_SESSION['sc_session'][1]['secury_menu']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['secury_menu']['init'];
...
{ 
    $_SESSION['scriptcase']['sc_apl_seg']['secury_menu'] = "on";
} 
if (!isset($_SESSION['scriptcase']['secury_menu']['session_timeout']['redir']) && (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_menu']) || $_SESSION['scriptcase']['sc_apl_seg']['secury_menu'] != "on"))
{ 
...
if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'secury_menu'))
{
    $_SESSION['sc_session'][1]['secury_menu']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_secury_menu'] = "javascript:window.close()";
}

/* Variáveis de Configuração do Menu */
$secury_menu_menuData['iframe'] = TRUE;

$secury_menu_menuData['height'] = '100%';
if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_grid_sec_users") . "/secury_grid_sec_users_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_grid_sec_users") . "/secury_grid_sec_users_ini.txt");
    ...
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_users']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_grid_sec_apps") . "/secury_grid_sec_apps_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_grid_sec_apps") . "/secury_grid_sec_apps_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_apps']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_grid_sec_groups") . "/secury_grid_sec_groups_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_grid_sec_groups") . "/secury_grid_sec_groups_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_groups']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_grid_sec_users_groups") . "/secury_grid_sec_users_groups_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_grid_sec_users_groups") . "/secury_grid_sec_users_groups_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_users_groups']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_search_sec_groups") . "/secury_search_sec_groups_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_search_sec_groups") . "/secury_search_sec_groups_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_search_sec_groups']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_sync_apps") . "/secury_sync_apps_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_sync_apps") . "/secury_sync_apps_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_sync_apps']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_change_pswd") . "/secury_change_pswd_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_change_pswd") . "/secury_change_pswd_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_change_pswd']))
        {
...
if (is_file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_Login") . "/secury_Login_ini.txt"))
{
    $sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("secury_Login") . "/secury_Login_ini.txt");
    if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
    {
        if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_Login']))
        {
...
<head>
 ...
 <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['secury_menu']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript" src="secury_menu_message.js"></script>
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_secury_menu'];
$secury_menu_menuData['data'] = array();
...
$secury_menu_menuData['data'][] = array(
    ...
    'target'   => " target=\"" . $this->secury_menu_target('_self') . "\"",
    'sc_id'    => "item_1",
...
$str_disabled = "N";
$str_link = "secury_menu_form_php.php?sc_item_menu=item_2&sc_apl_menu=secury_grid_sec_users&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_users']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_users']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "secury_menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=secury_grid_sec_apps&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "secury_menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=secury_grid_sec_groups&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "secury_menu_form_php.php?sc_item_menu=item_11&sc_apl_menu=secury_grid_sec_users_groups&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_users_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['secury_grid_sec_users_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "secury_menu_form_php.php?sc_item_menu=item_5&sc_apl_menu=secury_search_sec_groups&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_search_sec_groups']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['secury_search_sec_groups']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "secury_menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=secury_sync_apps&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_sync_apps']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['secury_sync_apps']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "secury_menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=secury_change_pswd&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_change_pswd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['secury_change_pswd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
...
$str_disabled = "N";
$str_link = "secury_menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=secury_Login&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['secury_Login']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['secury_Login']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
}
    ...
    $secury_menu_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " target=\"" . $this->secury_menu_target('_parent') . "\"",
        'sc_id'    => "item_8",
        'disabled' => $str_disabled,
        'display'  => "",
        'display_position'    => "",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['secury_menu']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['secury_menu']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'secury_menu');
    $secury_menu_menuData['data'] = $str_menu_usu;
}
if (is_file("secury_menu_help.txt"))
{
    $Arq_WebHelp = file("secury_menu_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $secury_menu_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->secury_menu_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'  => "text",
                    'display_position'    => "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['secury_menu']) && !empty($_SESSION['scriptcase']['sc_menu_del']['secury_menu']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($secury_menu_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['secury_menu']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($secury_menu_menuData['data'][$i_menu]);
       }
    ...
    $secury_menu_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['secury_menu']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['secury_menu']))
{
    $disable_menu = false;
    foreach ($secury_menu_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['secury_menu']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $secury_menu_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($secury_menu_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $secury_menu_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($secury_menu_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($secury_menu_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $secury_menu_menuData['data'][$chave]['level'];
                        unset($secury_menu_menuData['data'][$chave]);
                }
        }
}
$secury_menu_menuData['data'] = array_values($secury_menu_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($secury_menu_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if ($secury_menu_menuData['data'][$chave]['disabled'] == 'Y')
            {
                    unset($secury_menu_menuData['data'][$chave]['disabled']);
                    foreach ($secury_menu_menuData['data'] as $_key => $_val)
                    {
                            if($_key > $chave)
                            {
                                    if($secury_menu_menuData['data'][$_key]['level'] > $secury_menu_menuData['data'][$chave]['level'])
                                    {
                                            unset($secury_menu_menuData['data'][$_key]);
                                    }
                                    else
                                    {
                                            break;
            ...
            if (isset($secury_menu_menuData['data'][$chave + 1]) && !empty($secury_menu_menuData['data'][$chave + 1]))
            {
                if ($secury_menu_menuData['data'][$chave]['link'] == "#")
                {
                    if ($secury_menu_menuData['data'][$chave]['level'] >= $secury_menu_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($secury_menu_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($secury_menu_menuData['data'][$chave]['link'] == "#")
            {
                unset($secury_menu_menuData['data'][$chave]);
            }
        }
...
<?php
    $_SESSION['scriptcase']['secury_menu']['apl_inicial'] = ($NM_scr_iframe != "") ? $NM_scr_iframe : "secury_menu_pag_ini.php";
    $_SESSION['scriptcase']['secury_menu']['path_link'] = $path_link;
?>
        ...
        <td class="scMenuTTableM" valign="top">
                <table cellpadding=0 cellspacing=0>
                    <tr>
                      ...
                      <?php
                      echo $this->secury_menu_escreveMenu($secury_menu_menuData['data']);
                      ?>
                            </td>
                    </tr>
                </table>
...
<div class="ui-layout-center">
  <table cellspacing=0 cellpadding=0 style="height: 100%; width: 100%" cellpadding=0 cellspacing=0>
    <tr>
        ...
        <iframe name="secury_menu_iframe" id="iframe_secury_menu" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;" src="<?php echo $_SESSION['scriptcase']['secury_menu']['apl_inicial']?>"></iframe>
      </tr>
    </table>
</div>
<script type="text/javascript">
...
Iframe_atual = "secury_menu_iframe";
</script>
</body>
</html>
<?php
...
/* Controle de Target */
function secury_menu_escreveMenu($arr_menu)
{
    $aMenuItemList = array();
...
/* Controle de Target */
   function secury_menu_target($str_target)
   {
       global $secury_menu_menuData;
       ...
       elseif ($secury_menu_menuData['iframe'])
       {
           return 'secury_menu_iframe';
       }
       else
       {
           return $str_target;
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "javascript:parent.nm_out_menu('secury_menu_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . "')";  
               }
               else
               {
                    $str_line['link'] = "secury_menu_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($secury_menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['secury_menu']['glo_nm_usa_grupo'] . ""; 
               }
           }
           elseif ($arr_item['target'] == '_parent')
           {
               $str_line['link'] = "javascript:parent.nm_out_menu('" . $_SESSION['scriptcase']['sc_saida_secury_menu'] . "')"; 
           }
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->secury_menu_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['secury_menu']['sc_init'][$apl_menu] = 1;
        return  1;
   }
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['secury_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['secury_menu']['glo_nm_path_imag_temp'] . "/sc_apl_default_gestao_focus_pronto.txt"));
    }
    if (isset($apl_def)) {
        if ($apl_def[0] != "secury_menu") {
            $_SESSION['scriptcase']['sem_session'] = true;
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['secury_menu']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['secury_menu']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
            $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
            $_SESSION['scriptcase']['secury_menu']['session_timeout']['redir_tp'] = $Redir_tp;
        }
        if (isset($_COOKIE['sc_actual_lang_gestao_focus_pronto'])) {
            $_SESSION['scriptcase']['secury_menu']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_gestao_focus_pronto'];
        }
    }
}
...
$contr_secury_menu = new secury_menu_class;
$contr_secury_menu->secury_menu_menu();
