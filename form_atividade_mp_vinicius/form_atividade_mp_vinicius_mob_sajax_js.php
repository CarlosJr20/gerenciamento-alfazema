  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_atividade_mp_vinicius_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_atividade_mp_vinicius_mob_form();
	}
  ...
  // ---------- Validate selecao_projetos
  function do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_projetos()
  {
    var nomeCampo_selecao_projetos = "selecao_projetos";
    var var_selecao_projetos = scAjaxGetFieldSelect(nomeCampo_selecao_projetos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_vinicius_mob_validate_selecao_projetos(var_selecao_projetos, var_script_case_init, do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_projetos_cb);
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_projetos

  function do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_projetos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selecao_projetos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_projetos_cb

  // ---------- Validate tag
  function do_ajax_form_atividade_mp_vinicius_mob_validate_tag()
  {
    var nomeCampo_tag = "tag";
    var var_tag = scAjaxGetFieldSelect(nomeCampo_tag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_vinicius_mob_validate_tag(var_tag, var_script_case_init, do_ajax_form_atividade_mp_vinicius_mob_validate_tag_cb);
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_tag

  function do_ajax_form_atividade_mp_vinicius_mob_validate_tag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tag";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_tag_cb

  // ---------- Validate selecao_atividade
  function do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_atividade()
  {
    var nomeCampo_selecao_atividade = "selecao_atividade";
    var var_selecao_atividade = scAjaxGetFieldSelect(nomeCampo_selecao_atividade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_vinicius_mob_validate_selecao_atividade(var_selecao_atividade, var_script_case_init, do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_atividade_cb);
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_atividade

  function do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_atividade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selecao_atividade";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_selecao_atividade_cb

  // ---------- Validate data
  function do_ajax_form_atividade_mp_vinicius_mob_validate_data()
  {
    ...
    setTimeout(function() {
      var var_data = scAjaxGetFieldText(nomeCampo_data);
      x_ajax_form_atividade_mp_vinicius_mob_validate_data(var_data, var_script_case_init, do_ajax_form_atividade_mp_vinicius_mob_validate_data_cb);
    }, 200);
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_data

  function do_ajax_form_atividade_mp_vinicius_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_data_cb

  // ---------- Validate hora_inicio
  function do_ajax_form_atividade_mp_vinicius_mob_validate_hora_inicio()
  {
    var nomeCampo_hora_inicio = "hora_inicio";
    var var_hora_inicio = scAjaxGetFieldText(nomeCampo_hora_inicio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_vinicius_mob_validate_hora_inicio(var_hora_inicio, var_script_case_init, do_ajax_form_atividade_mp_vinicius_mob_validate_hora_inicio_cb);
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_hora_inicio

  function do_ajax_form_atividade_mp_vinicius_mob_validate_hora_inicio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora_inicio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_hora_inicio_cb

  // ---------- Validate hora_final
  function do_ajax_form_atividade_mp_vinicius_mob_validate_hora_final()
  {
    var nomeCampo_hora_final = "hora_final";
    var var_hora_final = scAjaxGetFieldText(nomeCampo_hora_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_vinicius_mob_validate_hora_final(var_hora_final, var_script_case_init, do_ajax_form_atividade_mp_vinicius_mob_validate_hora_final_cb);
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_hora_final

  function do_ajax_form_atividade_mp_vinicius_mob_validate_hora_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora_final";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_hora_final_cb

  // ---------- Validate descricao
  function do_ajax_form_atividade_mp_vinicius_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_atividade_mp_vinicius_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_atividade_mp_vinicius_mob_validate_descricao_cb);
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_descricao

  function do_ajax_form_atividade_mp_vinicius_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_atividade_mp_vinicius_mob_validate_descricao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_atividade_mp_vinicius_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_atividade_mp_vinicius_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_selecao_projetos = scAjaxGetFieldSelect("selecao_projetos");
    var var_tag = scAjaxGetFieldSelect("tag");
    var var_selecao_atividade = scAjaxGetFieldSelect("selecao_atividade");
    var var_data = scAjaxGetFieldText("data");
    var var_hora_inicio = scAjaxGetFieldText("hora_inicio");
    var var_hora_final = scAjaxGetFieldText("hora_final");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_id_atividade_mp = scAjaxGetFieldText("id_atividade_mp");
    ...
    scAjaxProcOn();
    x_ajax_form_atividade_mp_vinicius_mob_submit_form(var_selecao_projetos, var_tag, var_selecao_atividade, var_data, var_hora_inicio, var_hora_final, var_descricao, var_id_atividade_mp, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_atividade_mp_vinicius_mob_submit_form_cb);
  } // do_ajax_form_atividade_mp_vinicius_mob_submit_form

  function do_ajax_form_atividade_mp_vinicius_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("selecao_projetos");
      scAjaxHideErrorDisplay("tag");
      scAjaxHideErrorDisplay("selecao_atividade");
      scAjaxHideErrorDisplay("data");
      scAjaxHideErrorDisplay("hora_inicio");
      scAjaxHideErrorDisplay("hora_final");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_atividade_mp_vinicius_mob_submit_form_cb_after_alert);
  } // do_ajax_form_atividade_mp_vinicius_mob_submit_form_cb
  function do_ajax_form_atividade_mp_vinicius_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_atividade_mp_vinicius_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_atividade_mp_vinicius_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_atividade_mp_vinicius_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_atividade_mp_vinicius_mob_navigate_form();
    }
  }

  function perform_ajax_form_atividade_mp_vinicius_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("hora_final");
    scAjaxHideErrorDisplay("descricao");
    var var_id_atividade_mp = document.F2.id_atividade_mp.value;
    ...
    scAjaxProcOn();
    x_ajax_form_atividade_mp_vinicius_mob_navigate_form(var_id_atividade_mp, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_atividade_mp_vinicius_mob_navigate_form_cb);
  } // do_ajax_form_atividade_mp_vinicius_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_atividade_mp_vinicius_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_atividade_mp_vinicius_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_atividade_mp.value = scAjaxGetKeyValue("id_atividade_mp");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_atividade_mp_vinicius_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_atividade_mp_vinicius_mob_navigate_form_cb
  function do_ajax_form_atividade_mp_vinicius_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_atividade_mp_vinicius_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_atividade_mp_vinicius_mob_navigate_form_cb_after_alert
  function sc_hide_form_atividade_mp_vinicius_mob_form()
  {
  ...
  ajax_field_list[0] = "selecao_projetos";
  ajax_field_list[1] = "tag";
  ajax_field_list[2] = "selecao_atividade";
  ajax_field_list[3] = "data";
  ajax_field_list[4] = "hora_inicio";
  ajax_field_list[5] = "hora_final";
  ajax_field_list[6] = "descricao";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "selecao_projetos": {"label": "Projeto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tag": {"label": "Função", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "selecao_atividade": {"label": "Atividade", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data": {"label": "Data", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hora_inicio": {"label": "Hora Início", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hora_final": {"label": "Hora Final", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "selecao_projetos": new Array(),
    "tag": new Array(),
    "selecao_atividade": new Array(),
    "data": new Array(),
    "hora_inicio": new Array(),
    "hora_final": new Array(),
    "descricao": new Array()
  };
  ajax_field_mult["selecao_projetos"][1] = "selecao_projetos";
  ajax_field_mult["tag"][1] = "tag";
  ajax_field_mult["selecao_atividade"][1] = "selecao_atividade";
  ajax_field_mult["data"][1] = "data";
  ajax_field_mult["hora_inicio"][1] = "hora_inicio";
  ajax_field_mult["hora_final"][1] = "hora_final";
  ajax_field_mult["descricao"][1] = "descricao";

  var ajax_field_id = {
    "selecao_projetos": new Array("hidden_field_label_selecao_projetos", "hidden_field_data_selecao_projetos"),
    "tag": new Array("hidden_field_label_tag", "hidden_field_data_tag"),
    "selecao_atividade": new Array("hidden_field_label_selecao_atividade", "hidden_field_data_selecao_atividade"),
    "data": new Array("hidden_field_label_data", "hidden_field_data_data"),
    "hora_inicio": new Array("hidden_field_label_hora_inicio", "hidden_field_data_hora_inicio"),
    "hora_final": new Array("hidden_field_label_hora_final", "hidden_field_data_hora_final"),
    "descricao": new Array("hidden_field_label_descricao", "hidden_field_data_descricao")
  };

  var ajax_read_only = {
    "selecao_projetos": "off",
    "tag": "off",
    "selecao_atividade": "off",
    "data": "off",
    "hora_inicio": "off",
    "hora_final": "off",
    "descricao": "off"
