...
class form_atividade_mp_vinicius_mob_erro
{
   var $Ini;
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return form_atividade_mp_vinicius_mob_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
