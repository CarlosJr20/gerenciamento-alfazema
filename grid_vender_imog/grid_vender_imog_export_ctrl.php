<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vender_imog']['sc_process_barr'] = true;
require_once('../grid_vender_imog/index.php');
unset($_SESSION['scriptcase']['grid_vender_imog']['sc_process_barr']);
$ExportCtrl = new grid_vender_imog_export_control;
$ExportCtrl->Export_barr();

class grid_vender_imog_export_control
{
