...
<?php
   ...
   $Ord_Cmp = new grid_vender_imog_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_vender_imog_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["img"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["img"])) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["img"] : "Img";
   $tab_ger_campos['titulo'] = "on";
   $tab_def_campos['titulo'] = "titulo";
   $tab_labels["titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["titulo"])) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["titulo"] : "Titulo";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["valor"] : "Valor";
   $tab_ger_campos['quartos'] = "on";
   $tab_def_campos['quartos'] = "quartos";
   $tab_labels["quartos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["quartos"])) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["quartos"] : "Quartos";
   $tab_ger_campos['area'] = "on";
   $tab_def_campos['area'] = "area";
   $tab_labels["area"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["area"])) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["area"] : "Area";
   $tab_ger_campos['lote'] = "on";
   $tab_def_campos['lote'] = "lote";
   $tab_labels["lote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["lote"])) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["lote"] : "Lote";
   $tab_ger_campos['ano'] = "on";
   $tab_def_campos['ano'] = "ano";
   $tab_labels["ano"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["ano"])) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["ano"] : "Ano";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['labels']["descricao"] : "Descricao";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_vender_imog_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_vender_imog']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
