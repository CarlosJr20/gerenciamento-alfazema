...
class grid_alfazema_veiculo_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_alfazema_veiculo_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_alfazema_veiculo_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_alfazema_veiculo_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nome')
      {
          ...
          $nmgp_def_dados = $this->lookup_ajax_nome($nome);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_bloco')
      {
          $bloco = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_bloco($bloco);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "Data";$Nm_datas[] = "Data";$Nm_datas[] = "Hora_Entrada";$Nm_datas[] = "Hora_Entrada";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "alfazema_veiculo.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_alfazema_veiculo/grid_alfazema_veiculo_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_alfazema_veiculo_ajax_search.js"></script>
 <script type="text/javascript" src="grid_alfazema_veiculo_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_alfazema_veiculo_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_alfazema_veiculo']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_alfazema_veiculo']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_hora_entrada_cond#NMF#' + search_get_sel_txt('SC_hora_entrada_cond') + '@NMF@';
  str_out += 'SC_hora_entrada_hor#NMF#' + search_get_sel_txt('SC_hora_entrada_hor') + '@NMF@';
  str_out += 'SC_hora_entrada_min#NMF#' + search_get_sel_txt('SC_hora_entrada_min') + '@NMF@';
  str_out += 'SC_hora_entrada_seg#NMF#' + search_get_sel_txt('SC_hora_entrada_seg') + '@NMF@';
  str_out += 'SC_hora_entrada_input_2_hor#NMF#' + search_get_sel_txt('SC_hora_entrada_input_2_hor') + '@NMF@';
  str_out += 'SC_hora_entrada_input_2_min#NMF#' + search_get_sel_txt('SC_hora_entrada_input_2_min') + '@NMF@';
  str_out += 'SC_hora_entrada_input_2_seg#NMF#' + search_get_sel_txt('SC_hora_entrada_input_2_seg') + '@NMF@';
  str_out += 'SC_id_alfazema_cond#NMF#' + search_get_sel_txt('SC_id_alfazema_cond') + '@NMF@';
  str_out += 'SC_id_alfazema#NMF#' + search_get_text('SC_id_alfazema') + '@NMF@';
  ...
  str_out += 'SC_bloco_cond#NMF#' + search_get_sel_txt('SC_bloco_cond') + '@NMF@';
  str_out += 'SC_bloco#NMF#' + search_get_text('SC_bloco') + '@NMF@';
  str_out += 'id_ac_bloco#NMF#' + search_get_text('id_ac_bloco') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nome").attr('class').split(' ');
   ...
   scClass = $("#id_ac_bloco").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_bloco").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_bloco",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">CONSULTA VEÍCULOS</div>
...
<?php
   ...
   {
      global 
             $hora_entrada_cond, $hora_entrada, $hora_entrada_hor, $hora_entrada_min, $hora_entrada_seg,
             $id_alfazema_cond, $id_alfazema,
             $nome_cond, $nome, $nome_autocomp,
             $bloco_cond, $bloco, $bloco_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $hora_entrada_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_hor']; 
          $hora_entrada_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_min']; 
          $hora_entrada_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_seg']; 
          $hora_entrada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_cond']; 
          $id_alfazema = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['id_alfazema']; 
          $id_alfazema_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['id_alfazema_cond']; 
          $nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['nome']; 
          $nome_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['nome_cond']; 
          $bloco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['bloco']; 
          $bloco_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['bloco_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['NM_operador']; 
          if (strtoupper($id_alfazema_cond) != "II" && strtoupper($id_alfazema_cond) != "QP" && strtoupper($id_alfazema_cond) != "NP" && strtoupper($id_alfazema_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_alfazema, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($hora_entrada_cond) || empty($hora_entrada_cond))
      {
         $hora_entrada_cond = "eq";
      }
      if (!isset($id_alfazema_cond) || empty($id_alfazema_cond))
      {
         $id_alfazema_cond = "gt";
      }
      ...
      if (!isset($bloco_cond) || empty($bloco_cond))
      {
         $bloco_cond = "qp";
      }
      ...
      $str_hide_hora_entrada = (in_array($hora_entrada_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_alfazema = (in_array($id_alfazema_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nome = (in_array($nome_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_bloco = (in_array($bloco_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($hora_entrada) || $hora_entrada == "")
      {
          $hora_entrada = "";
      }
      if (isset($hora_entrada) && !empty($hora_entrada))
      {
         $tmp_pos = strpos($hora_entrada, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $hora_entrada = substr($hora_entrada, 0, $tmp_pos);
         }
      }
      if (!isset($id_alfazema) || $id_alfazema == "")
      {
          $id_alfazema = "";
      }
      if (isset($id_alfazema) && !empty($id_alfazema))
      {
         $tmp_pos = strpos($id_alfazema, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_alfazema = substr($id_alfazema, 0, $tmp_pos);
         }
      }
      if (!isset($nome) || $nome == "")
      {
      ...
      if (!isset($bloco) || $bloco == "")
      {
          $bloco = "";
      }
      if (isset($bloco) && !empty($bloco))
      {
         $tmp_pos = strpos($bloco, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $bloco = substr($bloco, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_hora_entrada_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['hora_entrada'])) ? $this->New_label['hora_entrada'] : "Hora Entrada"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_hora_entrada_cond" name="hora_entrada_cond" onChange="nm_campos_between(document.getElementById('id_vis_hora_entrada'), this, 'hora_entrada')">
       <OPTION value="eq" <?php if ("eq" == $hora_entrada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $hora_entrada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $hora_entrada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $hora_entrada_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_hora_entrada" <?php echo $str_hide_hora_entrada?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['hora_entrada'])) ? $this->New_label['hora_entrada'] : "Hora Entrada";
 $nmgp_tab_label .= "hora_entrada?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_hora_entrada_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_hora_entrada_hor" name="hora_entrada_hor" value="<?php echo NM_encode_input($hora_entrada_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_hora_entrada_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_hora_entrada_min" name="hora_entrada_min" value="<?php echo NM_encode_input($hora_entrada_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_hora_entrada_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_hora_entrada_seg" name="hora_entrada_seg" value="<?php echo NM_encode_input($hora_entrada_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
?>
        <SPAN id="id_css_hora_entrada"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_id_alfazema_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_alfazema'])) ? $this->New_label['id_alfazema'] : "Id Alfazema"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_alfazema_cond" name="id_alfazema_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_alfazema'), this, 'id_alfazema')">
       <OPTION value="gt" <?php if ("gt" == $id_alfazema_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_alfazema_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_alfazema_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_alfazema" <?php echo $str_hide_id_alfazema?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_alfazema'])) ? $this->New_label['id_alfazema'] : "Id Alfazema";
 $nmgp_tab_label .= "id_alfazema?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_alfazema" name="id_alfazema" value="<?php echo NM_encode_input($id_alfazema) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<INPUT  type="text" id="SC_nome" name="nome" value="<?php echo NM_encode_input($nome) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nome" name="nome_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_bloco_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['bloco'])) ? $this->New_label['bloco'] : "Bloco"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_bloco_cond" name="bloco_cond" onChange="nm_campos_between(document.getElementById('id_vis_bloco'), this, 'bloco')">
       <OPTION value="qp" <?php if ("qp" == $bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $bloco_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_bloco" <?php echo $str_hide_bloco?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['bloco'])) ? $this->New_label['bloco'] : "Bloco";
 $nmgp_tab_label .= "bloco?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $bloco;
      }
?>
<INPUT  type="text" id="SC_bloco" name="bloco" value="<?php echo NM_encode_input($bloco) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_bloco" name="bloco_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_alfazema_veiculo_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_alfazema_veiculo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_alfazema_veiculo']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.hora_entrada_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_hora_entrada'), document.F1.hora_entrada_cond, 'hora_entrada');
   document.F1.hora_entrada_hor.value = "";
   document.F1.hora_entrada_min.value = "";
   document.F1.hora_entrada_seg.value = "";
   document.F1.id_alfazema_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_alfazema'), document.F1.id_alfazema_cond, 'id_alfazema');
   document.F1.id_alfazema.value = "";
   ...
   document.F1.bloco_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_bloco'), document.F1.bloco_cond, 'bloco');
   document.F1.bloco.value = "";
   document.F1.bloco_autocomp.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_hora_entrada_hor').bind('change', function() {sc_grid_alfazema_veiculo_valida_hora(this)});
    $('#SC_hora_entrada_min').bind('change', function() {sc_grid_alfazema_veiculo_valida_min(this)});
    $('#SC_hora_entrada_seg').bind('change', function() {sc_grid_alfazema_veiculo_valida_seg(this)});
 }
 function sc_grid_alfazema_veiculo_valida_hora(obj)
 {
 ...
 function sc_grid_alfazema_veiculo_valida_min(obj)
 {
 ...
 function sc_grid_alfazema_veiculo_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_alfazema_veiculo/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_hora_entrada_cond'] = 'cond';
      $tp_fields['SC_hora_entrada_hor'] = 'text';
      $tp_fields['SC_hora_entrada_min'] = 'text';
      $tp_fields['SC_hora_entrada_seg'] = 'text';
      $tp_fields['SC_hora_entrada_input_2_hor'] = 'text';
      $tp_fields['SC_hora_entrada_input_2_min'] = 'text';
      $tp_fields['SC_hora_entrada_input_2_seg'] = 'text';
      $tp_fields['SC_id_alfazema_cond'] = 'cond';
      $tp_fields['SC_id_alfazema'] = 'text';
      $tp_fields['SC_nome_cond'] = 'cond';
      $tp_fields['SC_nome'] = 'text_aut';
      $tp_fields['id_ac_nome'] = 'text_aut';
      $tp_fields['SC_bloco_cond'] = 'cond';
      $tp_fields['SC_bloco'] = 'text_aut';
      $tp_fields['id_ac_bloco'] = 'text_aut';
   ...
   {
      global $hora_entrada_cond, $hora_entrada, $hora_entrada_hor, $hora_entrada_min, $hora_entrada_seg,
             $id_alfazema_cond, $id_alfazema,
             $nome_cond, $nome, $nome_autocomp,
             $bloco_cond, $bloco, $bloco_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq'] = array();
      if (!empty($nome_autocomp) && empty($nome))
      {
          $nome = $nome_autocomp;
      }
      if (!empty($bloco_autocomp) && empty($bloco))
      {
          $bloco = $bloco_autocomp;
      }
      $hora_entrada_cond_salva = $hora_entrada_cond; 
      $id_alfazema_cond_salva = $id_alfazema_cond; 
      if (!isset($id_alfazema_input_2) || $id_alfazema_input_2 == "")
      {
          $id_alfazema_input_2 = $id_alfazema;
      }
      ...
      $bloco_cond_salva = $bloco_cond; 
      if (!isset($bloco_input_2) || $bloco_input_2 == "")
      {
          $bloco_input_2 = $bloco;
      }
      if ($id_alfazema_cond != "in")
      {
          nm_limpa_numero($id_alfazema, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_hor'] = $hora_entrada_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_min'] = $hora_entrada_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_seg'] = $hora_entrada_seg; 
      if (!empty($hora_entrada_hor) || !empty($hora_entrada_min) || !empty($hora_entrada_seg) || $hora_entrada_cond_salva == "nu" || $hora_entrada_cond_salva == "nn" || $hora_entrada_cond_salva == "ep" || $hora_entrada_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $hora_entrada_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $hora_entrada_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $hora_entrada_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_cond'] = $hora_entrada_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['cmp'] = "hora_entrada"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['opc'] = $hora_entrada_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq']['hora_entrada'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['id_alfazema'] = $id_alfazema; 
      if (is_array($id_alfazema) && !empty($id_alfazema))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0] = $id_alfazema;
      }
      elseif ($id_alfazema_cond_salva == "nu" || $id_alfazema_cond_salva == "nn" || $id_alfazema_cond_salva == "ep" || $id_alfazema_cond_salva == "ne" || !empty($id_alfazema))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0][0] = $id_alfazema;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['id_alfazema_cond'] = $id_alfazema_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['cmp'] = "id_alfazema"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['opc'] = $id_alfazema_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq']['id_alfazema'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['nome'] = $nome; 
      if (is_array($nome) && !empty($nome))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0] = $nome;
      }
      elseif ($nome_cond_salva == "nu" || $nome_cond_salva == "nn" || $nome_cond_salva == "ep" || $nome_cond_salva == "ne" || !empty($nome))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0][0] = $nome;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['nome_cond'] = $nome_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['cmp'] = "nome"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['opc'] = $nome_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq']['nome'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['bloco'] = $bloco; 
      if (is_array($bloco) && !empty($bloco))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0] = $bloco;
      }
      elseif ($bloco_cond_salva == "nu" || $bloco_cond_salva == "nn" || $bloco_cond_salva == "ep" || $bloco_cond_salva == "ne" || !empty($bloco))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['val'][0][0] = $bloco;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['bloco_cond'] = $bloco_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['cmp'] = "bloco"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid]['opc'] = $bloco_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq']['bloco'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $id_alfazema;
      if (strtoupper($id_alfazema_cond) != "II" && strtoupper($id_alfazema_cond) != "QP" && strtoupper($id_alfazema_cond) != "NP" && strtoupper($id_alfazema_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_alfazema'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nome != '') {
      $nome_look = substr($this->Db->qstr($nome), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nome'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nome'] = $nome;
      }
      $nmgp_def_dados = array();
    if ($bloco != '') {
      $bloco_look = substr($this->Db->qstr($bloco), 1, -1); 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['bloco'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['bloco'] = $bloco;
      }

      //----- $hora_entrada
      $this->Date_part = false;
      if ($hora_entrada_cond != "bi_TP")
      {
          $hora_entrada_cond = strtoupper($hora_entrada_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $hora_entrada_hor;
          $Dtxt .= $hora_entrada_min;
          $Dtxt .= $hora_entrada_seg;
          $val[0]['hor'] = $hora_entrada_hor;
          $val[0]['min'] = $hora_entrada_min;
          $val[0]['seg'] = $hora_entrada_seg;
          if ($hora_entrada_cond == "BW")
          {
              $val[1]['ano'] = $hora_entrada_input_2_ano;
              $val[1]['mes'] = $hora_entrada_input_2_mes;
              $val[1]['dia'] = $hora_entrada_input_2_dia;
              $val[1]['hor'] = $hora_entrada_input_2_hor;
              $val[1]['min'] = $hora_entrada_input_2_min;
              $val[1]['seg'] = $hora_entrada_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "HH", "TIME", $hora_entrada_cond, "", "hora");
          $hora_entrada = $val[0];
          $this->cmp_formatado['hora_entrada'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['hora_entrada'], "HH:II:SS");
          $this->cmp_formatado['hora_entrada'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("HH", "his"));
          if ($hora_entrada_cond == "BW")
          {
              $hora_entrada_input_2     = $val[1];
              $this->cmp_formatado['hora_entrada_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']['hora_entrada_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['hora_entrada_input_2'], "HH:II:SS");
              $this->cmp_formatado['hora_entrada_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("HH", "his"));
          }
          if (!empty($Dtxt) || $hora_entrada_cond == "NU" || $hora_entrada_cond == "NN"|| $hora_entrada_cond == "EP"|| $hora_entrada_cond == "NE")
          {
              $this->monta_condicao("Hora_Entrada", $hora_entrada_cond, $hora_entrada, $hora_entrada_input_2, 'hora_entrada', 'TIME');
          }
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq']['hora_entrada']['label'] = $nmgp_tab_label['hora_entrada'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq']['hora_entrada']['descr'] = $nmgp_tab_label['hora_entrada'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['grid_pesq']['hora_entrada']['hint']  = $nmgp_tab_label['hora_entrada'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $id_alfazema
      $this->Date_part = false;
      if (isset($id_alfazema) || $id_alfazema_cond == "nu" || $id_alfazema_cond == "nn" || $id_alfazema_cond == "ep" || $id_alfazema_cond == "ne")
      {
         $this->monta_condicao("id_alfazema", $id_alfazema_cond, $id_alfazema, "", "id_alfazema");
      }

      //----- $nome
      $this->Date_part = false;
      if (isset($nome) || $nome_cond == "nu" || $nome_cond == "nn" || $nome_cond == "ep" || $nome_cond == "ne")
      {
      ...
      //----- $bloco
      $this->Date_part = false;
      if (isset($bloco) || $bloco_cond == "nu" || $bloco_cond == "nn" || $bloco_cond == "ep" || $bloco_cond == "ne")
      {
         $this->monta_condicao("Bloco", $bloco_cond, $bloco, "", "bloco");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_alfazema_veiculo']['cond_pesq'] .= $this->NM_operador;
