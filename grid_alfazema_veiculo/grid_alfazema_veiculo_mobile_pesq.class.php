...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "Data";$Nm_datas[] = "Data";$Nm_datas[] = "Hora_Entrada";$Nm_datas[] = "Hora_Entrada";$Nm_numeric[] = "id_alfazema";$Nm_numeric[] = "`n�mero`";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_hora_entrada_cond" name="hora_entrada_cond" onChange="nm_campos_between(document.getElementById('id_vis_hora_entrada'), this, 'hora_entrada')">
      ...
      <br><span id="id_hide_hora_entrada"  <?php echo $str_hide_hora_entrada?>>
<?php
  $Form_base = "hhiiss";
  $date_format_show = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_alfazema_cond" name="id_alfazema_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_alfazema'), this, 'id_alfazema')">
      ...
      <br><span id="id_hide_id_alfazema"  <?php echo $str_hide_id_alfazema?>><INPUT  type="text" id="SC_id_alfazema" name="id_alfazema" value="<?php echo NM_encode_input($id_alfazema) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nome_cond" name="nome_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome'), this, 'nome')">
      ...
      <br><span id="id_hide_nome"  <?php echo $str_hide_nome?>><?php
      if ($nome != "")
      {
      $nome_look = substr($this->Db->qstr($nome), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_bloco_cond" name="bloco_cond" onChange="nm_campos_between(document.getElementById('id_vis_bloco'), this, 'bloco')">
      ...
      <br><span id="id_hide_bloco"  <?php echo $str_hide_bloco?>><?php
      if ($bloco != "")
      {
      $bloco_look = substr($this->Db->qstr($bloco), 1, -1); 
      $nmgp_def_dados = array(); 
