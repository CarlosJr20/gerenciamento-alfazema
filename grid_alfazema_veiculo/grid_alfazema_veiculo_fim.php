...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_alfazema_veiculo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_alfazema_veiculo"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_alfazema_veiculo'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_alfazema_veiculo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_alfazema_veiculo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_alfazema_veiculo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_alfazema_veiculo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_alfazema_veiculo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_alfazema_veiculo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_alfazema_veiculo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_alfazema_veiculo']['embutida_filho'] as $ind => $sc_init)
          {
