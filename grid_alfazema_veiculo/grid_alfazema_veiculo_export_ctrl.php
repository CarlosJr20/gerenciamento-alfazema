<?php
@session_start() ;
$_SESSION['scriptcase']['grid_alfazema_veiculo']['sc_process_barr'] = true;
require_once('../grid_alfazema_veiculo/index.php');
unset($_SESSION['scriptcase']['grid_alfazema_veiculo']['sc_process_barr']);
$ExportCtrl = new grid_alfazema_veiculo_export_control;
$ExportCtrl->Export_barr();

class grid_alfazema_veiculo_export_control
{
