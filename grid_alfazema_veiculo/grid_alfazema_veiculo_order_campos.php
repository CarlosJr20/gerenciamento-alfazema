...
<?php
   ...
   $Ord_Cmp = new grid_alfazema_veiculo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_alfazema_veiculo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["nome"] : "Nome";
   $tab_ger_campos['bloco'] = "on";
   $tab_def_campos['bloco'] = "Bloco";
   $tab_labels["bloco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["bloco"])) ? $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["bloco"] : "Bloco";
   ...
   {
       $tab_def_campos['sc_field_0'] = "`Número`";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["sc_field_0"] : "Número";
   ...
   {
       $tab_def_campos['sc_field_1'] = "`Veículo`";
   }
   $tab_labels["sc_field_1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["sc_field_1"])) ? $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["sc_field_1"] : "Veículo";
   $tab_ger_campos['placa'] = "on";
   $tab_def_campos['placa'] = "Placa";
   $tab_labels["placa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["placa"])) ? $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["placa"] : "Placa";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "Data";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["data"] : "Data";
   $tab_ger_campos['hora_entrada'] = "on";
   $tab_def_campos['hora_entrada'] = "Hora_Entrada";
   $tab_labels["hora_entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["hora_entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['labels']["hora_entrada"] : "Hora Entrada";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_alfazema_veiculo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_alfazema_veiculo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
