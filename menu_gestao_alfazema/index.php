...
-->
               ...
               <!-- Lançamanto de horas -->
               <li>
                  <a href='../calendar_gestao_alfazema_area/calendar_gestao_alfazema_area.php' target='CMIframe'><i class=''><img src= '<?php echo sc_url_library("sys", "nav_bar_vertical","img/calendar.png"); ?>' class = 'icon' style='width: 16px' ></i> <span class='nav-label'>Agendamento</span>
<!--                   <span class='fa arrow'></span> -->
                  </a> 
<!--                   <ul class='nav nav-second-level collapse' style=''>
                     <li>
                        <a id='cad' href='../calendar_gestao_alfazema_area/calendar_gestao_alfazema_area.php'  target='CMIframe' > 
                           <img src= '</?php echo sc_url_library("sys", "nerd_imog","img/calendar.png"); ?>' style='width: 16px' class = 'icon' > Calendário 
