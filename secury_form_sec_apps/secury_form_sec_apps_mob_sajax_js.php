  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_secury_form_sec_apps_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_secury_form_sec_apps_mob_form();
	}
  ...
  // ---------- Validate app_name
  function do_ajax_secury_form_sec_apps_mob_validate_app_name()
  {
    var nomeCampo_app_name = "app_name";
    var var_app_name = scAjaxGetFieldText(nomeCampo_app_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_secury_form_sec_apps_mob_validate_app_name(var_app_name, var_script_case_init, do_ajax_secury_form_sec_apps_mob_validate_app_name_cb);
  } // do_ajax_secury_form_sec_apps_mob_validate_app_name

  function do_ajax_secury_form_sec_apps_mob_validate_app_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "app_name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_secury_form_sec_apps_mob_validate_app_name_cb

  // ---------- Validate description
  function do_ajax_secury_form_sec_apps_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_secury_form_sec_apps_mob_validate_description(var_description, var_script_case_init, do_ajax_secury_form_sec_apps_mob_validate_description_cb);
  } // do_ajax_secury_form_sec_apps_mob_validate_description

  function do_ajax_secury_form_sec_apps_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_secury_form_sec_apps_mob_validate_description_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_secury_form_sec_apps_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_secury_form_sec_apps_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_app_name = scAjaxGetFieldText("app_name");
    ...
    scAjaxProcOn();
    x_ajax_secury_form_sec_apps_mob_submit_form(var_app_name, var_description, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_secury_form_sec_apps_mob_submit_form_cb);
  } // do_ajax_secury_form_sec_apps_mob_submit_form

  function do_ajax_secury_form_sec_apps_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("app_name");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_secury_form_sec_apps_mob_submit_form_cb_after_alert);
  } // do_ajax_secury_form_sec_apps_mob_submit_form_cb
  function do_ajax_secury_form_sec_apps_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_secury_form_sec_apps_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_secury_form_sec_apps_mob_navigate_form()
  {
    perform_ajax_secury_form_sec_apps_mob_navigate_form();
  }

  function perform_ajax_secury_form_sec_apps_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("app_name");
    scAjaxHideErrorDisplay("description");
    var var_app_name = document.F2.app_name.value;
    ...
    scAjaxProcOn();
    x_ajax_secury_form_sec_apps_mob_navigate_form(var_app_name, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_secury_form_sec_apps_mob_navigate_form_cb);
  } // do_ajax_secury_form_sec_apps_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['secury_form_sec_apps_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_secury_form_sec_apps_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.app_name.value = scAjaxGetKeyValue("app_name");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_secury_form_sec_apps_mob_navigate_form_cb_after_alert);
  } // do_ajax_secury_form_sec_apps_mob_navigate_form_cb
  function do_ajax_secury_form_sec_apps_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_secury_form_sec_apps_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_secury_form_sec_apps_mob_navigate_form_cb_after_alert
  function sc_hide_secury_form_sec_apps_mob_form()
  {
  ...
  ajax_field_list[0] = "app_name";
  ajax_field_list[1] = "description";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "app_name": {"label": "<?php echo $this->Ini->Nm_lang['lang_sec_app_name'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["app_name"][1] = "app_name";
  ajax_field_mult["description"][1] = "description";

  var ajax_field_id = {
    "app_name": new Array("hidden_field_label_app_name", "hidden_field_data_app_name"),
