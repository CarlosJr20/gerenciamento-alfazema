...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_premium_imog"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_premium_imog"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_premium_imog'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_premium_imog']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_premium_imog']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_premium_imog']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_premium_imog']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_premium_imog']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_premium_imog']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_premium_imog']['embutida_filho'] as $ind => $sc_init)
          {
