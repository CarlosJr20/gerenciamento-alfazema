<?php
@session_start() ;
$_SESSION['scriptcase']['grid_premium_imog']['sc_process_barr'] = true;
require_once('../grid_premium_imog/index.php');
unset($_SESSION['scriptcase']['grid_premium_imog']['sc_process_barr']);
$ExportCtrl = new grid_premium_imog_export_control;
$ExportCtrl->Export_barr();

class grid_premium_imog_export_control
{
