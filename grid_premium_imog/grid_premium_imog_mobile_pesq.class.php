...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "valor";$Nm_numeric[] = "area";$Nm_numeric[] = "lote";$Nm_numeric[] = "ano";$Nm_numeric[] = "id";$Nm_numeric[] = "valor";$Nm_numeric[] = "area";$Nm_numeric[] = "lote";$Nm_numeric[] = "ano";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_img_cond" name="img_cond" onChange="nm_campos_between(document.getElementById('id_vis_img'), this, 'img')">
      ...
      <br><span id="id_hide_img"  <?php echo $str_hide_img?>><INPUT  type="text" id="SC_img" name="img" value="<?php echo NM_encode_input($img) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_titulo_cond" name="titulo_cond" onChange="nm_campos_between(document.getElementById('id_vis_titulo'), this, 'titulo')">
