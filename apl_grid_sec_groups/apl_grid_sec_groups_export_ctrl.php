<?php
@session_start() ;
$_SESSION['scriptcase']['apl_grid_sec_groups']['sc_process_barr'] = true;
require_once('../apl_grid_sec_groups/index.php');
unset($_SESSION['scriptcase']['apl_grid_sec_groups']['sc_process_barr']);
$ExportCtrl = new apl_grid_sec_groups_export_control;
$ExportCtrl->Export_barr();

class apl_grid_sec_groups_export_control
{
