  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_paciente_helder" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_paciente_helder_form();
	}
  ...
  // ---------- Validate nome
  function do_ajax_form_paciente_helder_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paciente_helder_validate_nome(var_nome, var_script_case_init, do_ajax_form_paciente_helder_validate_nome_cb);
  } // do_ajax_form_paciente_helder_validate_nome

  function do_ajax_form_paciente_helder_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paciente_helder_validate_nome_cb

  // ---------- Validate idade
  function do_ajax_form_paciente_helder_validate_idade()
  {
    var nomeCampo_idade = "idade";
    var var_idade = scAjaxGetFieldText(nomeCampo_idade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paciente_helder_validate_idade(var_idade, var_script_case_init, do_ajax_form_paciente_helder_validate_idade_cb);
  } // do_ajax_form_paciente_helder_validate_idade

  function do_ajax_form_paciente_helder_validate_idade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idade";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paciente_helder_validate_idade_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_paciente_helder_validate_sc_field_0()
  {
    ...
    setTimeout(function() {
      var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
      x_ajax_form_paciente_helder_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_paciente_helder_validate_sc_field_0_cb);
    }, 200);
  } // do_ajax_form_paciente_helder_validate_sc_field_0

  function do_ajax_form_paciente_helder_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paciente_helder_validate_sc_field_0_cb

  // ---------- Validate leito
  function do_ajax_form_paciente_helder_validate_leito()
  {
    var nomeCampo_leito = "leito";
    var var_leito = scAjaxGetFieldText(nomeCampo_leito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paciente_helder_validate_leito(var_leito, var_script_case_init, do_ajax_form_paciente_helder_validate_leito_cb);
  } // do_ajax_form_paciente_helder_validate_leito

  function do_ajax_form_paciente_helder_validate_leito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "leito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paciente_helder_validate_leito_cb

  // ---------- Validate registro
  function do_ajax_form_paciente_helder_validate_registro()
  {
    var nomeCampo_registro = "registro";
    var var_registro = scAjaxGetFieldText(nomeCampo_registro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paciente_helder_validate_registro(var_registro, var_script_case_init, do_ajax_form_paciente_helder_validate_registro_cb);
  } // do_ajax_form_paciente_helder_validate_registro

  function do_ajax_form_paciente_helder_validate_registro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paciente_helder_validate_registro_cb

  // ---------- Validate atendimento
  function do_ajax_form_paciente_helder_validate_atendimento()
  {
    var nomeCampo_atendimento = "atendimento";
    var var_atendimento = scAjaxGetFieldText(nomeCampo_atendimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paciente_helder_validate_atendimento(var_atendimento, var_script_case_init, do_ajax_form_paciente_helder_validate_atendimento_cb);
  } // do_ajax_form_paciente_helder_validate_atendimento

  function do_ajax_form_paciente_helder_validate_atendimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paciente_helder_validate_atendimento_cb

  // ---------- Validate data
  function do_ajax_form_paciente_helder_validate_data()
  {
    ...
    setTimeout(function() {
      var var_data = scAjaxGetFieldText(nomeCampo_data);
      x_ajax_form_paciente_helder_validate_data(var_data, var_script_case_init, do_ajax_form_paciente_helder_validate_data_cb);
    }, 200);
  } // do_ajax_form_paciente_helder_validate_data

  function do_ajax_form_paciente_helder_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paciente_helder_validate_data_cb

  // ---------- Validate hora
  function do_ajax_form_paciente_helder_validate_hora()
  {
    var nomeCampo_hora = "hora";
    var var_hora = scAjaxGetFieldText(nomeCampo_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_paciente_helder_validate_hora(var_hora, var_script_case_init, do_ajax_form_paciente_helder_validate_hora_cb);
  } // do_ajax_form_paciente_helder_validate_hora

  function do_ajax_form_paciente_helder_validate_hora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_paciente_helder_validate_hora_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_paciente_helder_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_paciente_helder_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_paciente_helder_submit_form(var_nome, var_idade, var_sc_field_0, var_leito, var_registro, var_atendimento, var_data, var_hora, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_paciente_helder_submit_form_cb);
  } // do_ajax_form_paciente_helder_submit_form

  function do_ajax_form_paciente_helder_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_paciente_helder_submit_form_cb_after_alert);
  } // do_ajax_form_paciente_helder_submit_form_cb
  function do_ajax_form_paciente_helder_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_paciente_helder_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_paciente_helder_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_paciente_helder_navigate_form, function() {});
    } else {
      perform_ajax_form_paciente_helder_navigate_form();
    }
  }

  function perform_ajax_form_paciente_helder_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_paciente_helder_navigate_form(var_id_paciente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_paciente_helder_navigate_form_cb);
  } // do_ajax_form_paciente_helder_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_paciente_helder']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_paciente_helder_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_paciente_helder_navigate_form_cb_after_alert);
  } // do_ajax_form_paciente_helder_navigate_form_cb
  function do_ajax_form_paciente_helder_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_paciente_helder_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_paciente_helder_navigate_form_cb_after_alert
  function sc_hide_form_paciente_helder_form()
  {
