...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_apl_form_add_users_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_apl_form_add_users_mob_submit_form(var_login, var_pswd, var_confirm_pswd, var_name, var_email, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_apl_form_add_users_mob_submit_form_cb);
