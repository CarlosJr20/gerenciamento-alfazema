<?php
@session_start() ;
$_SESSION['scriptcase']['grid_selecao_projeto_mp']['sc_process_barr'] = true;
require_once('../grid_selecao_projeto_mp/index.php');
unset($_SESSION['scriptcase']['grid_selecao_projeto_mp']['sc_process_barr']);
$ExportCtrl = new grid_selecao_projeto_mp_export_control;
$ExportCtrl->Export_barr();

class grid_selecao_projeto_mp_export_control
{
