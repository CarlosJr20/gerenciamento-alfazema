...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_selecao_projeto_mp"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_selecao_projeto_mp"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_selecao_projeto_mp'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_selecao_projeto_mp']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_selecao_projeto_mp']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_selecao_projeto_mp']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_selecao_projeto_mp']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_selecao_projeto_mp']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_selecao_projeto_mp</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_selecao_projeto_mp']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_selecao_projeto_mp']['embutida_filho'] as $ind => $sc_init)
          {
