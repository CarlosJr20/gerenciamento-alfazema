  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_selecao_projeto_mp_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_selecao_projeto_mp_mob_form();
	}
  ...
  // ---------- Validate selecao_cliente
  function do_ajax_form_selecao_projeto_mp_mob_validate_selecao_cliente()
  {
    var nomeCampo_selecao_cliente = "selecao_cliente";
    var var_selecao_cliente = scAjaxGetFieldSelect(nomeCampo_selecao_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_selecao_projeto_mp_mob_validate_selecao_cliente(var_selecao_cliente, var_script_case_init, do_ajax_form_selecao_projeto_mp_mob_validate_selecao_cliente_cb);
  } // do_ajax_form_selecao_projeto_mp_mob_validate_selecao_cliente

  function do_ajax_form_selecao_projeto_mp_mob_validate_selecao_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "selecao_cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_selecao_projeto_mp_mob_validate_selecao_cliente_cb

  // ---------- Validate nome_do_projeto
  function do_ajax_form_selecao_projeto_mp_mob_validate_nome_do_projeto()
  {
    var nomeCampo_nome_do_projeto = "nome_do_projeto";
    var var_nome_do_projeto = scAjaxGetFieldText(nomeCampo_nome_do_projeto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_selecao_projeto_mp_mob_validate_nome_do_projeto(var_nome_do_projeto, var_script_case_init, do_ajax_form_selecao_projeto_mp_mob_validate_nome_do_projeto_cb);
  } // do_ajax_form_selecao_projeto_mp_mob_validate_nome_do_projeto

  function do_ajax_form_selecao_projeto_mp_mob_validate_nome_do_projeto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome_do_projeto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_selecao_projeto_mp_mob_validate_nome_do_projeto_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_selecao_projeto_mp_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_selecao_projeto_mp_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_selecao_cliente = scAjaxGetFieldSelect("selecao_cliente");
    var var_nome_do_projeto = scAjaxGetFieldText("nome_do_projeto");
    var var_id_projeto = scAjaxGetFieldText("id_projeto");
    ...
    scAjaxProcOn();
    x_ajax_form_selecao_projeto_mp_mob_submit_form(var_selecao_cliente, var_nome_do_projeto, var_id_projeto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_selecao_projeto_mp_mob_submit_form_cb);
  } // do_ajax_form_selecao_projeto_mp_mob_submit_form

  function do_ajax_form_selecao_projeto_mp_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("selecao_cliente");
      scAjaxHideErrorDisplay("nome_do_projeto");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_selecao_projeto_mp_mob_submit_form_cb_after_alert);
  } // do_ajax_form_selecao_projeto_mp_mob_submit_form_cb
  function do_ajax_form_selecao_projeto_mp_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_selecao_projeto_mp_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_selecao_projeto_mp_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_selecao_projeto_mp_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_selecao_projeto_mp_mob_navigate_form();
    }
  }

  function perform_ajax_form_selecao_projeto_mp_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("selecao_cliente");
    scAjaxHideErrorDisplay("nome_do_projeto");
    var var_id_projeto = document.F2.id_projeto.value;
    ...
    scAjaxProcOn();
    x_ajax_form_selecao_projeto_mp_mob_navigate_form(var_id_projeto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_selecao_projeto_mp_mob_navigate_form_cb);
  } // do_ajax_form_selecao_projeto_mp_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_selecao_projeto_mp_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_selecao_projeto_mp_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_projeto.value = scAjaxGetKeyValue("id_projeto");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_selecao_projeto_mp_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_selecao_projeto_mp_mob_navigate_form_cb
  function do_ajax_form_selecao_projeto_mp_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_selecao_projeto_mp_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_selecao_projeto_mp_mob_navigate_form_cb_after_alert
  function sc_hide_form_selecao_projeto_mp_mob_form()
  {
  ...
  ajax_field_list[0] = "selecao_cliente";
  ajax_field_list[1] = "nome_do_projeto";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "selecao_cliente": {"label": "Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nome_do_projeto": {"label": "Nome Do Projeto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "selecao_cliente": new Array(),
    "nome_do_projeto": new Array()
  };
  ajax_field_mult["selecao_cliente"][1] = "selecao_cliente";
  ajax_field_mult["nome_do_projeto"][1] = "nome_do_projeto";

  var ajax_field_id = {
    "selecao_cliente": new Array("hidden_field_label_selecao_cliente", "hidden_field_data_selecao_cliente"),
    "nome_do_projeto": new Array("hidden_field_label_nome_do_projeto", "hidden_field_data_nome_do_projeto")
  };
