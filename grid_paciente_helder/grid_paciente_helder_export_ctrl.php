<?php
@session_start() ;
$_SESSION['scriptcase']['grid_paciente_helder']['sc_process_barr'] = true;
require_once('../grid_paciente_helder/index.php');
unset($_SESSION['scriptcase']['grid_paciente_helder']['sc_process_barr']);
$ExportCtrl = new grid_paciente_helder_export_control;
$ExportCtrl->Export_barr();

class grid_paciente_helder_export_control
{
