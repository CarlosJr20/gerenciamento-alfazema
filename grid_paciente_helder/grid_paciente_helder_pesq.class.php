...
class grid_paciente_helder_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_paciente_helder_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_paciente_helder_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_paciente_helder_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "`Data de Nascimento`";$Nm_datas[] = "`Data de Nascimento`";$Nm_datas[] = "Data";$Nm_datas[] = "Data";$Nm_datas[] = "Hora";$Nm_datas[] = "Hora";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_paciente_helder/grid_paciente_helder_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_paciente_helder_ajax_search.js"></script>
 <script type="text/javascript" src="grid_paciente_helder_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_paciente_helder_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_paciente_helder']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_paciente_helder']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_paciente_cond#NMF#' + search_get_sel_txt('SC_id_paciente_cond') + '@NMF@';
  str_out += 'SC_id_paciente#NMF#' + search_get_text('SC_id_paciente') + '@NMF@';
  ...
  str_out += 'SC_idade_cond#NMF#' + search_get_sel_txt('SC_idade_cond') + '@NMF@';
  str_out += 'SC_idade#NMF#' + search_get_text('SC_idade') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Consulta Paciente</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $hora_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_hor']; 
          $hora_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_min']; 
          $hora_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_seg']; 
          $hora_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_cond']; 
          $id_paciente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['id_paciente']; 
          $id_paciente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['id_paciente_cond']; 
          $nome = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['nome']; 
          $nome_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['nome_cond']; 
          $idade = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['idade']; 
          $idade_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['idade_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['NM_operador']; 
          if (strtoupper($id_paciente_cond) != "II" && strtoupper($id_paciente_cond) != "QP" && strtoupper($id_paciente_cond) != "NP" && strtoupper($id_paciente_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_paciente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idade_cond) != "II" && strtoupper($idade_cond) != "QP" && strtoupper($idade_cond) != "NP" && strtoupper($idade_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idade, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_paciente_cond) || empty($id_paciente_cond))
      {
         $id_paciente_cond = "gt";
      }
      ...
      if (!isset($idade_cond) || empty($idade_cond))
      {
         $idade_cond = "gt";
      }
      ...
      $str_hide_id_paciente = (in_array($id_paciente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nome = (in_array($nome_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idade = (in_array($idade_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($id_paciente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_paciente = substr($id_paciente, 0, $tmp_pos);
         }
      }
      if (!isset($nome) || $nome == "")
      {
      ...
      if (!isset($idade) || $idade == "")
      {
          $idade = "";
      }
      if (isset($idade) && !empty($idade))
      {
         $tmp_pos = strpos($idade, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idade = substr($idade, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_id_paciente_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_paciente'])) ? $this->New_label['id_paciente'] : "Id Paciente"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_paciente_cond" name="id_paciente_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_paciente'), this, 'id_paciente')">
       <OPTION value="gt" <?php if ("gt" == $id_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_paciente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_paciente" <?php echo $str_hide_id_paciente?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_paciente'])) ? $this->New_label['id_paciente'] : "Id Paciente";
 $nmgp_tab_label .= "id_paciente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_paciente" name="id_paciente" value="<?php echo NM_encode_input($id_paciente) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nome" name="nome_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idade_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idade'])) ? $this->New_label['idade'] : "Idade"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idade_cond" name="idade_cond" onChange="nm_campos_between(document.getElementById('id_vis_idade'), this, 'idade')">
       <OPTION value="gt" <?php if ("gt" == $idade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idade_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idade" <?php echo $str_hide_idade?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idade'])) ? $this->New_label['idade'] : "Idade";
 $nmgp_tab_label .= "idade?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idade" name="idade" value="<?php echo NM_encode_input($idade) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_paciente_helder_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_paciente_helder']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_paciente_helder']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_paciente_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_paciente'), document.F1.id_paciente_cond, 'id_paciente');
   document.F1.id_paciente.value = "";
   ...
   document.F1.idade_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idade'), document.F1.idade_cond, 'idade');
   document.F1.idade.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_hora_hor').bind('change', function() {sc_grid_paciente_helder_valida_hora(this)});
    $('#SC_hora_min').bind('change', function() {sc_grid_paciente_helder_valida_min(this)});
    $('#SC_hora_seg').bind('change', function() {sc_grid_paciente_helder_valida_seg(this)});
 }
 function sc_grid_paciente_helder_valida_hora(obj)
 {
 ...
 function sc_grid_paciente_helder_valida_min(obj)
 {
 ...
 function sc_grid_paciente_helder_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_paciente_cond'] = 'cond';
      $tp_fields['SC_id_paciente'] = 'text';
      $tp_fields['SC_nome_cond'] = 'cond';
      $tp_fields['SC_nome'] = 'text_aut';
      $tp_fields['id_ac_nome'] = 'text_aut';
      $tp_fields['SC_idade_cond'] = 'cond';
      $tp_fields['SC_idade'] = 'text';
   ...
   function trata_campos()
   {
      global $hora_cond, $hora, $hora_hor, $hora_min, $hora_seg,
             $id_paciente_cond, $id_paciente,
             $nome_cond, $nome, $nome_autocomp,
             $idade_cond, $idade, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq'] = array();
      if (!empty($nome_autocomp) && empty($nome))
      {
          $nome = $nome_autocomp;
      }
      $hora_cond_salva = $hora_cond; 
      $id_paciente_cond_salva = $id_paciente_cond; 
      if (!isset($id_paciente_input_2) || $id_paciente_input_2 == "")
      {
          $id_paciente_input_2 = $id_paciente;
      }
      ...
      $idade_cond_salva = $idade_cond; 
      if (!isset($idade_input_2) || $idade_input_2 == "")
      {
          $idade_input_2 = $idade;
      }
      if ($id_paciente_cond != "in")
      {
          nm_limpa_numero($id_paciente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idade_cond != "in")
      {
          nm_limpa_numero($idade, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_hor'] = $hora_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_min'] = $hora_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_seg'] = $hora_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $hora_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $hora_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $hora_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_cond'] = $hora_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['cmp'] = "hora"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['opc'] = $hora_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq']['hora'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['id_paciente'] = $id_paciente; 
      if (is_array($id_paciente) && !empty($id_paciente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0] = $id_paciente;
      }
      elseif ($id_paciente_cond_salva == "nu" || $id_paciente_cond_salva == "nn" || $id_paciente_cond_salva == "ep" || $id_paciente_cond_salva == "ne" || !empty($id_paciente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0][0] = $id_paciente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['id_paciente_cond'] = $id_paciente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['cmp'] = "id_paciente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['opc'] = $id_paciente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq']['id_paciente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['nome'] = $nome; 
      if (is_array($nome) && !empty($nome))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0] = $nome;
      }
      elseif ($nome_cond_salva == "nu" || $nome_cond_salva == "nn" || $nome_cond_salva == "ep" || $nome_cond_salva == "ne" || !empty($nome))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0][0] = $nome;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['nome_cond'] = $nome_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['cmp'] = "nome"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['opc'] = $nome_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq']['nome'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['idade'] = $idade; 
      if (is_array($idade) && !empty($idade))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0] = $idade;
      }
      elseif ($idade_cond_salva == "nu" || $idade_cond_salva == "nn" || $idade_cond_salva == "ep" || $idade_cond_salva == "ne" || !empty($idade))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['val'][0][0] = $idade;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['idade_cond'] = $idade_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['cmp'] = "idade"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid]['opc'] = $idade_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq']['idade'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $id_paciente;
      if (strtoupper($id_paciente_cond) != "II" && strtoupper($id_paciente_cond) != "QP" && strtoupper($id_paciente_cond) != "NP" && strtoupper($id_paciente_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['id_paciente'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nome != '') {
      $nome_look = substr($this->Db->qstr($nome), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      $this->cmp_formatado['idade'] = $Conteudo;
      ...
      if ($hora_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora'] = $val[0];
          ...
          if ($hora_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']['hora_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq']['hora']['label'] = $nmgp_tab_label['hora'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq']['hora']['descr'] = $nmgp_tab_label['hora'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['grid_pesq']['hora']['hint']  = $nmgp_tab_label['hora'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $id_paciente
      $this->Date_part = false;
      if (isset($id_paciente) || $id_paciente_cond == "nu" || $id_paciente_cond == "nn" || $id_paciente_cond == "ep" || $id_paciente_cond == "ne")
      {
         $this->monta_condicao("id_paciente", $id_paciente_cond, $id_paciente, "", "id_paciente");
      }
      ...
      //----- $idade
      $this->Date_part = false;
      if (isset($idade) || $idade_cond == "nu" || $idade_cond == "nn" || $idade_cond == "ep" || $idade_cond == "ne")
      {
         $this->monta_condicao("Idade", $idade_cond, $idade, "", "idade");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_paciente_helder']['cond_pesq'] .= $this->NM_operador;
