...
<?php
   ...
   $Ord_Cmp = new grid_paciente_helder_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_paciente_helder_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["nome"] : "Nome";
   $tab_ger_campos['idade'] = "on";
   $tab_def_campos['idade'] = "Idade";
   $tab_labels["idade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["idade"])) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["idade"] : "Idade";
   ...
   {
       $tab_def_campos['sc_field_0'] = "`Data de Nascimento`";
   }
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["sc_field_0"] : "Data De Nascimento";
   $tab_ger_campos['leito'] = "on";
   $tab_def_campos['leito'] = "Leito";
   $tab_labels["leito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["leito"])) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["leito"] : "Leito";
   $tab_ger_campos['registro'] = "on";
   $tab_def_campos['registro'] = "Registro";
   $tab_labels["registro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["registro"])) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["registro"] : "Registro";
   $tab_ger_campos['atendimento'] = "on";
   $tab_def_campos['atendimento'] = "Atendimento";
   $tab_labels["atendimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["atendimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["atendimento"] : "Atendimento";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "Data";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["data"] : "Data";
   $tab_ger_campos['hora'] = "on";
   $tab_def_campos['hora'] = "Hora";
   $tab_labels["hora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["hora"])) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['labels']["hora"] : "Hora";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_paciente_helder_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_paciente_helder']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
