...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "`Data de Nascimento`";$Nm_datas[] = "`Data de Nascimento`";$Nm_datas[] = "Data";$Nm_datas[] = "Data";$Nm_datas[] = "Hora";$Nm_datas[] = "Hora";$Nm_numeric[] = "id_paciente";$Nm_numeric[] = "idade";$Nm_numeric[] = "leito";$Nm_numeric[] = "registro";$Nm_numeric[] = "atendimento";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_paciente_cond" name="id_paciente_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_paciente'), this, 'id_paciente')">
      ...
      <br><span id="id_hide_id_paciente"  <?php echo $str_hide_id_paciente?>><INPUT  type="text" id="SC_id_paciente" name="id_paciente" value="<?php echo NM_encode_input($id_paciente) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idade_cond" name="idade_cond" onChange="nm_campos_between(document.getElementById('id_vis_idade'), this, 'idade')">
      ...
      <br><span id="id_hide_idade"  <?php echo $str_hide_idade?>><INPUT  type="text" id="SC_idade" name="idade" value="<?php echo NM_encode_input($idade) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
