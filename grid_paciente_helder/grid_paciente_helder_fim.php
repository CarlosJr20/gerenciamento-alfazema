...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_paciente_helder"]))
   {
      unset($_SESSION['session_sec_aplicacao']["gestao_focus_pronto_____grid_paciente_helder"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_paciente_helder'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_paciente_helder']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_paciente_helder']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_paciente_helder']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_paciente_helder']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_paciente_helder']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_paciente_helder</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_paciente_helder']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_paciente_helder']['embutida_filho'] as $ind => $sc_init)
          {
