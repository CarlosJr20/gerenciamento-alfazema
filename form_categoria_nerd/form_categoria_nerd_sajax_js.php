  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_categoria_nerd" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_categoria_nerd_form();
	}
  ...
  // ---------- Validate id_categoria_
  function do_ajax_form_categoria_nerd_validate_id_categoria_(iNumLinha)
  {
    var nomeCampo_id_categoria_ = "id_categoria_" + iNumLinha;
    var var_id_categoria_ = scAjaxGetFieldHidden(nomeCampo_id_categoria_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_nerd_validate_id_categoria_(var_id_categoria_, iNumLinha, var_script_case_init, do_ajax_form_categoria_nerd_validate_id_categoria__cb);
  } // do_ajax_form_categoria_nerd_validate_id_categoria_

  function do_ajax_form_categoria_nerd_validate_id_categoria__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_categoria_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_categoria_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_categoria_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_categoria_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_nerd_validate_id_categoria__cb

  // ---------- Validate id_tabela_
  function do_ajax_form_categoria_nerd_validate_id_tabela_(iNumLinha)
  {
    var nomeCampo_id_tabela_ = "id_tabela_" + iNumLinha;
    var var_id_tabela_ = scAjaxGetFieldCheckbox(nomeCampo_id_tabela_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_nerd_validate_id_tabela_(var_id_tabela_, iNumLinha, var_script_case_init, do_ajax_form_categoria_nerd_validate_id_tabela__cb);
  } // do_ajax_form_categoria_nerd_validate_id_tabela_

  function do_ajax_form_categoria_nerd_validate_id_tabela__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_tabela_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_tabela_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_tabela_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_tabela_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_nerd_validate_id_tabela__cb

  // ---------- Validate cateogira_
  function do_ajax_form_categoria_nerd_validate_cateogira_(iNumLinha)
  {
    var nomeCampo_cateogira_ = "cateogira_" + iNumLinha;
    var var_cateogira_ = scAjaxGetFieldText(nomeCampo_cateogira_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_nerd_validate_cateogira_(var_cateogira_, iNumLinha, var_script_case_init, do_ajax_form_categoria_nerd_validate_cateogira__cb);
  } // do_ajax_form_categoria_nerd_validate_cateogira_

  function do_ajax_form_categoria_nerd_validate_cateogira__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cateogira_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cateogira_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cateogira_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cateogira_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categoria_nerd_validate_cateogira__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_categoria_nerd_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_categoria_nerd_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_categoria_nerd_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_categoria_nerd_add_new_line_cb);
  } // do_ajax_form_categoria_nerd_add_new_line

  function do_ajax_form_categoria_nerd_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_categoria_nerd_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_categoria_nerd_backup_line(iNumLinha)
  {
    var var_id_categoria_ = scAjaxGetFieldHidden("id_categoria_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categoria_nerd_backup_line(var_id_categoria_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_categoria_nerd_backup_line_cb);
  } // do_ajax_form_categoria_nerd_backup_line

  function do_ajax_form_categoria_nerd_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_categoria_nerd_backup_line_cb

  function do_ajax_form_categoria_nerd_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_categoria_nerd_cancel_insert

  function do_ajax_form_categoria_nerd_cancel_update(iSeqVert)
  {
    do_ajax_form_categoria_nerd_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_categoria_nerd_cancel_update

  function do_ajax_form_categoria_nerd_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_categoria_nerd_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_categoria_nerd_table_refresh()
  {
    var var_id_categoria_ = document.F2.id_categoria_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_categoria_nerd_table_refresh(var_id_categoria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categoria_nerd_table_refresh_cb);
  } //  do_ajax_form_categoria_nerd_table_refresh

  function do_ajax_form_categoria_nerd_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_categoria_.value = scAjaxGetKeyValue("id_categoria_");
    ...
    scAjaxAlert(do_ajax_form_categoria_nerd_table_refresh_cb_after_alert);
  } // do_ajax_form_categoria_nerd_table_refresh_cb
  function do_ajax_form_categoria_nerd_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_categoria_nerd_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_categoria_nerd_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_categoria_nerd_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_categoria_ = scAjaxGetFieldHidden("id_categoria_" + iNumLinha);
    var var_id_tabela_ = scAjaxGetFieldCheckbox("id_tabela_" + iNumLinha, ";");
    var var_cateogira_ = scAjaxGetFieldText("cateogira_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_categoria_nerd_submit_form(var_id_categoria_, var_id_tabela_, var_cateogira_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categoria_nerd_submit_form_cb);
  } // do_ajax_form_categoria_nerd_submit_form

  function do_ajax_form_categoria_nerd_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_categoria_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_tabela_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cateogira_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_categoria_nerd_submit_form_cb_after_alert);
  } // do_ajax_form_categoria_nerd_submit_form_cb
  function do_ajax_form_categoria_nerd_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_categoria_nerd_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_categoria_nerd_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_categoria_nerd_navigate_form, function() {});
    } else {
      perform_ajax_form_categoria_nerd_navigate_form();
    }
  }

  function perform_ajax_form_categoria_nerd_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_categoria_nerd_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_categoria_" + iNavForm);
      scAjaxHideErrorDisplay("id_tabela_" + iNavForm);
      scAjaxHideErrorDisplay("cateogira_" + iNavForm);
    }
    var var_id_categoria_ = document.F2.id_categoria_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_categoria_nerd_navigate_form(var_id_categoria_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categoria_nerd_navigate_form_cb);
  } // do_ajax_form_categoria_nerd_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_categoria_nerd']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_categoria_nerd_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_categoria_.value = scAjaxGetKeyValue("id_categoria_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_categoria_nerd_navigate_form_cb_after_alert);
  } // do_ajax_form_categoria_nerd_navigate_form_cb
  function do_ajax_form_categoria_nerd_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_categoria_nerd_navigate_form_cb_after_alert
  function sc_hide_form_categoria_nerd_form()
  {
  ...
  function do_ajax_form_categoria_nerd_lkpedt_refresh_id_tabela_(iSeq)
  {
    var var_id_tabela_ = scAjaxGetFieldCheckbox("id_tabela_");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_row = iSeq;
    var nmgp_refresh_fields = "id_tabela_";
    x_ajax_form_categoria_nerd_lkpedt_refresh_id_tabela_(var_id_tabela_, nmgp_refresh_row, nmgp_refresh_fields, var_script_case_init, do_ajax_form_categoria_nerd_lkpedt_refresh_id_tabela__cb);
  } // do_ajax_form_categoria_nerd_lkpedt_refresh_id_tabela_

  function do_ajax_form_categoria_nerd_lkpedt_refresh_id_tabela__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_categoria_nerd_lkpedt_refresh_id_tabela__cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_categoria_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_tabela_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cateogira_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_categoria_" + iNumLinha] = {"label": "Id Categoria<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_tabela_" + iNumLinha] = {"label": "Tabela<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cateogira_" + iNumLinha] = {"label": "Cateogira<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_categoria_"][iNumLinha] = "id_categoria_" + iNumLinha;
    ajax_field_mult["id_tabela_"][iNumLinha] = "id_tabela_" + iNumLinha;
    ajax_field_mult["cateogira_"][iNumLinha] = "cateogira_" + iNumLinha;
    ajax_field_id["id_categoria_" + iNumLinha] = new Array("hidden_field_label_id_categoria_", "hidden_field_data_id_categoria_" + iNumLinha);
    ajax_field_id["id_tabela_" + iNumLinha] = new Array("hidden_field_label_id_tabela_", "hidden_field_data_id_tabela_" + iNumLinha);
    ajax_field_id["cateogira_" + iNumLinha] = new Array("hidden_field_label_cateogira_", "hidden_field_data_cateogira_" + iNumLinha);
    ajax_error_count["id_categoria_" + iNumLinha] = "off";
    ajax_error_count["id_tabela_" + iNumLinha] = "off";
    ajax_error_count["cateogira_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_categoria_" + iNumLinha] = "on";
    ajax_read_only["id_tabela_" + iNumLinha] = "off";
    ajax_read_only["cateogira_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_categoria_" + iNumLinha] = "on";
    ajax_read_only["id_tabela_" + iNumLinha] = "on";
    ajax_read_only["cateogira_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_categoria_" + iNumLinha] = null;
    ajax_error_list["id_tabela_" + iNumLinha] = null;
    ajax_error_list["cateogira_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_categoria_": new Array(),
    "id_tabela_": new Array(),
    "cateogira_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_categoria_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_categoria_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_categoria_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_categoria_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_categoria_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_tabela_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_tabela_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_tabela_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_tabela_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_tabela_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cateogira_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cateogira_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cateogira_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cateogira_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cateogira_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_categoria_'])) ? $this->nmgp_cmp_readonly['id_categoria_'] : 'on';
?>
    scAjaxFieldRead("id_categoria_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_tabela_'])) ? $this->nmgp_cmp_readonly['id_tabela_'] : 'off';
?>
    scAjaxFieldRead("id_tabela_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cateogira_'])) ? $this->nmgp_cmp_readonly['cateogira_'] : 'off';
?>
    scAjaxFieldRead("cateogira_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_categoria_" + iSeq, "on");
    scAjaxFieldRead("id_tabela_" + iSeq, "on");
    scAjaxFieldRead("cateogira_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_categoria_" + iRow] || "on" == ajax_error_count["id_tabela_" + iRow] || "on" == ajax_error_count["cateogira_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_categoria_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_tabela_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cateogira_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_categoria_" + iRow] && "off" == ajax_error_count["id_tabela_" + iRow] && "off" == ajax_error_count["cateogira_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_categoria_" + iRow] = "off";
        ajax_error_count["id_tabela_" + iRow] = "off";
        ajax_error_count["cateogira_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_categoria_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_tabela_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cateogira_" + iRow).removeClass("scFormErrorLine");
    }
  }
