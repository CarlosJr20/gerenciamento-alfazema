<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_categoria_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_categoria_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_categoria_nerd"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_categoria_nerd']['where_detal']))
  {
?>  
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_categoria_nerd_submit_form(y, z);
