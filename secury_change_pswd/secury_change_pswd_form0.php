...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("secury_change_pswd_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('secury_change_pswd_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("secury_change_pswd_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['secury_change_pswd'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['secury_change_pswd'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['where_filter']))
       {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_pswd_label" id="hidden_field_label_pswd" style="<?php echo $sStyleHidden_pswd; ?>"><span id="id_label_pswd"><?php echo $this->nm_new_label['pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['php_cmp_required']['pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['php_cmp_required']['pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_confirm_pswd_label" id="hidden_field_label_confirm_pswd" style="<?php echo $sStyleHidden_confirm_pswd; ?>"><span id="id_label_confirm_pswd"><?php echo $this->nm_new_label['confirm_pswd']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['php_cmp_required']['confirm_pswd']) || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['php_cmp_required']['confirm_pswd'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php
           if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['nm_run_menu'] != 1))) {
...
<?php
           if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("secury_change_pswd");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("secury_change_pswd");
 parent.scAjaxDetailHeight("secury_change_pswd", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['secury_change_pswd']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
