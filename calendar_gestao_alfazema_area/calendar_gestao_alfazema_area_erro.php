...
$old_error_handler = set_error_handler("calendar_gestao_alfazema_area_scriptcase_error_handler");

function calendar_gestao_alfazema_area_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['calendar_gestao_alfazema_area']['contr_erro']) && $_SESSION['scriptcase']['calendar_gestao_alfazema_area']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_calendar_gestao_alfazema_area->contr_calendar_gestao_alfazema_area->Apl_com_erro = true;
            if ($inicial_calendar_gestao_alfazema_area->contr_calendar_gestao_alfazema_area->NM_ajax_flag)
            {
                $inicial_calendar_gestao_alfazema_area->contr_calendar_gestao_alfazema_area->NM_ajax_info['errList']['geral_calendar_gestao_alfazema_area'][] = $msg;
                return;
            }
            calendar_gestao_alfazema_area_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function calendar_gestao_alfazema_area_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['calendar_gestao_alfazema_area'])  && '' != $_SESSION['scriptcase']['error_icon']['calendar_gestao_alfazema_area'])  ? $_SESSION['scriptcase']['error_icon']['calendar_gestao_alfazema_area']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['calendar_gestao_alfazema_area']) && '' != $_SESSION['scriptcase']['error_span_title']['calendar_gestao_alfazema_area']) ? $_SESSION['scriptcase']['error_span_title']['calendar_gestao_alfazema_area'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['calendar_gestao_alfazema_area']) && '' != $_SESSION['scriptcase']['error_icon_title']['calendar_gestao_alfazema_area']) ? $_SESSION['scriptcase']['error_icon_title']['calendar_gestao_alfazema_area'] : '';
?>
