<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="id_gestao" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_gestao']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="calendar_gestao_alfazema_area_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc___calend_all_day___onclick()
{
