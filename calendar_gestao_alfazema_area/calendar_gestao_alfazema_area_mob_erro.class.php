...
class calendar_gestao_alfazema_area_mob_erro
{
   var $Ini;
   ...
   function mensagem($script, $linha, $tipo, $mensagem, $complemento = "", $exibe = true)
   {
      ...
      $this->monta_mensagem();
      return calendar_gestao_alfazema_area_mob_scriptcase_error_handler(E_USER_ERROR, $this->msg_final, $script, $linha, $exibe);
   }
