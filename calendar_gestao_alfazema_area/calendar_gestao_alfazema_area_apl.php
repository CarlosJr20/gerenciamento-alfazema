<?php
//
class calendar_gestao_alfazema_area_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_priv_admin)) 
          {
              $_SESSION['usr_priv_admin'] = $this->usr_priv_admin;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new calendar_gestao_alfazema_area_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['initialize'])
          {
              if ('calendar' != $this->nmgp_opcao) {
                  $_SESSION['scriptcase']['calendar_gestao_alfazema_area']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['calendar_gestao_alfazema_area']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['calendar_gestao_alfazema_area']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_gestao_alfazema_area']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['calendar_gestao_alfazema_area'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_gestao_alfazema_area']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_gestao_alfazema_area']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('calendar_gestao_alfazema_area') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['calendar_gestao_alfazema_area']['label'] = "REGISTRO DE EVENTO";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "calendar_gestao_alfazema_area")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['calendar_gestao_alfazema_area']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['calendar_gestao_alfazema_area'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['calendar_gestao_alfazema_area']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_gestao_alfazema_area'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['calendar_gestao_alfazema_area'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("calendar_gestao_alfazema_area", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'calendar_gestao_alfazema_area_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'calendar_gestao_alfazema_area_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'calendar_gestao_alfazema_area/calendar_gestao_alfazema_area_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "calendar_gestao_alfazema_area_erro.class.php"); 
      }
      $this->Erro      = new calendar_gestao_alfazema_area_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['calendar_gestao_alfazema_area']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['calendar_gestao_alfazema_area']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "calendar_gestao_alfazema_area.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="calendar_gestao_alfazema_area_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="calendar_gestao_alfazema_area"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_calendar_gestao_alfazema_area']) || !is_array($this->NM_ajax_info['errList']['geral_calendar_gestao_alfazema_area']))
              {
                  $this->NM_ajax_info['errList']['geral_calendar_gestao_alfazema_area'] = array();
              }
              $this->NM_ajax_info['errList']['geral_calendar_gestao_alfazema_area'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if (isset($this->__calend_all_day__) && 'Y' == $this->__calend_all_day__)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['bypass_required_time']['horario_inic'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['bypass_required_time']['horario_fim'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['bypass_required_time']['horario_inic'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['bypass_required_time']['horario_fim'] = false;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_calendar_gestao_alfazema_area';
...
$_SESSION['scriptcase']['calendar_gestao_alfazema_area']['contr_erro'] = 'off'; 
    ...
    function ValidateField_tipoarea(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['tipoarea']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['tipoarea'] == "on")
        { 
          $hasError = true;
      ...
      if ($this->tipoarea != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_tipoarea']) && !in_array($this->tipoarea, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_tipoarea']))
          {
              $hasError = true;
    ...
    function ValidateField_nome(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['nome'] == "on")) 
      { 
          if ($this->nome == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_sobrenome(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['sobrenome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['sobrenome'] == "on")) 
      { 
          if ($this->sobrenome == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_email(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['email']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['email'] == "on") 
          { 
              $hasError = true;
              $Campos_Falta[] = "Email" ; 
              if (!isset($Campos_Erros['email']))
    ...
    function ValidateField_fone(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->fone, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Fone; " ; 
                  if (!isset($Campos_Erros['fone']))
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['fone']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['fone'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Fone" ; 
              if (!isset($Campos_Erros['fone']))
    ...
    function ValidateField_aptnum(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->aptnum, 4, 0, 1, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['aptnum']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['aptnum'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_aptbloco(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['aptbloco']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['aptbloco'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Bloco" ; 
      ...
      if ($this->aptbloco != "")
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_aptbloco']) && !in_array($this->aptbloco, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_aptbloco']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['aptbloco']))
    ...
    function ValidateField_qtdpessoas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->qtdpessoas, 8, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['qtdpessoas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['qtdpessoas'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_horario_inic(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['horario_inic']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['horario_inic'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['bypass_required_time']['horario_inic']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['bypass_required_time']['horario_inic'])
              {
              $hasError = true;
    ...
    function ValidateField_horario_fim(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      {
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['horario_fim']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['php_cmp_required']['horario_fim'] == "on") 
           { 
              if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['bypass_required_time']['horario_fim']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['bypass_required_time']['horario_fim'])
              {
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id_gestao']['keyVal'] = calendar_gestao_alfazema_area_pack_protect_string($this->nmgp_dados_form['id_gestao']);
          }
   } // ajax_return_values
...
$aLookup[] = array(calendar_gestao_alfazema_area_pack_protect_string('Área Gourmet') => str_replace('<', '&lt;',calendar_gestao_alfazema_area_pack_protect_string("Área Gourmet")));
$aLookup[] = array(calendar_gestao_alfazema_area_pack_protect_string('Área de Festas') => str_replace('<', '&lt;',calendar_gestao_alfazema_area_pack_protect_string("Área de Festas")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_tipoarea'][] = 'Área Gourmet';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_tipoarea'][] = 'Área de Festas';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['tipoarea']['valList'][$i] = calendar_gestao_alfazema_area_pack_protect_string($v);
          }
...
$aLookup[] = array(calendar_gestao_alfazema_area_pack_protect_string('A') => str_replace('<', '&lt;',calendar_gestao_alfazema_area_pack_protect_string("A")));
$aLookup[] = array(calendar_gestao_alfazema_area_pack_protect_string('B') => str_replace('<', '&lt;',calendar_gestao_alfazema_area_pack_protect_string("B")));
$aLookup[] = array(calendar_gestao_alfazema_area_pack_protect_string('C') => str_replace('<', '&lt;',calendar_gestao_alfazema_area_pack_protect_string("C")));
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_aptbloco'][] = 'A';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_aptbloco'][] = 'B';
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['Lookup_aptbloco'][] = 'C';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['aptbloco']['valList'][$i] = calendar_gestao_alfazema_area_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_data($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->id_gestao)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opcao'] = '';
...
$_SESSION['scriptcase']['calendar_gestao_alfazema_area']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          {
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
...
$_SESSION['scriptcase']['calendar_gestao_alfazema_area']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['parms'] = "id_gestao?#?$this->id_gestao?@?"; 
      }
      $this->NM_commit_db(); 
      if (isset($this->google_calendar_insert) && $this->google_calendar_insert)
      {
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
    ...
    include_once("calendar_gestao_alfazema_area_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['table_refresh'])
        {
   ...
   function calendarOutputDisplay()
   {
       ...
       $appReturn = '';
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['iframe_menu'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_outra_jan']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['sc_outra_jan'] != 'calendar_gestao_alfazema_area')) {
           global $nm_url_saida, $nm_apl_dependente;
           if ((!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] == "R" || $this->aba_iframe) && ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['run_iframe'] != "F") && ($nm_apl_dependente == 1)) {
...
{
    $.ajax({
        url: "calendar_gestao_alfazema_area.php",
        type: "GET",
        dataType: "json",
        data: {
...
{
    $('#calendar').fullCalendar('removeEventSource', 'calendar_gestao_alfazema_area.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
    setCategory();
    $('#calendar').fullCalendar('addEventSource', 'calendar_gestao_alfazema_area.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false));
}
...
{
    tb_show('', 'calendar_gestao_alfazema_area.php?nmgp_opcao=edit_novo&sc_cal_click_date=' + sDate + '&sc_cal_click_time=' + sTime + '&sc_cal_click_allday=' + allDay + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
function editEvent_desktop(sEventId)
{
    tb_show('', 'calendar_gestao_alfazema_area.php?nmgp_opcao=igual_calendar&id_gestao=' + sEventId + '&__orig_id_gestao=' + sEventId + '&script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_outra_jan=true&nmgp_url_saida=modal&TB_iframe=true&modal=true&height=500&width=700', '');
}
<?php
...
?>
        events: 'calendar_gestao_alfazema_area.php?script_case_init=<?php echo $this->Ini->sc_page ?>&nmgp_opcao=calendar_fetch' + getCategory(false),
...
?>
        ...
        eventResize: function(event, delta, revertFunc) {
            $.post(
                'calendar_gestao_alfazema_area.php',
                {
                    'script_case_init': '<?php echo $this->Ini->sc_page ?>',
...
<?php
   ...
   function calendarInitTimestamp()
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_calendar_gestao_alfazema_area = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['total'] = $qt_geral_reg_calendar_gestao_alfazema_area;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          calendar_gestao_alfazema_area_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "calendar_gestao_alfazema_area_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['nm_run_menu'] = 2;
       $nmgp_saida_form = "calendar_gestao_alfazema_area_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['masterValue']))
{
...
<?php
  exit;
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "help":
                ...
                break;
            case "exit":
                return array("sc_b_sai_t.sc-unique-btn-1", "sc_b_sai_t.sc-unique-btn-3", "sc_b_sai_b.sc-unique-btn-9", "sc_b_sai_b.sc-unique-btn-11", "sc_b_sai_t.sc-unique-btn-2", "sc_b_sai_b.sc-unique-btn-10");
                break;
            case "new":
                return array("sc_b_new_b.sc-unique-btn-4");
                break;
            case "insert":
                return array("sc_b_ins_b.sc-unique-btn-5");
                break;
            case "update":
                return array("sc_b_upd_b.sc-unique-btn-6");
                break;
            case "delete":
                return array("sc_b_del_b.sc-unique-btn-7");
                break;
            case "0":
                return array("sys_separator.sc-unique-btn-8");
                break;
        }
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['ordem_ord'] == " desc") {
