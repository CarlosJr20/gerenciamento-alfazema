...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_tipoarea'][] = 'Área Gourmet'; ?>
<?php  if ("Área Gourmet" == $this->tipoarea)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">Área Gourmet</label></TD>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_tipoarea'][] = 'Área de Festas'; ?>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_aptbloco'][] = 'A'; ?>
<?php  if ("A" == $this->aptbloco)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">A</label></TD>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_aptbloco'][] = 'B'; ?>
<?php  if ("B" == $this->aptbloco)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">B</label></TD>
 ...
 alt="{type: 'radio', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_aptbloco'][] = 'C'; ?>
...
<span id="id_read_on___calend_all_day__" class="css___calend_all_day___line" style="<?php echo $sStyleReadLab___calend_all_day__; ?>"><?php echo $this->form_format_readonly("__calend_all_day__", $this->form_encode_input($__calend_all_day___look)); ?></span><span id="id_read_off___calend_all_day__" class="css_read_off___calend_all_day__ css___calend_all_day___line" style="<?php echo $sStyleReadInp___calend_all_day__; ?>"><?php echo "<div id=\"idAjaxCheckbox___calend_all_day__\" style=\"display: inline-block\" class=\"css___calend_all_day___line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup___calend_all_day__'][] = 'Y'; ?>
