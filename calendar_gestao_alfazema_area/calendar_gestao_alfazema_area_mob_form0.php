...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>calendar_gestao_alfazema_area/calendar_gestao_alfazema_area_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("calendar_gestao_alfazema_area_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('calendar_gestao_alfazema_area_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['calendar_gestao_alfazema_area']['error_buffer']) && '' != $_SESSION['scriptcase']['calendar_gestao_alfazema_area']['error_buffer'])
{
    echo $_SESSION['scriptcase']['calendar_gestao_alfazema_area']['error_buffer'];
}
...
<?php
 include_once("calendar_gestao_alfazema_area_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="calendar_gestao_alfazema_area_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['insert_validation']; ?>">
<?php
}
?>
...
<input type="hidden" name="id_gestao" value="<?php  echo $this->form_encode_input($this->id_gestao) ?>">
<input type="hidden" name="_sc_force_mobile" id="sc-id-mobile-control" value="" />
<?php
$_SESSION['scriptcase']['error_span_title']['calendar_gestao_alfazema_area_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['calendar_gestao_alfazema_area_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['exit'];
        }
?>
...
<TABLE align="center" id="hidden_bloco_0" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['tipoarea'] = "Qual Área?";
    }
?>
<?php
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_tipoarea_line"><?php $tempOptionId = "id-opt-tipoarea" . $sc_seq_vert . "-1"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-tipoarea sc-ui-radio-tipoarea" type=radio name="tipoarea" value="Área Gourmet"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_tipoarea'][] = 'Área Gourmet'; ?>
<?php  if ("Área Gourmet" == $this->tipoarea)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">Área Gourmet</label></TD>
  <TD class="scFormDataFontOdd css_tipoarea_line"><?php $tempOptionId = "id-opt-tipoarea" . $sc_seq_vert . "-2"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-tipoarea sc-ui-radio-tipoarea" type=radio name="tipoarea" value="Área de Festas"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_tipoarea'][] = 'Área de Festas'; ?>
...
<span id="id_read_on_fone" class="sc-ui-readonly-fone css_fone_line" style="<?php echo $sStyleReadLab_fone; ?>"><?php echo $this->form_format_readonly("fone", $this->form_encode_input($this->fone)); ?></span><span id="id_read_off_fone" class="css_read_off_fone<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_fone; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=11"; } ?> alt="{datatype: 'mask', maskList: '99 9 9999-9999', alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '81 9 9999-9999', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<span id="id_read_on_aptnum" class="sc-ui-readonly-aptnum css_aptnum_line" style="<?php echo $sStyleReadLab_aptnum; ?>"><?php echo $this->form_format_readonly("aptnum", $this->form_encode_input($this->aptnum)); ?></span><span id="id_read_off_aptnum" class="css_read_off_aptnum<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_aptnum; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=4"; } ?> alt="{datatype: 'integer', maxLength: 4, thousandsSep: '', thousandsFormat: <?php echo $this->field_config['aptnum']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['aptnum']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '502', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_aptbloco_line"><?php $tempOptionId = "id-opt-aptbloco" . $sc_seq_vert . "-1"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-aptbloco sc-ui-radio-aptbloco" type=radio name="aptbloco" value="A"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_aptbloco'][] = 'A'; ?>
<?php  if ("A" == $this->aptbloco)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">A</label></TD>
  <TD class="scFormDataFontOdd css_aptbloco_line"><?php $tempOptionId = "id-opt-aptbloco" . $sc_seq_vert . "-2"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-aptbloco sc-ui-radio-aptbloco" type=radio name="aptbloco" value="B"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_aptbloco'][] = 'B'; ?>
<?php  if ("B" == $this->aptbloco)  { echo " checked" ;} ?>  onClick="" ><label for="<?php echo $tempOptionId ?>">B</label></TD>
  <TD class="scFormDataFontOdd css_aptbloco_line"><?php $tempOptionId = "id-opt-aptbloco" . $sc_seq_vert . "-3"; ?>
    <input id="<?php echo $tempOptionId ?>"  class="sc-ui-radio-aptbloco sc-ui-radio-aptbloco" type=radio name="aptbloco" value="C"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['Lookup_aptbloco'][] = 'C'; ?>
...
<span id="id_read_on_qtdpessoas" class="sc-ui-readonly-qtdpessoas css_qtdpessoas_line" style="<?php echo $sStyleReadLab_qtdpessoas; ?>"><?php echo $this->form_format_readonly("qtdpessoas", $this->form_encode_input($this->qtdpessoas)); ?></span><span id="id_read_off_qtdpessoas" class="css_read_off_qtdpessoas<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_qtdpessoas; ?>">
 <input class="sc-js-input scFormObjectOdd scFormObjectOddSpin scSpin_qtdpessoas_obj css_qtdpessoas_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_qtdpessoas" type=text name="qtdpessoas" value="<?php echo $this->form_encode_input($qtdpessoas) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=8"; } ?> alt="{datatype: 'integer', maxLength: 8, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['qtdpessoas']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['qtdpessoas']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['qtdpessoas']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '10', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<TABLE align="center" id="hidden_bloco_1" class="scFormTable<?php echo $this->classes_100perc_fields['table'] ?>" width="100%" style="height: 100%;"><?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['horario_inic'] = "Horário de Início";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
?>
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=8"; } ?> alt="{datatype: 'time', timeSep: '<?php echo $this->field_config['horario_inic']['time_sep']; ?>', timeFormat: '<?php echo $this->field_config['horario_inic']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '<?php echo $tmp_form_data; ?>', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['horario_fim'] = "Horário Final";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
?>
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=8"; } ?> alt="{datatype: 'time', timeSep: '<?php echo $this->field_config['horario_fim']['time_sep']; ?>', timeFormat: '<?php echo $this->field_config['horario_fim']['date_format']; ?>', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '<?php echo $tmp_form_data; ?>', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['btn_label'][''];
        }
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['masterValue']))
{
...
function updateHeaderFooter(sFldName, sFldValue)
{
  ...
  if ("data" == sFldName)
  {
    document.getElementById("head_mark_data_0").innerHTML = sFldValue;
  }
}
</script>
<?php
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("calendar_gestao_alfazema_area_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("calendar_gestao_alfazema_area_mob");
 parent.scAjaxDetailHeight("calendar_gestao_alfazema_area_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	...
	function scBtnFn_sys_format_inc() {
		...
		if ($("#sc_b_new_b.sc-unique-btn-15").length && $("#sc_b_new_b.sc-unique-btn-15").is(":visible")) {
		    if ($("#sc_b_new_b.sc-unique-btn-15").hasClass("disabled")) {
		        return;
		    }
			nm_move ('novo');
			 return;
		}
		if ($("#sc_b_ins_b.sc-unique-btn-16").length && $("#sc_b_ins_b.sc-unique-btn-16").is(":visible")) {
		    if ($("#sc_b_ins_b.sc-unique-btn-16").hasClass("disabled")) {
		        return;
		    }
			nm_atualiza ('incluir');
			 return;
	...
	function scBtnFn_sys_format_exc() {
		if ($("#sc_b_del_b.sc-unique-btn-7").length && $("#sc_b_del_b.sc-unique-btn-7").is(":visible")) {
		    if ($("#sc_b_del_b.sc-unique-btn-7").hasClass("disabled")) {
		        return;
		    }
			nm_atualiza ('excluir');
			 return;
		}
		if ($("#sc_b_del_b.sc-unique-btn-18").length && $("#sc_b_del_b.sc-unique-btn-18").is(":visible")) {
		    if ($("#sc_b_del_b.sc-unique-btn-18").hasClass("disabled")) {
		        return;
		    }
			nm_atualiza ('excluir');
			 return;
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
