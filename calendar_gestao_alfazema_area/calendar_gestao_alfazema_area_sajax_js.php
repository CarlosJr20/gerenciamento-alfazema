  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_calendar_gestao_alfazema_area" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_calendar_gestao_alfazema_area_form();
	}
...
?>
  ...
  // ---------- Validate tipoarea
  function do_ajax_calendar_gestao_alfazema_area_validate_tipoarea()
  {
    var nomeCampo_tipoarea = "tipoarea";
    var var_tipoarea = scAjaxGetFieldRadio(nomeCampo_tipoarea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_tipoarea(var_tipoarea, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_tipoarea_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_tipoarea

  function do_ajax_calendar_gestao_alfazema_area_validate_tipoarea_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_gestao_alfazema_area_validate_tipoarea_cb

  // ---------- Validate nome
  function do_ajax_calendar_gestao_alfazema_area_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_nome(var_nome, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_nome_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_nome

  function do_ajax_calendar_gestao_alfazema_area_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_gestao_alfazema_area_validate_nome_cb

  // ---------- Validate sobrenome
  function do_ajax_calendar_gestao_alfazema_area_validate_sobrenome()
  {
    var nomeCampo_sobrenome = "sobrenome";
    var var_sobrenome = scAjaxGetFieldText(nomeCampo_sobrenome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_sobrenome(var_sobrenome, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_sobrenome_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_sobrenome

  function do_ajax_calendar_gestao_alfazema_area_validate_sobrenome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_calendar_gestao_alfazema_area_validate_email()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_email(var_email, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_email_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_email

  function do_ajax_calendar_gestao_alfazema_area_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
  ...
  function do_ajax_calendar_gestao_alfazema_area_validate_aptnum()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_aptnum(var_aptnum, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_aptnum_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_aptnum

  function do_ajax_calendar_gestao_alfazema_area_validate_aptnum_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aptnum";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_gestao_alfazema_area_validate_aptnum_cb

  // ---------- Validate aptbloco
  function do_ajax_calendar_gestao_alfazema_area_validate_aptbloco()
  {
    var nomeCampo_aptbloco = "aptbloco";
    var var_aptbloco = scAjaxGetFieldRadio(nomeCampo_aptbloco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_aptbloco(var_aptbloco, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_aptbloco_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_aptbloco

  function do_ajax_calendar_gestao_alfazema_area_validate_aptbloco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_gestao_alfazema_area_validate_aptbloco_cb

  // ---------- Validate qtdpessoas
  function do_ajax_calendar_gestao_alfazema_area_validate_qtdpessoas()
  {
    var nomeCampo_qtdpessoas = "qtdpessoas";
    var var_qtdpessoas = scAjaxGetFieldText(nomeCampo_qtdpessoas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_qtdpessoas(var_qtdpessoas, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_qtdpessoas_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_qtdpessoas

  function do_ajax_calendar_gestao_alfazema_area_validate_qtdpessoas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_calendar_gestao_alfazema_area_validate_horario_inic()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_horario_inic(var_horario_inic, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_horario_inic_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_horario_inic

  function do_ajax_calendar_gestao_alfazema_area_validate_horario_inic_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_calendar_gestao_alfazema_area_validate_horario_inic_cb

  // ---------- Validate horario_fim
  function do_ajax_calendar_gestao_alfazema_area_validate_horario_fim()
  {
    var nomeCampo_horario_fim = "horario_fim";
    var var_horario_fim = scAjaxGetFieldText(nomeCampo_horario_fim);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_calendar_gestao_alfazema_area_validate_horario_fim(var_horario_fim, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_validate_horario_fim_cb);
  } // do_ajax_calendar_gestao_alfazema_area_validate_horario_fim

  function do_ajax_calendar_gestao_alfazema_area_validate_horario_fim_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_calendar_gestao_alfazema_area_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_calendar_gestao_alfazema_area_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
  ...
  } // do_ajax_calendar_gestao_alfazema_area_submit_form_cb
  function do_ajax_calendar_gestao_alfazema_area_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_calendar_gestao_alfazema_area_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_calendar_gestao_alfazema_area_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_calendar_gestao_alfazema_area_navigate_form, function() {});
    } else {
      perform_ajax_calendar_gestao_alfazema_area_navigate_form();
    }
  }

  function perform_ajax_calendar_gestao_alfazema_area_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_calendar_gestao_alfazema_area_navigate_form(var_id_gestao, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_calendar_gestao_alfazema_area_navigate_form_cb);
  } // do_ajax_calendar_gestao_alfazema_area_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['calendar_gestao_alfazema_area']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_calendar_gestao_alfazema_area_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_calendar_gestao_alfazema_area_navigate_form_cb_after_alert);
  } // do_ajax_calendar_gestao_alfazema_area_navigate_form_cb
  function do_ajax_calendar_gestao_alfazema_area_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_calendar_gestao_alfazema_area_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
