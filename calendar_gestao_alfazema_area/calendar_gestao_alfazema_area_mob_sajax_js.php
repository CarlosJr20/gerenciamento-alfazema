...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_calendar_gestao_alfazema_area_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_calendar_gestao_alfazema_area_mob_submit_form(var_tipoarea, var_nome, var_sobrenome, var_fone, var_email, var_aptnum, var_aptbloco, var_qtdpessoas, var_horario_inic, var_horario_fim, var_id_gestao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_calendar_gestao_alfazema_area_mob_submit_form_cb);
