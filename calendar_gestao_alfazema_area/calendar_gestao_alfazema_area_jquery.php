...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_gestao' + iSeqRow).bind('change', function() { sc_calendar_gestao_alfazema_area_id_gestao_onchange(this, iSeqRow) });
  $('#id_sc_field_nome' + iSeqRow).bind('blur', function() { sc_calendar_gestao_alfazema_area_nome_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_calendar_gestao_alfazema_area_nome_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sobrenome' + iSeqRow).bind('blur', function() { sc_calendar_gestao_alfazema_area_sobrenome_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_calendar_gestao_alfazema_area_sobrenome_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fone' + iSeqRow).bind('blur', function() { sc_calendar_gestao_alfazema_area_fone_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_calendar_gestao_alfazema_area_fone_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_calendar_gestao_alfazema_area_email_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_calendar_gestao_alfazema_area_email_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipoarea' + iSeqRow).bind('blur', function() { sc_calendar_gestao_alfazema_area_tipoarea_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_calendar_gestao_alfazema_area_tipoarea_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_horario_inic' + iSeqRow).bind('blur', function() { sc_calendar_gestao_alfazema_area_horario_inic_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_calendar_gestao_alfazema_area_horario_inic_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_aptbloco' + iSeqRow).bind('blur', function() { sc_calendar_gestao_alfazema_area_aptbloco_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_calendar_gestao_alfazema_area_aptbloco_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_qtdpessoas' + iSeqRow).bind('blur', function() { sc_calendar_gestao_alfazema_area_qtdpessoas_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_calendar_gestao_alfazema_area_qtdpessoas_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_calendar_gestao_alfazema_area_qtdpessoas_onfocus(this, iSeqRow) });
  $('#id_sc_field___calend_all_day__' + iSeqRow).bind('change', function() { sc_calendar_gestao_alfazema_area___calend_all_day___onchange(this, iSeqRow) });
...
function sc_calendar_gestao_alfazema_area_id_gestao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_nome_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_sobrenome_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_fone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_tipoarea_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_horario_inic_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_horario_fim_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_aptnum_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_aptbloco_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area_qtdpessoas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_calendar_gestao_alfazema_area___calend_all_day___onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_calendar_gestao_alfazema_area_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'calendar_gestao_alfazema_area')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
