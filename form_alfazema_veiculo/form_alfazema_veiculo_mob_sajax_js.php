  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_alfazema_veiculo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_alfazema_veiculo_mob_form();
	}
  ...
  // ---------- Validate nome
  function do_ajax_form_alfazema_veiculo_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alfazema_veiculo_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_alfazema_veiculo_mob_validate_nome_cb);
  } // do_ajax_form_alfazema_veiculo_mob_validate_nome

  function do_ajax_form_alfazema_veiculo_mob_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alfazema_veiculo_mob_validate_nome_cb

  // ---------- Validate bloco
  function do_ajax_form_alfazema_veiculo_mob_validate_bloco()
  {
    var nomeCampo_bloco = "bloco";
    var var_bloco = scAjaxGetFieldSelect(nomeCampo_bloco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alfazema_veiculo_mob_validate_bloco(var_bloco, var_script_case_init, do_ajax_form_alfazema_veiculo_mob_validate_bloco_cb);
  } // do_ajax_form_alfazema_veiculo_mob_validate_bloco

  function do_ajax_form_alfazema_veiculo_mob_validate_bloco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bloco";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alfazema_veiculo_mob_validate_bloco_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_alfazema_veiculo_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alfazema_veiculo_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_alfazema_veiculo_mob_validate_sc_field_0_cb);
  } // do_ajax_form_alfazema_veiculo_mob_validate_sc_field_0

  function do_ajax_form_alfazema_veiculo_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alfazema_veiculo_mob_validate_sc_field_0_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_alfazema_veiculo_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alfazema_veiculo_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_alfazema_veiculo_mob_validate_sc_field_1_cb);
  } // do_ajax_form_alfazema_veiculo_mob_validate_sc_field_1

  function do_ajax_form_alfazema_veiculo_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alfazema_veiculo_mob_validate_sc_field_1_cb

  // ---------- Validate placa
  function do_ajax_form_alfazema_veiculo_mob_validate_placa()
  {
    var nomeCampo_placa = "placa";
    var var_placa = scAjaxGetFieldText(nomeCampo_placa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alfazema_veiculo_mob_validate_placa(var_placa, var_script_case_init, do_ajax_form_alfazema_veiculo_mob_validate_placa_cb);
  } // do_ajax_form_alfazema_veiculo_mob_validate_placa

  function do_ajax_form_alfazema_veiculo_mob_validate_placa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "placa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alfazema_veiculo_mob_validate_placa_cb

  // ---------- Validate data
  function do_ajax_form_alfazema_veiculo_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alfazema_veiculo_mob_validate_data(var_data, var_script_case_init, do_ajax_form_alfazema_veiculo_mob_validate_data_cb);
  } // do_ajax_form_alfazema_veiculo_mob_validate_data

  function do_ajax_form_alfazema_veiculo_mob_validate_data_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alfazema_veiculo_mob_validate_data_cb

  // ---------- Validate hora_entrada
  function do_ajax_form_alfazema_veiculo_mob_validate_hora_entrada()
  {
    var nomeCampo_hora_entrada = "hora_entrada";
    var var_hora_entrada = scAjaxGetFieldText(nomeCampo_hora_entrada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_alfazema_veiculo_mob_validate_hora_entrada(var_hora_entrada, var_script_case_init, do_ajax_form_alfazema_veiculo_mob_validate_hora_entrada_cb);
  } // do_ajax_form_alfazema_veiculo_mob_validate_hora_entrada

  function do_ajax_form_alfazema_veiculo_mob_validate_hora_entrada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora_entrada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_alfazema_veiculo_mob_validate_hora_entrada_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_alfazema_veiculo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_alfazema_veiculo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome = scAjaxGetFieldText("nome");
    var var_bloco = scAjaxGetFieldSelect("bloco");
    ...
    var var_hora_entrada = scAjaxGetFieldText("hora_entrada");
    var var_id_alfazema = scAjaxGetFieldText("id_alfazema");
    ...
    scAjaxProcOn();
    x_ajax_form_alfazema_veiculo_mob_submit_form(var_nome, var_bloco, var_sc_field_0, var_sc_field_1, var_placa, var_data, var_hora_entrada, var_id_alfazema, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_alfazema_veiculo_mob_submit_form_cb);
  } // do_ajax_form_alfazema_veiculo_mob_submit_form

  function do_ajax_form_alfazema_veiculo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("hora_entrada");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_alfazema_veiculo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_alfazema_veiculo_mob_submit_form_cb
  function do_ajax_form_alfazema_veiculo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_alfazema_veiculo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_alfazema_veiculo_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_alfazema_veiculo_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_alfazema_veiculo_mob_navigate_form();
    }
  }

  function perform_ajax_form_alfazema_veiculo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("data");
    scAjaxHideErrorDisplay("hora_entrada");
    var var_id_alfazema = document.F2.id_alfazema.value;
    ...
    scAjaxProcOn();
    x_ajax_form_alfazema_veiculo_mob_navigate_form(var_id_alfazema, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_alfazema_veiculo_mob_navigate_form_cb);
  } // do_ajax_form_alfazema_veiculo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_alfazema_veiculo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_alfazema_veiculo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_alfazema.value = scAjaxGetKeyValue("id_alfazema");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_alfazema_veiculo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_alfazema_veiculo_mob_navigate_form_cb
  function do_ajax_form_alfazema_veiculo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_alfazema_veiculo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_alfazema_veiculo_mob_navigate_form_cb_after_alert
  function sc_hide_form_alfazema_veiculo_mob_form()
  {
  ...
  ajax_field_list[1] = "bloco";
  ajax_field_list[2] = "sc_field_0";
  ajax_field_list[3] = "sc_field_1";
  ajax_field_list[4] = "placa";
  ajax_field_list[5] = "data";
  ajax_field_list[6] = "hora_entrada";
  ...
  var ajax_error_list = {
    ...
    "bloco": {"label": "Bloco", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_0": {"label": "Número", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_1": {"label": "Veículo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "hora_entrada": {"label": "Hora Entrada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "placa": new Array(),
    "data": new Array(),
    "hora_entrada": new Array()
  };
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["bloco"][1] = "bloco";
  ...
  ajax_field_mult["hora_entrada"][1] = "hora_entrada";

  var ajax_field_id = {
    "nome": new Array("hidden_field_label_nome", "hidden_field_data_nome"),
    "bloco": new Array("hidden_field_label_bloco", "hidden_field_data_bloco"),
    ...
    "hora_entrada": new Array("hidden_field_label_hora_entrada", "hidden_field_data_hora_entrada")
  };
