...
class grid_cliente_mp_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cliente_mp_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cliente_mp_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cliente_mp_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nome_da_empresa')
      {
          $nome_da_empresa = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nome_da_empresa($nome_da_empresa);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cliente_mp/grid_cliente_mp_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cliente_mp_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cliente_mp_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_cliente_mp_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cliente_mp']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cliente_mp']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_id_client_cond#NMF#' + search_get_sel_txt('SC_id_client_cond') + '@NMF@';
  str_out += 'SC_id_client#NMF#' + search_get_text('SC_id_client') + '@NMF@';
  str_out += 'SC_nome_da_empresa_cond#NMF#' + search_get_sel_txt('SC_nome_da_empresa_cond') + '@NMF@';
  str_out += 'SC_nome_da_empresa#NMF#' + search_get_text('SC_nome_da_empresa') + '@NMF@';
  str_out += 'id_ac_nome_da_empresa#NMF#' + search_get_text('id_ac_nome_da_empresa') + '@NMF@';
  str_out += 'SC_cnpj_cond#NMF#' + search_get_sel_txt('SC_cnpj_cond') + '@NMF@';
  str_out += 'SC_cnpj#NMF#' + search_get_text('SC_cnpj') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_nome_da_empresa").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nome_da_empresa").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nome_da_empresa",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_nome_da_empresa").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nome_da_empresa").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">Consultar Clientes</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $id_client_cond, $id_client,
             $nome_da_empresa_cond, $nome_da_empresa, $nome_da_empresa_autocomp,
             $cnpj_cond, $cnpj,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $hora_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_hor']; 
          $hora_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_min']; 
          $hora_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_seg']; 
          $hora_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_cond']; 
          $id_client = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['id_client']; 
          $id_client_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['id_client_cond']; 
          $nome_da_empresa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['nome_da_empresa']; 
          $nome_da_empresa_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['nome_da_empresa_cond']; 
          $cnpj = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['cnpj']; 
          $cnpj_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['cnpj_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['NM_operador']; 
          if (strtoupper($id_client_cond) != "II" && strtoupper($id_client_cond) != "QP" && strtoupper($id_client_cond) != "NP" && strtoupper($id_client_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($id_client, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($id_client_cond) || empty($id_client_cond))
      {
         $id_client_cond = "gt";
      }
      if (!isset($nome_da_empresa_cond) || empty($nome_da_empresa_cond))
      {
         $nome_da_empresa_cond = "qp";
      }
      if (!isset($cnpj_cond) || empty($cnpj_cond))
      {
         $cnpj_cond = "qp";
      }
      ...
      $str_hide_id_client = (in_array($id_client_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nome_da_empresa = (in_array($nome_da_empresa_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_cnpj = (in_array($cnpj_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($id_client, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $id_client = substr($id_client, 0, $tmp_pos);
         }
      }
      if (!isset($nome_da_empresa) || $nome_da_empresa == "")
      {
          $nome_da_empresa = "";
      }
      if (isset($nome_da_empresa) && !empty($nome_da_empresa))
      {
         $tmp_pos = strpos($nome_da_empresa, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nome_da_empresa = substr($nome_da_empresa, 0, $tmp_pos);
         }
      }
      if (!isset($cnpj) || $cnpj == "")
      {
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_id_client_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_client'])) ? $this->New_label['id_client'] : "Id Client"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_id_client_cond" name="id_client_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_client'), this, 'id_client')">
       <OPTION value="gt" <?php if ("gt" == $id_client_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $id_client_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $id_client_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_client" <?php echo $str_hide_id_client?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_client'])) ? $this->New_label['id_client'] : "Id Client";
 $nmgp_tab_label .= "id_client?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_id_client" name="id_client" value="<?php echo NM_encode_input($id_client) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_nome_da_empresa_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['nome_da_empresa'])) ? $this->New_label['nome_da_empresa'] : "Nome Da Empresa"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_nome_da_empresa_cond" name="nome_da_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_da_empresa'), this, 'nome_da_empresa')">
       <OPTION value="qp" <?php if ("qp" == $nome_da_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $nome_da_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $nome_da_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $nome_da_empresa_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nome_da_empresa" <?php echo $str_hide_nome_da_empresa?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['nome_da_empresa'])) ? $this->New_label['nome_da_empresa'] : "Nome Da Empresa";
 $nmgp_tab_label .= "nome_da_empresa?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $nome_da_empresa;
      }
?>
<INPUT  type="text" id="SC_nome_da_empresa" name="nome_da_empresa" value="<?php echo NM_encode_input($nome_da_empresa) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_nome_da_empresa" name="nome_da_empresa_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_cnpj_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cnpj'])) ? $this->New_label['cnpj'] : "CNPJ"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_cnpj_cond" name="cnpj_cond" onChange="nm_campos_between(document.getElementById('id_vis_cnpj'), this, 'cnpj')">
       <OPTION value="qp" <?php if ("qp" == $cnpj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $cnpj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cnpj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $cnpj_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cnpj" <?php echo $str_hide_cnpj?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cnpj'])) ? $this->New_label['cnpj'] : "CNPJ";
 $nmgp_tab_label .= "cnpj?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_cnpj" name="cnpj" value="<?php echo NM_encode_input($cnpj) ?>" size=50 alt="{datatype: 'mask', maskList: '999.999.999-99;99.999.999/9999-99', alignRight: true, maxLength: 14, autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("grid_cliente_mp_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cliente_mp']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cliente_mp']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_client_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_id_client'), document.F1.id_client_cond, 'id_client');
   document.F1.id_client.value = "";
   document.F1.nome_da_empresa_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nome_da_empresa'), document.F1.nome_da_empresa_cond, 'nome_da_empresa');
   document.F1.nome_da_empresa.value = "";
   document.F1.nome_da_empresa_autocomp.value = "";
   document.F1.cnpj_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_cnpj'), document.F1.cnpj_cond, 'cnpj');
   document.F1.cnpj.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_cnpj').bind('change', function() {sc_grid_cliente_mp_valida_ciccnpj(this)});
    $('#SC_hora_hor').bind('change', function() {sc_grid_cliente_mp_valida_hora(this)});
    $('#SC_hora_min').bind('change', function() {sc_grid_cliente_mp_valida_min(this)});
    $('#SC_hora_seg').bind('change', function() {sc_grid_cliente_mp_valida_seg(this)});
 }
 function sc_grid_cliente_mp_valida_hora(obj)
 {
 ...
 function sc_grid_cliente_mp_valida_min(obj)
 {
 ...
 function sc_grid_cliente_mp_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
 ...
 function sc_grid_cliente_mp_valida_cic(obj)
 {
     var x        = 0;
     var y        = 0;
     var soma     = 0;
 ...
 function sc_grid_cliente_mp_valida_cnpj(obj)
 {
     var x         = 0;
     var y         = 5;
     var soma      = 0;
 ...
 function sc_grid_cliente_mp_valida_ciccnpj(obj)
 {
     var CnpjIn = obj.value;
     CnpjIn = CnpjIn.replace(/[.]/g, '');
     CnpjIn = CnpjIn.replace(/[-]/g, '');
     ...
     if (CnpjIn.length <= 11)
     {
         return sc_grid_cliente_mp_valida_cic(obj);
     }
     else
     {
         return sc_grid_cliente_mp_valida_cnpj(obj);
     }
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_client_cond'] = 'cond';
      $tp_fields['SC_id_client'] = 'text';
      $tp_fields['SC_nome_da_empresa_cond'] = 'cond';
      $tp_fields['SC_nome_da_empresa'] = 'text_aut';
      $tp_fields['id_ac_nome_da_empresa'] = 'text_aut';
      $tp_fields['SC_cnpj_cond'] = 'cond';
      $tp_fields['SC_cnpj'] = 'text';
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq'] = array();
      if (!empty($nome_da_empresa_autocomp) && empty($nome_da_empresa))
      {
          $nome_da_empresa = $nome_da_empresa_autocomp;
      }
      $hora_cond_salva = $hora_cond; 
      $id_client_cond_salva = $id_client_cond; 
      if (!isset($id_client_input_2) || $id_client_input_2 == "")
      {
          $id_client_input_2 = $id_client;
      }
      $nome_da_empresa_cond_salva = $nome_da_empresa_cond; 
      if (!isset($nome_da_empresa_input_2) || $nome_da_empresa_input_2 == "")
      {
          $nome_da_empresa_input_2 = $nome_da_empresa;
      }
      $cnpj_cond_salva = $cnpj_cond; 
      if (!isset($cnpj_input_2) || $cnpj_input_2 == "")
      {
          $cnpj_input_2 = $cnpj;
      }
      if ($id_client_cond != "in")
      {
          nm_limpa_numero($id_client, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_hor'] = $hora_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_min'] = $hora_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_seg'] = $hora_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $hora_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $hora_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $hora_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_cond'] = $hora_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['cmp'] = "hora"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['opc'] = $hora_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq']['hora'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['id_client'] = $id_client; 
      if (is_array($id_client) && !empty($id_client))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0] = $id_client;
      }
      elseif ($id_client_cond_salva == "nu" || $id_client_cond_salva == "nn" || $id_client_cond_salva == "ep" || $id_client_cond_salva == "ne" || !empty($id_client))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0][0] = $id_client;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['id_client_cond'] = $id_client_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['cmp'] = "id_client"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['opc'] = $id_client_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq']['id_client'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['nome_da_empresa'] = $nome_da_empresa; 
      if (is_array($nome_da_empresa) && !empty($nome_da_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0] = $nome_da_empresa;
      }
      elseif ($nome_da_empresa_cond_salva == "nu" || $nome_da_empresa_cond_salva == "nn" || $nome_da_empresa_cond_salva == "ep" || $nome_da_empresa_cond_salva == "ne" || !empty($nome_da_empresa))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0][0] = $nome_da_empresa;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['nome_da_empresa_cond'] = $nome_da_empresa_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['cmp'] = "nome_da_empresa"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['opc'] = $nome_da_empresa_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq']['nome_da_empresa'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['cnpj'] = $cnpj; 
      if (is_array($cnpj) && !empty($cnpj))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0] = $cnpj;
      }
      elseif ($cnpj_cond_salva == "nu" || $cnpj_cond_salva == "nn" || $cnpj_cond_salva == "ep" || $cnpj_cond_salva == "ne" || !empty($cnpj))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['val'][0][0] = $cnpj;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['cnpj_cond'] = $cnpj_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['cmp'] = "cnpj"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid]['opc'] = $cnpj_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq']['cnpj'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'] = $Temp_Busca;
      }
      nm_limpa_ciccnpj($cnpj) ; 
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      ...
      $this->cmp_formatado['id_client'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($nome_da_empresa != '') {
      $nome_da_empresa_look = substr($this->Db->qstr($nome_da_empresa), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nome_da_empresa'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['nome_da_empresa'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nome_da_empresa'] = $nome_da_empresa;
      }
      $Conteudo = $cnpj;
      ...
      $this->cmp_formatado['cnpj'] = $Conteudo;
      ...
      if ($hora_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora'] = $val[0];
          ...
          if ($hora_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']['hora_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq']['hora']['label'] = $nmgp_tab_label['hora'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq']['hora']['descr'] = $nmgp_tab_label['hora'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['grid_pesq']['hora']['hint']  = $nmgp_tab_label['hora'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $id_client
      $this->Date_part = false;
      if (isset($id_client) || $id_client_cond == "nu" || $id_client_cond == "nn" || $id_client_cond == "ep" || $id_client_cond == "ne")
      {
         $this->monta_condicao("id_client", $id_client_cond, $id_client, "", "id_client");
      }

      //----- $nome_da_empresa
      $this->Date_part = false;
      if (isset($nome_da_empresa) || $nome_da_empresa_cond == "nu" || $nome_da_empresa_cond == "nn" || $nome_da_empresa_cond == "ep" || $nome_da_empresa_cond == "ne")
      {
         $this->monta_condicao("nome_da_empresa", $nome_da_empresa_cond, $nome_da_empresa, "", "nome_da_empresa");
      }

      //----- $cnpj
      $this->Date_part = false;
      if (isset($cnpj) || $cnpj_cond == "nu" || $cnpj_cond == "nn" || $cnpj_cond == "ep" || $cnpj_cond == "ne")
      {
         $this->monta_condicao("CNPJ", $cnpj_cond, $cnpj, "", "cnpj");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente_mp']['cond_pesq'] .= $this->NM_operador;
