...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "data";$Nm_datas[] = "data";$Nm_datas[] = "hora";$Nm_datas[] = "hora";$Nm_numeric[] = "id_client";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_id_client_cond" name="id_client_cond" onChange="nm_campos_between(document.getElementById('id_vis_id_client'), this, 'id_client')">
      ...
      <br><span id="id_hide_id_client"  <?php echo $str_hide_id_client?>><INPUT  type="text" id="SC_id_client" name="id_client" value="<?php echo NM_encode_input($id_client) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nome_da_empresa_cond" name="nome_da_empresa_cond" onChange="nm_campos_between(document.getElementById('id_vis_nome_da_empresa'), this, 'nome_da_empresa')">
      ...
      <br><span id="id_hide_nome_da_empresa"  <?php echo $str_hide_nome_da_empresa?>><?php
      if ($nome_da_empresa != "")
      {
      $nome_da_empresa_look = substr($this->Db->qstr($nome_da_empresa), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_cnpj_cond" name="cnpj_cond" onChange="nm_campos_between(document.getElementById('id_vis_cnpj'), this, 'cnpj')">
      ...
      <br><span id="id_hide_cnpj"  <?php echo $str_hide_cnpj?>><INPUT  type="text" id="SC_cnpj" name="cnpj" value="<?php echo NM_encode_input($cnpj) ?>" size=50 alt="{datatype: 'mask', maskList: '999.999.999-99;99.999.999/9999-99', alignRight: true, maxLength: 14, autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
