<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cliente_mp']['sc_process_barr'] = true;
require_once('../grid_cliente_mp/index.php');
unset($_SESSION['scriptcase']['grid_cliente_mp']['sc_process_barr']);
$ExportCtrl = new grid_cliente_mp_export_control;
$ExportCtrl->Export_barr();

class grid_cliente_mp_export_control
{
